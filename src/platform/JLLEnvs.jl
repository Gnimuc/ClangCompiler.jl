...
function get_system_dirs(triple::String, version::VersionNumber=v"4.8.5")
    ...
    elseif triple == "aarch64-apple-darwin20"
        # compiler
        push!(isys, joinpath(gcc_triple_path, triple, "include", "c++", "11.0.0"))
        push!(isys, joinpath(gcc_triple_path, triple, "include", "c++", "11.0.0", triple))
        push!(isys, joinpath(gcc_triple_path, triple, "include", "c++", "11.0.0", "backward"))
    ...
    elseif triple == "armv7l-linux-gnueabihf"
        # compiler
        push!(isys, joinpath(gcc_triple_path, "arm-linux-gnueabihf", "include", "c++", string(version)))
        push!(isys, joinpath(gcc_triple_path, "arm-linux-gnueabihf", "include", "c++", string(version), "arm-linux-gnueabihf"))
        push!(isys, joinpath(gcc_triple_path, "arm-linux-gnueabihf", "include", "c++", string(version), "backward"))
    ...
    elseif triple == "armv7l-linux-musleabihf"
        # compiler
        push!(isys, joinpath(gcc_triple_path, "arm-linux-musleabihf", "include", "c++", string(version)))
        push!(isys, joinpath(gcc_triple_path, "arm-linux-musleabihf", "include", "c++", string(version), "arm-linux-musleabihf"))
        push!(isys, joinpath(gcc_triple_path, "arm-linux-musleabihf", "include", "c++", string(version), "backward"))
