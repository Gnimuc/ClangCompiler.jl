...
void clang_StandardConversionSequence_setFromType(CXStandardConversionSequence SCS,
                                                  CXQualType T) {
  reinterpret_cast<clang::StandardConversionSequence *>(SCS)->setFromType(
...
void clang_StandardConversionSequence_setToType(CXStandardConversionSequence SCS,
  ...
  reinterpret_cast<clang::StandardConversionSequence *>(SCS)->setToType(
...
void clang_StandardConversionSequence_setAllToTypes(CXStandardConversionSequence SCS,
                                                    CXQualType T) {
  reinterpret_cast<clang::StandardConversionSequence *>(SCS)->setAllToTypes(
      clang::QualType::getFromOpaquePtr(T));
}

CXQualType clang_StandardConversionSequence_getFromType(CXStandardConversionSequence SCS) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::StandardConversionSequence *>(SCS)
      ->getFromType()
      .getAsOpaquePtr());
}
...
void clang_StandardConversionSequence_setAsIdentityConversion(
  ...
  reinterpret_cast<clang::StandardConversionSequence *>(SCS)->setAsIdentityConversion();
}

bool clang_StandardConversionSequence_isIdentityConversion(
    CXStandardConversionSequence SCS) {
  return reinterpret_cast<clang::StandardConversionSequence *>(SCS)->isIdentityConversion();
}
...
clang_StandardConversionSequence_getRank(CXStandardConversionSequence SCS) {
  return static_cast<CXImplicitConversionRank>(
      reinterpret_cast<clang::StandardConversionSequence *>(SCS)->getRank());
}

bool clang_StandardConversionSequence_isPointerConversionToBool(
    CXStandardConversionSequence SCS) {
  return reinterpret_cast<clang::StandardConversionSequence *>(SCS)->isPointerConversionToBool();
}

bool clang_StandardConversionSequence_isPointerConversionToVoidPointer(
    CXStandardConversionSequence SCS, CXASTContext Ctx) {
  return reinterpret_cast<clang::StandardConversionSequence *>(SCS)
      ->isPointerConversionToVoidPointer(*reinterpret_cast<clang::ASTContext *>(Ctx));
}
...
CXNarrowingKind clang_StandardConversionSequence_getNarrowingKind(
  ...
  clang::NarrowingKind NK =
      reinterpret_cast<clang::StandardConversionSequence *>(SCS)->getNarrowingKind(
          *reinterpret_cast<clang::ASTContext *>(Ctx), reinterpret_cast<clang::Expr *>(Converted),
          *reinterpret_cast<clang::APValue *>(ConstantValue), CT,
          IgnoreFloatToIntegralConversion);
  *ConstantType = reinterpret_cast<CXQualType>(CT.getAsOpaquePtr());
  return static_cast<CXNarrowingKind>(NK);
}

void clang_StandardConversionSequence_dump(CXStandardConversionSequence SCS) {
  reinterpret_cast<clang::StandardConversionSequence *>(SCS)->dump();
}

CXStandardConversionSequence
clang_UserDefinedConversionSequence_getBefore(CXUserDefinedConversionSequence UDCS) {
  return reinterpret_cast<CXStandardConversionSequence>(&reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->Before);
}

CXStandardConversionSequence
clang_UserDefinedConversionSequence_getAfter(CXUserDefinedConversionSequence UDCS) {
  return reinterpret_cast<CXStandardConversionSequence>(&reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->After);
}

bool clang_UserDefinedConversionSequence_getEllipsisConversion(
    CXUserDefinedConversionSequence UDCS) {
  return reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->EllipsisConversion;
}

void clang_UserDefinedConversionSequence_setEllipsisConversion(
    CXUserDefinedConversionSequence UDCS, bool V) {
  reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->EllipsisConversion = V;
}

bool clang_UserDefinedConversionSequence_getHadMultipleCandidates(
    CXUserDefinedConversionSequence UDCS) {
  return reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->HadMultipleCandidates;
}

void clang_UserDefinedConversionSequence_setHadMultipleCandidates(
    CXUserDefinedConversionSequence UDCS, bool V) {
  reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->HadMultipleCandidates = V;
}

CXFunctionDecl clang_UserDefinedConversionSequence_getConversionFunction(
    CXUserDefinedConversionSequence UDCS) {
  return reinterpret_cast<CXFunctionDecl>(reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->ConversionFunction);
}

void clang_UserDefinedConversionSequence_setConversionFunction(
    CXUserDefinedConversionSequence UDCS, CXFunctionDecl FD) {
  reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->ConversionFunction =
      reinterpret_cast<clang::FunctionDecl *>(FD);
}

void clang_UserDefinedConversionSequence_dump(CXUserDefinedConversionSequence UDCS) {
  reinterpret_cast<clang::UserDefinedConversionSequence *>(UDCS)->dump();
}

CXQualType
clang_AmbiguousConversionSequence_getFromType(CXAmbiguousConversionSequence ACS) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)
      ->getFromType()
      .getAsOpaquePtr());
}
...
void clang_AmbiguousConversionSequence_setFromType(CXAmbiguousConversionSequence ACS,
                                                   CXQualType T) {
  reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->setFromType(
      clang::QualType::getFromOpaquePtr(T));
}

void clang_AmbiguousConversionSequence_setToType(CXAmbiguousConversionSequence ACS,
                                                 CXQualType T) {
  reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->setToType(
      clang::QualType::getFromOpaquePtr(T));
}

void clang_AmbiguousConversionSequence_addConversion(CXAmbiguousConversionSequence ACS,
                                                     CXNamedDecl Found, CXFunctionDecl D) {
  reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->addConversion(
      reinterpret_cast<clang::NamedDecl *>(Found), reinterpret_cast<clang::FunctionDecl *>(D));
}

unsigned
clang_AmbiguousConversionSequence_getNumConversions(CXAmbiguousConversionSequence ACS) {
  return static_cast<unsigned>(
      reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->conversions().size());
}

CXNamedDecl
clang_AmbiguousConversionSequence_getConversionFound(CXAmbiguousConversionSequence ACS,
                                                     unsigned I) {
  return reinterpret_cast<CXNamedDecl>(reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->conversions()[I].first);
}

CXFunctionDecl
clang_AmbiguousConversionSequence_getConversionFunction(CXAmbiguousConversionSequence ACS,
                                                        unsigned I) {
  return reinterpret_cast<CXFunctionDecl>(reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->conversions()[I].second);
}

void clang_AmbiguousConversionSequence_construct(CXAmbiguousConversionSequence ACS) {
  reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->construct();
}

void clang_AmbiguousConversionSequence_destruct(CXAmbiguousConversionSequence ACS) {
  reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->destruct();
}

void clang_AmbiguousConversionSequence_copyFrom(CXAmbiguousConversionSequence ACS,
                                                CXAmbiguousConversionSequence Other) {
  reinterpret_cast<clang::AmbiguousConversionSequence *>(ACS)->copyFrom(
      *reinterpret_cast<clang::AmbiguousConversionSequence *>(Other));
}

void clang_BadConversionSequence_init(CXBadConversionSequence BCS,
                                      CXBadConversionSequence_FailureKind K, CXExpr From,
                                      CXQualType To) {
  reinterpret_cast<clang::BadConversionSequence *>(BCS)->init(
      static_cast<clang::BadConversionSequence::FailureKind>(K),
      reinterpret_cast<clang::Expr *>(From), clang::QualType::getFromOpaquePtr(To));
}

CXQualType clang_BadConversionSequence_getFromType(CXBadConversionSequence BCS) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::BadConversionSequence *>(BCS)->getFromType().getAsOpaquePtr());
}

CXQualType clang_BadConversionSequence_getToType(CXBadConversionSequence BCS) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::BadConversionSequence *>(BCS)->getToType().getAsOpaquePtr());
}
...
CXImplicitConversionSequence clang_ImplicitConversionSequence_create(void) {
  ...
  return reinterpret_cast<CXImplicitConversionSequence>(ICS.release());
}

void clang_ImplicitConversionSequence_dispose(CXImplicitConversionSequence ICS) {
  delete reinterpret_cast<clang::ImplicitConversionSequence *>(ICS);
}
...
clang_ImplicitConversionSequence_getKind(CXImplicitConversionSequence ICS) {
  return static_cast<CXImplicitConversionSequence_Kind>(
      reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->getKind());
}

unsigned clang_ImplicitConversionSequence_getKindRank(CXImplicitConversionSequence ICS) {
  return reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->getKindRank();
}

CXStandardConversionSequence
clang_ImplicitConversionSequence_getStandard(CXImplicitConversionSequence ICS) {
  return reinterpret_cast<CXStandardConversionSequence>(&reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->Standard);
}

CXBadConversionSequence
clang_ImplicitConversionSequence_getBad(CXImplicitConversionSequence ICS) {
  return reinterpret_cast<CXBadConversionSequence>(&reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->Bad);
}

CXAmbiguousConversionSequence
clang_ImplicitConversionSequence_getAmbiguous(CXImplicitConversionSequence ICS) {
  return reinterpret_cast<CXAmbiguousConversionSequence>(&reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->Ambiguous);
}

CXUserDefinedConversionSequence
clang_ImplicitConversionSequence_getUserDefined(CXImplicitConversionSequence ICS) {
  return reinterpret_cast<CXUserDefinedConversionSequence>(&reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->UserDefined);
}

bool clang_ImplicitConversionSequence_isInitialized(CXImplicitConversionSequence ICS) {
  return reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->isInitialized();
}
...
void clang_ImplicitConversionSequence_setBad(CXImplicitConversionSequence ICS,
  ...
  reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->setBad(
...
void clang_ImplicitConversionSequence_setInitializerListContainerType(
  ...
  reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->setInitializerListContainerType(
...
CXQualType clang_ImplicitConversionSequence_getInitializerListContainerType(
    CXImplicitConversionSequence ICS) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)
...
void clang_ImplicitConversionSequence_dump(CXImplicitConversionSequence ICS) {
  reinterpret_cast<clang::ImplicitConversionSequence *>(ICS)->dump();
}
...
clang_OverloadCandidate_getRewriteKind(CXOverloadCandidate C) {
  return static_cast<CXOverloadCandidateRewriteKind>(
      reinterpret_cast<clang::OverloadCandidate *>(C)->getRewriteKind());
}

bool clang_OverloadCandidate_isReversed(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->isReversed();
}

bool clang_OverloadCandidate_hasAmbiguousConversion(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->hasAmbiguousConversion();
}

bool clang_OverloadCandidate_TryToFixBadConversion(CXOverloadCandidate C, unsigned Idx,
                                                   CXSema S) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->TryToFixBadConversion(
      Idx, *reinterpret_cast<clang::Sema *>(S));
}

unsigned clang_OverloadCandidate_getNumParams(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->getNumParams();
}

bool clang_OverloadCandidate_NotValidBecauseConstraintExprHasError(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)
      ->NotValidBecauseConstraintExprHasError();
}

unsigned clang_OverloadCandidate_getNumConversions(CXOverloadCandidate C) {
  return static_cast<unsigned>(
      reinterpret_cast<clang::OverloadCandidate *>(C)->Conversions.size());
}

CXImplicitConversionSequence clang_OverloadCandidate_getConversion(CXOverloadCandidate C,
                                                                   unsigned I) {
  return reinterpret_cast<CXImplicitConversionSequence>(&reinterpret_cast<clang::OverloadCandidate *>(C)->Conversions[I]);
}

CXFunctionDecl clang_OverloadCandidate_getFunction(CXOverloadCandidate C) {
  return reinterpret_cast<CXFunctionDecl>(reinterpret_cast<clang::OverloadCandidate *>(C)->Function);
}

CXCXXConversionDecl clang_OverloadCandidate_getSurrogate(CXOverloadCandidate C) {
  return reinterpret_cast<CXCXXConversionDecl>(reinterpret_cast<clang::OverloadCandidate *>(C)->Surrogate);
}

bool clang_OverloadCandidate_getViable(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->Viable;
}

bool clang_OverloadCandidate_getBest(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->Best;
}

bool clang_OverloadCandidate_isSurrogate(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->IsSurrogate;
}

bool clang_OverloadCandidate_getIgnoreObjectArgument(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->IgnoreObjectArgument;
}

unsigned clang_OverloadCandidate_getExplicitCallArguments(CXOverloadCandidate C) {
  return reinterpret_cast<clang::OverloadCandidate *>(C)->ExplicitCallArguments;
}
...
clang_OverloadCandidateSet_create(CXSourceLocation_ Loc,
  ...
  return reinterpret_cast<CXOverloadCandidateSet>(CS.release());
}

void clang_OverloadCandidateSet_dispose(CXOverloadCandidateSet CS) {
  delete reinterpret_cast<clang::OverloadCandidateSet *>(CS);
}
...
CXSourceLocation_ clang_OverloadCandidateSet_getLocation(CXOverloadCandidateSet CS) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::OverloadCandidateSet *>(CS)->getLocation().getPtrEncoding());
}
...
clang_OverloadCandidateSet_getKind(CXOverloadCandidateSet CS) {
  return static_cast<CXOverloadCandidateSet_CandidateSetKind>(
      reinterpret_cast<clang::OverloadCandidateSet *>(CS)->getKind());
}
...
clang_OverloadCandidateSet_getRewriteInfoOriginalOperator(CXOverloadCandidateSet CS) {
  return static_cast<CXOverloadedOperatorKind>(
      reinterpret_cast<clang::OverloadCandidateSet *>(CS)->getRewriteInfo().OriginalOperator);
}

CXSourceLocation_
clang_OverloadCandidateSet_getRewriteInfoOpLoc(CXOverloadCandidateSet CS) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::OverloadCandidateSet *>(CS)
      ->getRewriteInfo()
...
bool clang_OverloadCandidateSet_getRewriteInfoAllowRewrittenCandidates(
  ...
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)
      ->getRewriteInfo()
...
bool clang_OverloadCandidateSet_rewriteInfoIsRewrittenOperator(CXOverloadCandidateSet CS,
  ...
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)
      ->getRewriteInfo()
      .isRewrittenOperator(reinterpret_cast<clang::FunctionDecl *>(FD));
}
...
bool clang_OverloadCandidateSet_rewriteInfoIsAcceptableCandidate(CXOverloadCandidateSet CS,
  ...
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)
      ->getRewriteInfo()
      .isAcceptableCandidate(reinterpret_cast<clang::FunctionDecl *>(FD));
}
...
clang_OverloadCandidateSet_rewriteInfoGetRewriteKind(CXOverloadCandidateSet CS,
  ...
  return static_cast<CXOverloadCandidateRewriteKind>(
      reinterpret_cast<clang::OverloadCandidateSet *>(CS)->getRewriteInfo().getRewriteKind(
          reinterpret_cast<clang::FunctionDecl *>(FD),
...
bool clang_OverloadCandidateSet_rewriteInfoIsReversible(CXOverloadCandidateSet CS) {
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)->getRewriteInfo().isReversible();
}

bool clang_OverloadCandidateSet_rewriteInfoAllowsReversed(CXOverloadCandidateSet CS,
                                                          CXOverloadedOperatorKind Op) {
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)->getRewriteInfo().allowsReversed(
      static_cast<clang::OverloadedOperatorKind>(Op));
}
...
bool clang_OverloadCandidateSet_shouldDeferDiags(CXOverloadCandidateSet CS, CXSema S,
  ...
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)->shouldDeferDiags(
      *reinterpret_cast<clang::Sema *>(S), ArgVec,
...
bool clang_OverloadCandidateSet_isNewCandidate(CXOverloadCandidateSet CS, CXDecl F,
                                               bool Reversed) {
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)->isNewCandidate(
      reinterpret_cast<clang::Decl *>(F), Reversed ? clang::OverloadCandidateParamOrder::Reversed
                                              : clang::OverloadCandidateParamOrder::Normal);
}

void clang_OverloadCandidateSet_exclude(CXOverloadCandidateSet CS, CXDecl F) {
  reinterpret_cast<clang::OverloadCandidateSet *>(CS)->exclude(reinterpret_cast<clang::Decl *>(F));
}

void clang_OverloadCandidateSet_clear(CXOverloadCandidateSet CS,
                                      CXOverloadCandidateSet_CandidateSetKind CSK) {
  reinterpret_cast<clang::OverloadCandidateSet *>(CS)->clear(
      static_cast<clang::OverloadCandidateSet::CandidateSetKind>(CSK));
}

size_t clang_OverloadCandidateSet_size(CXOverloadCandidateSet CS) {
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)->size();
}

bool clang_OverloadCandidateSet_empty(CXOverloadCandidateSet CS) {
  return reinterpret_cast<clang::OverloadCandidateSet *>(CS)->empty();
}

CXOverloadCandidate clang_OverloadCandidateSet_getCandidate(CXOverloadCandidateSet CS,
                                                            unsigned I) {
  return reinterpret_cast<CXOverloadCandidate>(reinterpret_cast<clang::OverloadCandidateSet *>(CS)->begin() + I);
}
...
void clang_OverloadCandidateSet_allocateConversionSequences(
  ...
  clang::ConversionSequenceList Seqs =
      reinterpret_cast<clang::OverloadCandidateSet *>(CS)->allocateConversionSequences(
          NumConversions);
  for (unsigned I = 0; I < NumConversions; ++I)
    Out[I] = reinterpret_cast<CXImplicitConversionSequence>(Seqs.data() + I);
}

CXOverloadCandidate clang_OverloadCandidateSet_addCandidate(CXOverloadCandidateSet CS,
                                                            unsigned NumConversions) {
  clang::OverloadCandidate &C =
      reinterpret_cast<clang::OverloadCandidateSet *>(CS)->addCandidate(NumConversions);
  ...
  return reinterpret_cast<CXOverloadCandidate>(&C);
}
...
CXOverloadingResult clang_OverloadCandidateSet_BestViableFunction(
  ...
  auto *Set = reinterpret_cast<clang::OverloadCandidateSet *>(CS);
  clang::OverloadCandidateSet::iterator It = Set->end();
  clang::OverloadingResult R = Set->BestViableFunction(
      *reinterpret_cast<clang::Sema *>(S), clang::SourceLocation::getFromPtrEncoding(Loc), It);
  ...
  *Best = reinterpret_cast<CXOverloadCandidate>(It == Set->end() ? nullptr : It);
...
unsigned clang_OverloadCandidateSet_CompleteCandidates(CXOverloadCandidateSet CS, CXSema S,
  ...
  llvm::SmallVector<clang::OverloadCandidate *, 32> Cands =
      reinterpret_cast<clang::OverloadCandidateSet *>(CS)->CompleteCandidates(
  ...
  if (Out) {
    ...
    for (unsigned I = 0; I < N; ++I)
      Out[I] = reinterpret_cast<CXOverloadCandidate>(Cands[I]);
  }
  return Total;
}

CXLangAS clang_OverloadCandidateSet_getDestAS(CXOverloadCandidateSet CS) {
  return static_cast<CXLangAS>(reinterpret_cast<clang::OverloadCandidateSet *>(CS)->getDestAS());
}

void clang_OverloadCandidateSet_setDestAS(CXOverloadCandidateSet CS, CXLangAS AS) {
  reinterpret_cast<clang::OverloadCandidateSet *>(CS)->setDestAS(static_cast<clang::LangAS>(AS));
}
