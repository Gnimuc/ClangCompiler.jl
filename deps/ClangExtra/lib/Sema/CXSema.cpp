...
bool clang_Sema_CheckFunctionReturnType(CXSema S, CXQualType T, CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)->CheckFunctionReturnType(
...
CXFunctionDecl clang_Sema_FindUsualDeallocationFunction(CXSema S,
  ...
  return static_cast<clang::Sema *>(S)->FindUsualDeallocationFunction(
...
CXFunctionDecl clang_Sema_FindDeallocationFunctionForDestructor(CXSema S,
                                                                CXSourceLocation_ StartLoc,
                                                                CXCXXRecordDecl RD) {
  return static_cast<clang::Sema *>(S)->FindDeallocationFunctionForDestructor(
...
CXNamedDecl clang_Sema_FindFirstQualifierInScope(CXSema S, CXScope Sp,
  ...
  return static_cast<clang::Sema *>(S)->FindFirstQualifierInScope(
      static_cast<clang::Scope *>(Sp), static_cast<clang::NestedNameSpecifier *>(NNS));
}
...
bool clang_Sema_CheckDerivedToBaseConversion(CXSema S, CXQualType Derived, CXQualType Base,
                                             ...
                                             bool IgnoreAccess) {
  return static_cast<clang::Sema *>(S)->CheckDerivedToBaseConversion(
...
bool clang_Sema_CheckIfOverriddenFunctionIsMarkedFinal(CXSema S, CXCXXMethodDecl New,
                                                       CXCXXMethodDecl Old) {
  return static_cast<clang::Sema *>(S)->CheckIfOverriddenFunctionIsMarkedFinal(
      static_cast<clang::CXXMethodDecl *>(New), static_cast<clang::CXXMethodDecl *>(Old));
}

bool clang_Sema_AddOverriddenMethods(CXSema S, CXCXXRecordDecl DC, CXCXXMethodDecl MD) {
  return static_cast<clang::Sema *>(S)->AddOverriddenMethods(
      static_cast<clang::CXXRecordDecl *>(DC), static_cast<clang::CXXMethodDecl *>(MD));
}

void clang_Sema_SetParamDefaultArgument(CXSema S, CXParmVarDecl Param, CXExpr DefaultArg,
                                        CXSourceLocation_ EqualLoc) {
  static_cast<clang::Sema *>(S)->SetParamDefaultArgument(
      static_cast<clang::ParmVarDecl *>(Param), static_cast<clang::Expr *>(DefaultArg),
...
void clang_Sema_ForceDeclarationOfImplicitMembers(CXSema S, CXCXXRecordDecl Class) {
  static_cast<clang::Sema *>(S)->ForceDeclarationOfImplicitMembers(
      static_cast<clang::CXXRecordDecl *>(Class));
}

void clang_Sema_DefineImplicitDefaultConstructor(CXSema S, CXSourceLocation_ Loc,
                                                 CXCXXConstructorDecl Constructor) {
  static_cast<clang::Sema *>(S)->DefineImplicitDefaultConstructor(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXConstructorDecl *>(Constructor));
}

void clang_Sema_DefineImplicitDestructor(CXSema S, CXSourceLocation_ Loc,
                                         CXCXXDestructorDecl Destructor) {
  static_cast<clang::Sema *>(S)->DefineImplicitDestructor(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXDestructorDecl *>(Destructor));
}
...
void clang_Sema_DefineImplicitCopyConstructor(CXSema S, CXSourceLocation_ Loc,
                                              CXCXXConstructorDecl Constructor) {
  static_cast<clang::Sema *>(S)->DefineImplicitCopyConstructor(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXConstructorDecl *>(Constructor));
}
...
void clang_Sema_DefineImplicitMoveConstructor(CXSema S, CXSourceLocation_ Loc,
                                              CXCXXConstructorDecl Constructor) {
  static_cast<clang::Sema *>(S)->DefineImplicitMoveConstructor(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXConstructorDecl *>(Constructor));
}
...
void clang_Sema_DefineImplicitCopyAssignment(CXSema S, CXSourceLocation_ Loc,
  ...
  static_cast<clang::Sema *>(S)->DefineImplicitCopyAssignment(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXMethodDecl *>(MethodDecl));
}

void clang_Sema_DefineImplicitMoveAssignment(CXSema S, CXSourceLocation_ Loc,
                                             CXCXXMethodDecl MethodDecl) {
  static_cast<clang::Sema *>(S)->DefineImplicitMoveAssignment(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXMethodDecl *>(MethodDecl));
}

bool clang_Sema_DefineUsedVTables(CXSema S) {
  return static_cast<clang::Sema *>(S)->DefineUsedVTables();
}

void clang_Sema_AddImplicitlyDeclaredMembersToClass(CXSema S, CXCXXRecordDecl ClassDecl) {
  static_cast<clang::Sema *>(S)->AddImplicitlyDeclaredMembersToClass(
      static_cast<clang::CXXRecordDecl *>(ClassDecl));
}
...
bool clang_Sema_SetMemberAccessSpecifier(CXSema S, CXNamedDecl MemberDecl,
  ...
  return static_cast<clang::Sema *>(S)->SetMemberAccessSpecifier(
      static_cast<clang::NamedDecl *>(MemberDecl),
      static_cast<clang::NamedDecl *>(PrevMemberDecl),
      static_cast<clang::AccessSpecifier>(LexicalAS));
}

CXTemplateDecl clang_Sema_AdjustDeclIfTemplate(CXSema S, CXDecl *D) {
  clang::Decl *Inner = static_cast<clang::Decl *>(*D);
  clang::TemplateDecl *TD = static_cast<clang::Sema *>(S)->AdjustDeclIfTemplate(Inner);
  *D = Inner;
  return TD;
}
...
CXQualType clang_Sema_BuildArrayType(CXSema S, CXQualType T, CXArraySizeModifier ASM,
  ...
  return static_cast<clang::Sema *>(S)
      ->BuildArrayType(
          ...
          static_cast<clang::Expr *>(ArraySize), Quals,
...
CXQualType clang_Sema_BuildVectorType(CXSema S, CXQualType T, CXExpr VecSize,
  ...
  return static_cast<clang::Sema *>(S)
      ->BuildVectorType(clang::QualType::getFromOpaquePtr(T),
                        static_cast<clang::Expr *>(VecSize),
...
CXQualType clang_Sema_BuildExtVectorType(CXSema S, CXQualType T, CXExpr ArraySize,
  ...
  return static_cast<clang::Sema *>(S)
      ->BuildExtVectorType(clang::QualType::getFromOpaquePtr(T),
                           static_cast<clang::Expr *>(ArraySize),
                           clang::SourceLocation::getFromPtrEncoding(AttrLoc))
      .getAsOpaquePtr();
}
...
CXQualType clang_Sema_BuildBitIntType(CXSema S, bool IsUnsigned, CXExpr BitWidth,
                                      CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)
      ->BuildBitIntType(IsUnsigned, static_cast<clang::Expr *>(BitWidth),
                        clang::SourceLocation::getFromPtrEncoding(Loc))
      .getAsOpaquePtr();
}
...
CXQualType clang_Sema_BuildTypeofExprType(CXSema S, CXExpr E, CXTypeOfKind Kind) {
  return static_cast<clang::Sema *>(S)
      ->BuildTypeofExprType(static_cast<clang::Expr *>(E),
...
CXQualType clang_Sema_BuildDecltypeType(CXSema S, CXExpr E, bool AsUnevaluated) {
  return static_cast<clang::Sema *>(S)
      ->BuildDecltypeType(static_cast<clang::Expr *>(E), AsUnevaluated)
      .getAsOpaquePtr();
}
...
CXExpr clang_Sema_CreateBuiltinUnaryOp(CXSema S, CXSourceLocation_ OpLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CreateBuiltinUnaryOp(
      clang::SourceLocation::getFromPtrEncoding(OpLoc),
      static_cast<clang::UnaryOperatorKind>(Opc), static_cast<clang::Expr *>(InputExpr),
      IsAfterAmp);
...
CXExpr clang_Sema_CreateUnaryExprOrTypeTraitExpr(CXSema S, CXTypeSourceInfo TInfo,
  ...
  clang::ExprResult Res = static_cast<clang::Sema *>(S)->CreateUnaryExprOrTypeTraitExpr(
  ...
  *IsInvalid = Res.isInvalid();
  return Res.isInvalid() ? nullptr : Res.get();
}
...
CXExpr clang_Sema_CreateBuiltinArraySubscriptExpr(CXSema S, CXExpr Base,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CreateBuiltinArraySubscriptExpr(
      static_cast<clang::Expr *>(Base), clang::SourceLocation::getFromPtrEncoding(LLoc),
      static_cast<clang::Expr *>(Idx), clang::SourceLocation::getFromPtrEncoding(RLoc));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_CreateBuiltinBinOp(CXSema S, CXSourceLocation_ OpLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CreateBuiltinBinOp(
      clang::SourceLocation::getFromPtrEncoding(OpLoc),
      static_cast<clang::BinaryOperatorKind>(Opc), static_cast<clang::Expr *>(LHSExpr),
      static_cast<clang::Expr *>(RHSExpr));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildInitList(CXSema S, CXSourceLocation_ LBraceLoc,
  ...
  for (unsigned I = 0; I != NumInits; ++I)
    Inits.push_back(static_cast<clang::Expr *>(InitArgList[I]));
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildInitList(
...
CXExpr clang_Sema_BuildCXXNoexceptExpr(CXSema S, CXSourceLocation_ KeyLoc, CXExpr Operand,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXNoexceptExpr(
      clang::SourceLocation::getFromPtrEncoding(KeyLoc),
      static_cast<clang::Expr *>(Operand),
...
CXParmVarDecl clang_Sema_BuildParmVarDeclForTypedef(CXSema S, CXDeclContext DC,
  ...
  return static_cast<clang::Sema *>(S)->BuildParmVarDeclForTypedef(
      static_cast<clang::DeclContext *>(DC), clang::SourceLocation::getFromPtrEncoding(Loc),
      clang::QualType::getFromOpaquePtr(T));
}
...
CXExpr clang_Sema_CreateRecoveryExpr(CXSema S, CXSourceLocation_ Begin,
  ...
  for (unsigned I = 0; I != NumSubExprs; ++I)
    Subs.push_back(static_cast<clang::Expr *>(SubExprs[I]));
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CreateRecoveryExpr(
...
CXDeclRefExpr clang_Sema_BuildDeclRefExpr(CXSema S, CXValueDecl D, CXQualType Ty,
                                          ...
                                          CXCXXScopeSpec SS) {
  return static_cast<clang::Sema *>(S)->BuildDeclRefExpr(
      static_cast<clang::ValueDecl *>(D), clang::QualType::getFromOpaquePtr(Ty),
      static_cast<clang::ExprValueKind>(VK), clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<const clang::CXXScopeSpec *>(SS));
}
...
CXExpr clang_Sema_BuildUnaryOp(CXSema S, CXScope Sp, CXSourceLocation_ OpLoc,
                               ...
                               bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildUnaryOp(
      static_cast<clang::Scope *>(Sp), clang::SourceLocation::getFromPtrEncoding(OpLoc),
      static_cast<clang::UnaryOperatorKind>(Opc), static_cast<clang::Expr *>(Input),
      IsAfterAmp);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildCallExpr(CXSema S, CXScope Sp, CXExpr Fn,
  ...
  for (unsigned I = 0; I != NumArgs; ++I)
    Args.push_back(static_cast<clang::Expr *>(ArgExprs[I]));
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCallExpr(
      static_cast<clang::Scope *>(Sp), static_cast<clang::Expr *>(Fn),
      clang::SourceLocation::getFromPtrEncoding(LParenLoc), Args,
      clang::SourceLocation::getFromPtrEncoding(RParenLoc),
      static_cast<clang::Expr *>(ExecConfig), IsExecConfig, AllowRecovery);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildCStyleCastExpr(CXSema S, CXSourceLocation_ LParenLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCStyleCastExpr(
      clang::SourceLocation::getFromPtrEncoding(LParenLoc),
      static_cast<clang::TypeSourceInfo *>(Ty),
      clang::SourceLocation::getFromPtrEncoding(RParenLoc), static_cast<clang::Expr *>(Op));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildBinOp(CXSema S, CXScope Sp, CXSourceLocation_ OpLoc,
                             ...
                             bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildBinOp(
      static_cast<clang::Scope *>(Sp), clang::SourceLocation::getFromPtrEncoding(OpLoc),
      static_cast<clang::BinaryOperatorKind>(Opc), static_cast<clang::Expr *>(LHSExpr),
      static_cast<clang::Expr *>(RHSExpr));
  *IsInvalid = R.isInvalid();
...
CXExpr clang_Sema_BuildAsTypeExpr(CXSema S, CXExpr E, CXQualType DestTy,
                                  ...
                                  bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildAsTypeExpr(
      static_cast<clang::Expr *>(E), clang::QualType::getFromOpaquePtr(DestTy),
...
CXExpr clang_Sema_BuildBuiltinBitCastExpr(CXSema S, CXSourceLocation_ KWLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildBuiltinBitCastExpr(
      clang::SourceLocation::getFromPtrEncoding(KWLoc),
      static_cast<clang::TypeSourceInfo *>(TSI), static_cast<clang::Expr *>(Operand),
      clang::SourceLocation::getFromPtrEncoding(RParenLoc));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildEmptyCXXFoldExpr(CXSema S, CXSourceLocation_ EllipsisLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildEmptyCXXFoldExpr(
...
CXExpr clang_Sema_BuildCXXTypeConstructExpr(CXSema S, CXTypeSourceInfo Type,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXTypeConstructExpr(
      static_cast<clang::TypeSourceInfo *>(Type),
      clang::SourceLocation::getFromPtrEncoding(LParenLoc), Args,
...
CXExpr clang_Sema_BuildTypeTrait(CXSema S, CXTypeTrait Kind, CXSourceLocation_ KWLoc,
  ...
  for (unsigned I = 0; I != NumArgs; ++I)
    TSIs.push_back(static_cast<clang::TypeSourceInfo *>(Args[I]));
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildTypeTrait(
...
CXExpr clang_Sema_BuildArrayTypeTrait(CXSema S, CXArrayTypeTrait ATT,
                                      ...
                                      bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildArrayTypeTrait(
      static_cast<clang::ArrayTypeTrait>(ATT),
      clang::SourceLocation::getFromPtrEncoding(KWLoc),
      static_cast<clang::TypeSourceInfo *>(TSInfo), static_cast<clang::Expr *>(DimExpr),
      clang::SourceLocation::getFromPtrEncoding(RParen));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildExpressionTrait(CXSema S, CXExpressionTrait OET,
                                       ...
                                       CXSourceLocation_ RParen, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildExpressionTrait(
      static_cast<clang::ExpressionTrait>(OET),
      clang::SourceLocation::getFromPtrEncoding(KWLoc), static_cast<clang::Expr *>(Queried),
      clang::SourceLocation::getFromPtrEncoding(RParen));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
clang_Sema_CreateMaterializeTemporaryExpr(CXSema S, CXQualType T, CXExpr Temporary,
  ...
  return static_cast<clang::Sema *>(S)->CreateMaterializeTemporaryExpr(
      clang::QualType::getFromOpaquePtr(T), static_cast<clang::Expr *>(Temporary),
...
CXDecl clang_Sema_BuildStaticAssertDeclaration(CXSema S, CXSourceLocation_ StaticAssertLoc,
  ...
  return static_cast<clang::Sema *>(S)->BuildStaticAssertDeclaration(
      clang::SourceLocation::getFromPtrEncoding(StaticAssertLoc),
      static_cast<clang::Expr *>(AssertExpr), static_cast<clang::Expr *>(AssertMessageExpr),
...
CXExpr clang_Sema_BuildExpressionFromNonTypeTemplateArgument(CXSema S,
                                                             ...
                                                             bool *IsInvalid) {
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->BuildExpressionFromNonTypeTemplateArgument(
...
CXExpr clang_Sema_BuildCXXFunctionalCastExpr(CXSema S, CXTypeSourceInfo TInfo,
                                             ...
                                             bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXFunctionalCastExpr(
      static_cast<clang::TypeSourceInfo *>(TInfo), clang::QualType::getFromOpaquePtr(Type),
      clang::SourceLocation::getFromPtrEncoding(LParenLoc),
      static_cast<clang::Expr *>(CastExpr),
      clang::SourceLocation::getFromPtrEncoding(RParenLoc));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXDeclGroupRef clang_Sema_BuildDeclaratorGroup(CXSema S, const CXDecl *Group,
  ...
  for (unsigned I = 0; I != NumDecls; ++I)
    Decls.push_back(static_cast<clang::Decl *>(Group[I]));
  return static_cast<clang::Sema *>(S)->BuildDeclaratorGroup(Decls).getAsOpaquePtr();
}

CXExpr clang_Sema_MakeFullExpr(CXSema S, CXExpr Arg, CXSourceLocation_ CC) {
  return static_cast<clang::Sema *>(S)
      ->MakeFullExpr(static_cast<clang::Expr *>(Arg),
...
CXExpr clang_Sema_MakeFullDiscardedValueExpr(CXSema S, CXExpr Arg) {
  return static_cast<clang::Sema *>(S)
      ->MakeFullDiscardedValueExpr(static_cast<clang::Expr *>(Arg))
      .get();
}
...
CXVarDecl clang_Sema_BuildExceptionDeclaration(CXSema S, CXScope Sp, CXTypeSourceInfo TInfo,
                                               ...
                                               CXIdentifierInfo Id) {
  return static_cast<clang::Sema *>(S)->BuildExceptionDeclaration(
      static_cast<clang::Scope *>(Sp), static_cast<clang::TypeSourceInfo *>(TInfo),
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
...
CXExpr clang_Sema_BuildSYCLUniqueStableNameExpr(CXSema S, CXSourceLocation_ OpLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildSYCLUniqueStableNameExpr(
      clang::SourceLocation::getFromPtrEncoding(OpLoc),
...
CXExpr clang_Sema_BuildFieldReferenceExpr(CXSema S, CXExpr BaseExpr, bool IsArrow,
                                          ...
                                          bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildFieldReferenceExpr(
      static_cast<clang::Expr *>(BaseExpr), IsArrow,
      clang::SourceLocation::getFromPtrEncoding(OpLoc),
      *static_cast<clang::CXXScopeSpec *>(SS), static_cast<clang::FieldDecl *>(Field),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(FoundDecl),
...
CXExpr clang_Sema_BuildCompoundLiteralExpr(CXSema S, CXSourceLocation_ LParenLoc,
                                           ...
                                           bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCompoundLiteralExpr(
      clang::SourceLocation::getFromPtrEncoding(LParenLoc),
      static_cast<clang::TypeSourceInfo *>(TInfo),
      clang::SourceLocation::getFromPtrEncoding(RParenLoc),
      static_cast<clang::Expr *>(LiteralExpr));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildVAArgExpr(CXSema S, CXSourceLocation_ BuiltinLoc, CXExpr E,
                                 ...
                                 bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildVAArgExpr(
      clang::SourceLocation::getFromPtrEncoding(BuiltinLoc), static_cast<clang::Expr *>(E),
      static_cast<clang::TypeSourceInfo *>(TInfo),
...
CXExpr clang_Sema_BuildCXXNamedCast(CXSema S, CXSourceLocation_ OpLoc, unsigned Kind,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXNamedCast(
      clang::SourceLocation::getFromPtrEncoding(OpLoc),
      static_cast<clang::tok::TokenKind>(Kind), static_cast<clang::TypeSourceInfo *>(Ty),
...
CXExpr clang_Sema_BuildCXXTypeId(CXSema S, CXQualType TypeInfoType,
                                 ...
                                 CXSourceLocation_ RParenLoc, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXTypeId(
      clang::QualType::getFromOpaquePtr(TypeInfoType),
      clang::SourceLocation::getFromPtrEncoding(TypeidLoc),
      static_cast<clang::TypeSourceInfo *>(Operand),
      clang::SourceLocation::getFromPtrEncoding(RParenLoc));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildExpressionFromDeclTemplateArgument(CXSema S, CXTemplateArgument Arg,
                                                          ...
                                                          bool *IsInvalid) {
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->BuildExpressionFromDeclTemplateArgument(
          *static_cast<clang::TemplateArgument *>(Arg),
...
CXQualType clang_Sema_BuildFunctionType(CXSema S, CXQualType T, CXQualType *ParamTypes,
  ...
  clang::QualType R = static_cast<clang::Sema *>(S)->BuildFunctionType(
      clang::QualType::getFromOpaquePtr(T), Params,
      clang::SourceLocation::getFromPtrEncoding(Loc),
      clang::DeclarationName::getFromOpaquePtr(Entity), EPI);
  for (unsigned I = 0; I < NumParams; ++I)
    ParamTypes[I] = Params[I].getAsOpaquePtr();
  return R.getAsOpaquePtr();
}

CXExpr clang_Sema_BuildConvertedConstantExpression(CXSema S, CXExpr From, CXQualType T,
                                                   CXCCEKind CCE, CXNamedDecl Dest,
                                                   bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildConvertedConstantExpression(
      static_cast<clang::Expr *>(From), clang::QualType::getFromOpaquePtr(T),
      static_cast<clang::Sema::CCEKind>(CCE), static_cast<clang::NamedDecl *>(Dest));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildDeclarationNameExpr(CXSema S, CXCXXScopeSpec SS, CXLookupResult R,
                                           ...
                                           bool *IsInvalid) {
  clang::ExprResult Res = static_cast<clang::Sema *>(S)->BuildDeclarationNameExpr(
      *static_cast<clang::CXXScopeSpec *>(SS), *static_cast<clang::LookupResult *>(R),
...
CXExpr clang_Sema_BuildPredefinedExpr(CXSema S, CXSourceLocation_ Loc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildPredefinedExpr(
      clang::SourceLocation::getFromPtrEncoding(Loc),
...
CXExpr clang_Sema_BuildBuiltinOffsetOf(
  ...
  for (unsigned I = 0; I < NumComponents; ++I) {
    ...
    if (C.isBrackets)
      C.U.E = static_cast<clang::Expr *>(Indices[I]);
    else
      C.U.IdentInfo = static_cast<clang::IdentifierInfo *>(Idents[I]);
    Components.push_back(C);
  }
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildBuiltinOffsetOf(
      clang::SourceLocation::getFromPtrEncoding(BuiltinLoc),
      static_cast<clang::TypeSourceInfo *>(TInfo), Components,
      clang::SourceLocation::getFromPtrEncoding(RParenLoc));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildSourceLocExpr(CXSema S, CXSourceLocIdentKind Kind,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildSourceLocExpr(
      static_cast<clang::SourceLocIdentKind>(Kind),
      clang::QualType::getFromOpaquePtr(ResultTy),
      clang::SourceLocation::getFromPtrEncoding(BuiltinLoc),
      clang::SourceLocation::getFromPtrEncoding(RParenLoc),
      static_cast<clang::DeclContext *>(ParentContext));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildCXXThrow(CXSema S, CXSourceLocation_ OpLoc, CXExpr Ex,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXThrow(
      clang::SourceLocation::getFromPtrEncoding(OpLoc), static_cast<clang::Expr *>(Ex),
      IsThrownVarInScope);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildTemplateIdExpr(CXSema S, CXCXXScopeSpec SS,
                                      ...
                                      bool *IsInvalid) {
  clang::ExprResult Res = static_cast<clang::Sema *>(S)->BuildTemplateIdExpr(
      *static_cast<clang::CXXScopeSpec *>(SS),
      clang::SourceLocation::getFromPtrEncoding(TemplateKWLoc),
      *static_cast<clang::LookupResult *>(R), RequiresADL,
...
CXTypeSourceInfo clang_Sema_RebuildTypeInCurrentInstantiation(CXSema S, CXTypeSourceInfo T,
                                                              CXSourceLocation_ Loc,
                                                              CXDeclarationName Name) {
  return static_cast<clang::Sema *>(S)->RebuildTypeInCurrentInstantiation(
...
bool clang_Sema_RebuildNestedNameSpecifierInCurrentInstantiation(CXSema S,
                                                                 CXCXXScopeSpec SS) {
  return static_cast<clang::Sema *>(S)->RebuildNestedNameSpecifierInCurrentInstantiation(
      *static_cast<clang::CXXScopeSpec *>(SS));
}

CXExpr clang_Sema_RebuildExprInCurrentInstantiation(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->RebuildExprInCurrentInstantiation(
      static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
bool clang_Sema_RebuildTemplateParamsInCurrentInstantiation(
  ...
  return static_cast<clang::Sema *>(S)->RebuildTemplateParamsInCurrentInstantiation(
...
void clang_Sema_MarkUnusedFileScopedDecl(CXSema S, CXDeclaratorDecl D) {
  static_cast<clang::Sema *>(S)->MarkUnusedFileScopedDecl(
      static_cast<clang::DeclaratorDecl *>(D));
}

void clang_Sema_MarkAnyDeclReferenced(CXSema S, CXSourceLocation_ Loc, CXDecl D,
                                      bool MightBeOdrUse) {
  static_cast<clang::Sema *>(S)->MarkAnyDeclReferenced(
      clang::SourceLocation::getFromPtrEncoding(Loc), static_cast<clang::Decl *>(D),
      MightBeOdrUse);
}

void clang_Sema_MarkFunctionReferenced(CXSema S, CXSourceLocation_ Loc, CXFunctionDecl Func,
                                       bool MightBeOdrUse) {
  static_cast<clang::Sema *>(S)->MarkFunctionReferenced(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::FunctionDecl *>(Func), MightBeOdrUse);
}

void clang_Sema_MarkVariableReferenced(CXSema S, CXSourceLocation_ Loc, CXVarDecl Var) {
  static_cast<clang::Sema *>(S)->MarkVariableReferenced(
      clang::SourceLocation::getFromPtrEncoding(Loc), static_cast<clang::VarDecl *>(Var));
}

void clang_Sema_MarkDeclarationsReferencedInType(CXSema S, CXSourceLocation_ Loc,
                                                 CXQualType T) {
  static_cast<clang::Sema *>(S)->MarkDeclarationsReferencedInType(
      clang::SourceLocation::getFromPtrEncoding(Loc), clang::QualType::getFromOpaquePtr(T));
}

void clang_Sema_MarkBaseAndMemberDestructorsReferenced(CXSema S, CXSourceLocation_ Loc,
                                                       CXCXXRecordDecl Record) {
  static_cast<clang::Sema *>(S)->MarkBaseAndMemberDestructorsReferenced(
      clang::SourceLocation::getFromPtrEncoding(Loc),
...
void clang_Sema_MarkVTableUsed(CXSema S, CXSourceLocation_ Loc, CXCXXRecordDecl Class,
  ...
  static_cast<clang::Sema *>(S)->MarkVTableUsed(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXRecordDecl *>(Class), DefinitionRequired);
}

void clang_Sema_MarkVirtualMemberExceptionSpecsNeeded(CXSema S, CXSourceLocation_ Loc,
                                                      CXCXXRecordDecl RD) {
  static_cast<clang::Sema *>(S)->MarkVirtualMemberExceptionSpecsNeeded(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXRecordDecl *>(RD));
}
...
void clang_Sema_MarkVirtualMembersReferenced(CXSema S, CXSourceLocation_ Loc,
  ...
  static_cast<clang::Sema *>(S)->MarkVirtualMembersReferenced(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::CXXRecordDecl *>(RD), ConstexprOnly);
}

bool clang_Sema_CheckTemplateArgument(CXSema S, CXTypeSourceInfo Arg) {
  return static_cast<clang::Sema *>(S)->CheckTemplateArgument(
      static_cast<clang::TypeSourceInfo *>(Arg));
}
...
CXTypeSourceInfo clang_Sema_SubstAutoTypeSourceInfo(CXSema S, CXTypeSourceInfo TypeWithAuto,
                                                    CXQualType Replacement) {
  return static_cast<clang::Sema *>(S)->SubstAutoTypeSourceInfo(
      static_cast<clang::TypeSourceInfo *>(TypeWithAuto),
      clang::QualType::getFromOpaquePtr(Replacement));
}
...
clang_Sema_SubstAutoTypeSourceInfoDependent(CXSema S, CXTypeSourceInfo TypeWithAuto) {
  return static_cast<clang::Sema *>(S)->SubstAutoTypeSourceInfoDependent(
      static_cast<clang::TypeSourceInfo *>(TypeWithAuto));
}
...
CXTypeSourceInfo clang_Sema_ReplaceAutoTypeSourceInfo(CXSema S,
                                                      ...
                                                      CXQualType Replacement) {
  return static_cast<clang::Sema *>(S)->ReplaceAutoTypeSourceInfo(
      static_cast<clang::TypeSourceInfo *>(TypeWithAuto),
      clang::QualType::getFromOpaquePtr(Replacement));
}
...
bool clang_Sema_DeduceReturnType(CXSema S, CXFunctionDecl FD, CXSourceLocation_ Loc,
                                 bool Diagnose) {
  return static_cast<clang::Sema *>(S)->DeduceReturnType(
      static_cast<clang::FunctionDecl *>(FD),
...
void clang_Sema_MarkDeducedTemplateParameters(CXSema S, CXFunctionTemplateDecl FTD,
  ...
  static_cast<clang::Sema *>(S)->MarkDeducedTemplateParameters(
      static_cast<clang::FunctionTemplateDecl *>(FTD), Bits);
...
bool clang_Sema_InstantiateDefaultArgument(CXSema S, CXSourceLocation_ CallLoc,
  ...
  return static_cast<clang::Sema *>(S)->InstantiateDefaultArgument(
      clang::SourceLocation::getFromPtrEncoding(CallLoc),
      static_cast<clang::FunctionDecl *>(FD), static_cast<clang::ParmVarDecl *>(Param));
}

void clang_Sema_InstantiateExceptionSpec(CXSema S, CXSourceLocation_ PointOfInstantiation,
                                         CXFunctionDecl Function) {
  static_cast<clang::Sema *>(S)->InstantiateExceptionSpec(
      clang::SourceLocation::getFromPtrEncoding(PointOfInstantiation),
      static_cast<clang::FunctionDecl *>(Function));
}
...
CXFunctionDecl clang_Sema_InstantiateFunctionDeclaration(CXSema S,
                                                         ...
                                                         CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)->InstantiateFunctionDeclaration(
      static_cast<clang::FunctionTemplateDecl *>(FTD),
...
unsigned clang_Sema_getNumCodeSynthesisContexts(CXSema S) {
  return static_cast<unsigned>(static_cast<clang::Sema *>(S)->CodeSynthesisContexts.size());
}
...
clang_InstantiatingTemplate_create(CXSema S, CXSourceLocation_ PointOfInstantiation,
  ...
  return new clang::Sema::InstantiatingTemplate( // NOLINT(*-owning-memory)
      *static_cast<clang::Sema *>(S),
      clang::SourceLocation::getFromPtrEncoding(PointOfInstantiation),
      static_cast<clang::Decl *>(Entity),
...
void clang_InstantiatingTemplate_dispose(CXInstantiatingTemplate Inst) {
  delete static_cast<clang::Sema::InstantiatingTemplate *>(Inst);
}

void clang_InstantiatingTemplate_Clear(CXInstantiatingTemplate Inst) {
  static_cast<clang::Sema::InstantiatingTemplate *>(Inst)->Clear();
}

bool clang_InstantiatingTemplate_isInvalid(CXInstantiatingTemplate Inst) {
  return static_cast<clang::Sema::InstantiatingTemplate *>(Inst)->isInvalid();
}

bool clang_InstantiatingTemplate_isAlreadyInstantiating(CXInstantiatingTemplate Inst) {
  return static_cast<clang::Sema::InstantiatingTemplate *>(Inst)->isAlreadyInstantiating();
}
...
CXTypeSourceInfo clang_Sema_SubstTypeSourceInfo(
  ...
  return static_cast<clang::Sema *>(S)->SubstType(
      static_cast<clang::TypeSourceInfo *>(T),
...
CXExpr clang_Sema_SubstExpr(CXSema S, CXExpr E,
                            CXMultiLevelTemplateArgumentList TemplateArgs,
                            bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->SubstExpr(
      static_cast<clang::Expr *>(E),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
...
CXExpr clang_Sema_SubstConstraintExpr(CXSema S, CXExpr E,
                                      CXMultiLevelTemplateArgumentList TemplateArgs,
                                      bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->SubstConstraintExpr(
      static_cast<clang::Expr *>(E),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
...
CXExpr clang_Sema_SubstConstraintExprWithoutSatisfaction(
  ...
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->SubstConstraintExprWithoutSatisfaction(
          static_cast<clang::Expr *>(E),
          extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
...
CXStmt clang_Sema_SubstStmt(CXSema S, CXStmt St,
                            CXMultiLevelTemplateArgumentList TemplateArgs,
                            bool *IsInvalid) {
  clang::StmtResult R = static_cast<clang::Sema *>(S)->SubstStmt(
      static_cast<clang::Stmt *>(St),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_SubstInitializer(CXSema S, CXExpr E,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->SubstInitializer(
      static_cast<clang::Expr *>(E),
...
clang_Sema_SubstNestedNameSpecifierLoc(CXSema S, CXNestedNameSpecifierLoc NNS,
  ...
  return new clang::NestedNameSpecifierLoc( // NOLINT(*-owning-memory)
      static_cast<clang::Sema *>(S)->SubstNestedNameSpecifierLoc(
          *static_cast<clang::NestedNameSpecifierLoc *>(NNS),
          extra::unboxMultiLevelTemplateArgumentList(TemplateArgs)));
}
...
clang_Sema_SubstDeclarationNameInfo(CXSema S, CXDeclarationNameInfo NameInfo,
                                    CXMultiLevelTemplateArgumentList TemplateArgs) {
  return new clang::DeclarationNameInfo( // NOLINT(*-owning-memory)
      static_cast<clang::Sema *>(S)->SubstDeclarationNameInfo(
...
bool clang_Sema_hasCurrentInstantiationScope(CXSema S) {
  return static_cast<clang::Sema *>(S)->CurrentInstantiationScope != nullptr;
}
...
CXTypeSourceInfo clang_Sema_SubstFunctionDeclType(
  ...
  return static_cast<clang::Sema *>(S)->SubstFunctionDeclType(
      static_cast<clang::TypeSourceInfo *>(T),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs),
      clang::SourceLocation::getFromPtrEncoding(Loc),
      clang::DeclarationName::getFromOpaquePtr(Entity),
      static_cast<clang::CXXRecordDecl *>(ThisContext),
...
void clang_Sema_SubstExceptionSpec(CXSema S, CXFunctionDecl New, CXFunctionProtoType Proto,
                                   CXMultiLevelTemplateArgumentList TemplateArgs) {
  static_cast<clang::Sema *>(S)->SubstExceptionSpec(
      static_cast<clang::FunctionDecl *>(New),
      static_cast<clang::FunctionProtoType *>(Proto),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
}
...
CXParmVarDecl clang_Sema_SubstParmVarDecl(CXSema S, CXParmVarDecl D,
  ...
  return static_cast<clang::Sema *>(S)->SubstParmVarDecl(
...
bool clang_Sema_SubstParmTypes(CXSema S, CXSourceLocation_ Loc, const CXParmVarDecl *Params,
  ...
  for (unsigned I = 0; I != NumParams; ++I)
    Inputs.push_back(static_cast<clang::ParmVarDecl *>(Params[I]));
  ...
  bool Failed = static_cast<clang::Sema *>(S)->SubstParmTypes(
...
bool clang_Sema_SubstDefaultArgument(CXSema S, CXSourceLocation_ Loc, CXParmVarDecl Param,
                                     CXMultiLevelTemplateArgumentList TemplateArgs,
                                     bool ForCallExpr) {
  return static_cast<clang::Sema *>(S)->SubstDefaultArgument(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::ParmVarDecl *>(Param),
...
bool clang_Sema_SubstExprs(CXSema S, const CXExpr *Exprs, unsigned NumExprs, bool IsCall,
  ...
  for (unsigned I = 0; I != NumExprs; ++I)
    Inputs.push_back(static_cast<clang::Expr *>(Exprs[I]));

  llvm::SmallVector<clang::Expr *, 8> Results;
  bool Failed = static_cast<clang::Sema *>(S)->SubstExprs(
...
CXTemplateParameterList clang_Sema_SubstTemplateParams(
  ...
  return static_cast<clang::Sema *>(S)->SubstTemplateParams(
      static_cast<clang::TemplateParameterList *>(Params),
      static_cast<clang::DeclContext *>(Owner),
...
bool clang_Sema_SubstTemplateArguments(CXSema S, const CXTemplateArgumentLoc *Args,
  ...
  for (unsigned I = 0; I != NumArgs; ++I)
    Inputs.push_back(*static_cast<clang::TemplateArgumentLoc *>(Args[I]));
  return static_cast<clang::Sema *>(S)->SubstTemplateArguments(
      Inputs, extra::unboxMultiLevelTemplateArgumentList(TemplateArgs),
      *static_cast<clang::TemplateArgumentListInfo *>(Outputs));
}

CXDecl clang_Sema_SubstDecl(CXSema S, CXDecl D, CXDeclContext Owner,
                            CXMultiLevelTemplateArgumentList TemplateArgs) {
  return static_cast<clang::Sema *>(S)->SubstDecl(
      static_cast<clang::Decl *>(D), static_cast<clang::DeclContext *>(Owner),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
}
...
bool clang_Sema_SubstBaseSpecifiers(CXSema S, CXCXXRecordDecl Instantiation,
                                    ...
                                    CXMultiLevelTemplateArgumentList TemplateArgs) {
  return static_cast<clang::Sema *>(S)->SubstBaseSpecifiers(
      static_cast<clang::CXXRecordDecl *>(Instantiation),
      static_cast<clang::CXXRecordDecl *>(Pattern),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
}
...
CXTemplateName clang_Sema_SubstTemplateName(CXSema S, CXNestedNameSpecifierLoc QualifierLoc,
  ...
  if (QualifierLoc)
    Qualifier = *static_cast<clang::NestedNameSpecifierLoc *>(QualifierLoc);
  return static_cast<clang::Sema *>(S)
...
bool clang_Sema_InstantiateInClassInitializer(
  ...
  return static_cast<clang::Sema *>(S)->InstantiateInClassInitializer(
      clang::SourceLocation::getFromPtrEncoding(PointOfInstantiation),
      static_cast<clang::FieldDecl *>(Instantiation),
      static_cast<clang::FieldDecl *>(Pattern),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
}
...
void clang_Sema_InstantiateAttrs(CXSema S, CXMultiLevelTemplateArgumentList TemplateArgs,
  ...
  static_cast<clang::Sema *>(S)->InstantiateAttrs(
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs),
      static_cast<clang::Decl *>(Pattern), static_cast<clang::Decl *>(Inst), nullptr,
      static_cast<clang::LocalInstantiationScope *>(OuterMostScope));
}
...
void clang_Sema_InstantiateAttrsForDecl(CXSema S,
                                        ...
                                        CXDecl Pattern, CXDecl Inst,
                                        CXLocalInstantiationScope OuterMostScope) {
  static_cast<clang::Sema *>(S)->InstantiateAttrsForDecl(
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs),
      static_cast<clang::Decl *>(Pattern), static_cast<clang::Decl *>(Inst), nullptr,
      static_cast<clang::LocalInstantiationScope *>(OuterMostScope));
}
...
void clang_Sema_PerformDependentDiagnostics(CXSema S, CXDeclContext Pattern,
                                            CXMultiLevelTemplateArgumentList TemplateArgs) {
  static_cast<clang::Sema *>(S)->PerformDependentDiagnostics(
      static_cast<clang::DeclContext *>(Pattern),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
}
#include "clang/AST/Stmt.h"

bool clang_Sema_hasUncompilableErrorOccurred(CXSema S) {
  return static_cast<clang::Sema *>(S)->hasUncompilableErrorOccurred();
}

CXString clang_Sema_getFixItZeroInitializerForType(CXSema S, CXQualType T,
                                                   CXSourceLocation_ Loc) {
  return extra::makeCXString(static_cast<clang::Sema *>(S)->getFixItZeroInitializerForType(
      clang::QualType::getFromOpaquePtr(T),
      clang::SourceLocation::getFromPtrEncoding(Loc)));
}
...
CXString clang_Sema_getFixItZeroLiteralForType(CXSema S, CXQualType T,
                                               CXSourceLocation_ Loc) {
  return extra::makeCXString(static_cast<clang::Sema *>(S)->getFixItZeroLiteralForType(
      clang::QualType::getFromOpaquePtr(T),
      clang::SourceLocation::getFromPtrEncoding(Loc)));
}
...
CXCanThrowResult clang_Sema_canThrow(CXSema S, CXStmt E) {
  return static_cast<CXCanThrowResult>(
      static_cast<clang::Sema *>(S)->canThrow(static_cast<clang::Stmt *>(E)));
}

bool clang_Sema_isVisible(CXSema S, CXNamedDecl D) {
  return static_cast<clang::Sema *>(S)->isVisible(static_cast<clang::NamedDecl *>(D));
}

bool clang_Sema_isReachable(CXSema S, CXNamedDecl D) {
  return static_cast<clang::Sema *>(S)->isReachable(static_cast<clang::NamedDecl *>(D));
}

bool clang_Sema_hasVisibleMergedDefinition(CXSema S, CXNamedDecl Def) {
  return static_cast<clang::Sema *>(S)->hasVisibleMergedDefinition(
      static_cast<clang::NamedDecl *>(Def));
}

bool clang_Sema_isEquivalentInternalLinkageDeclaration(CXSema S, CXNamedDecl A,
                                                       CXNamedDecl B) {
  return static_cast<clang::Sema *>(S)->isEquivalentInternalLinkageDeclaration(
      static_cast<clang::NamedDecl *>(A), static_cast<clang::NamedDecl *>(B));
}

bool clang_Sema_isUsualDeallocationFunction(CXSema S, CXCXXMethodDecl FD) {
  return static_cast<clang::Sema *>(S)->isUsualDeallocationFunction(
      static_cast<clang::CXXMethodDecl *>(FD));
}

CXDeclContext clang_Sema_getFunctionLevelDeclContext(CXSema S, bool AllowLambda) {
  return static_cast<clang::Sema *>(S)->getFunctionLevelDeclContext(AllowLambda);
}

CXFunctionDecl clang_Sema_getCurFunctionDecl(CXSema S, bool AllowLambda) {
  return static_cast<clang::Sema *>(S)->getCurFunctionDecl(AllowLambda);
}

CXNamedDecl clang_Sema_getCurFunctionOrMethodDecl(CXSema S) {
  return static_cast<clang::Sema *>(S)->getCurFunctionOrMethodDecl();
}

bool clang_Sema_IsFloatingPointPromotion(CXSema S, CXQualType FromType, CXQualType ToType) {
  return static_cast<clang::Sema *>(S)->IsFloatingPointPromotion(
...
CXNamespaceDecl clang_Sema_getStdNamespace(CXSema S) {
  return static_cast<clang::Sema *>(S)->getStdNamespace();
}

CXCXXRecordDecl clang_Sema_getStdBadAlloc(CXSema S) {
  return static_cast<clang::Sema *>(S)->getStdBadAlloc();
}

bool clang_Sema_isInitListConstructor(CXSema S, CXFunctionDecl Ctor) {
  return static_cast<clang::Sema *>(S)->isInitListConstructor(
      static_cast<clang::FunctionDecl *>(Ctor));
}

bool clang_Sema_isImplicitlyDeleted(CXSema S, CXFunctionDecl FD) {
  return static_cast<clang::Sema *>(S)->isImplicitlyDeleted(
      static_cast<clang::FunctionDecl *>(FD));
}

bool clang_Sema_IsDerivedFrom(CXSema S, CXSourceLocation_ Loc, CXQualType Derived,
                              CXQualType Base) {
  return static_cast<clang::Sema *>(S)->IsDerivedFrom(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      clang::QualType::getFromOpaquePtr(Derived), clang::QualType::getFromOpaquePtr(Base));
}

CXDeclContext clang_Sema_getCurLexicalContext(CXSema S) {
  return static_cast<clang::Sema *>(S)->getCurLexicalContext();
}
unsigned clang_Sema_LookupConstructors(CXSema S, CXCXXRecordDecl Class, CXNamedDecl *Buf,
                                       unsigned BufSize) {
  clang::DeclContextLookupResult R = static_cast<clang::Sema *>(S)->LookupConstructors(
      static_cast<clang::CXXRecordDecl *>(Class));
  unsigned N = 0;
...
CXCXXConstructorDecl clang_Sema_LookupCopyingConstructor(CXSema S, CXCXXRecordDecl Class,
                                                         unsigned Quals) {
  return static_cast<clang::Sema *>(S)->LookupCopyingConstructor(
      static_cast<clang::CXXRecordDecl *>(Class), Quals);
}

CXCXXMethodDecl clang_Sema_LookupCopyingAssignment(CXSema S, CXCXXRecordDecl Class,
                                                   unsigned Quals, bool RValueThis,
                                                   unsigned ThisQuals) {
  return static_cast<clang::Sema *>(S)->LookupCopyingAssignment(
      static_cast<clang::CXXRecordDecl *>(Class), Quals, RValueThis, ThisQuals);
}

CXCXXConstructorDecl clang_Sema_LookupMovingConstructor(CXSema S, CXCXXRecordDecl Class,
                                                        unsigned Quals) {
  return static_cast<clang::Sema *>(S)->LookupMovingConstructor(
      static_cast<clang::CXXRecordDecl *>(Class), Quals);
}
...
CXCXXMethodDecl clang_Sema_LookupMovingAssignment(CXSema S, CXCXXRecordDecl Class,
                                                  unsigned Quals, bool RValueThis,
                                                  unsigned ThisQuals) {
  return static_cast<clang::Sema *>(S)->LookupMovingAssignment(
      static_cast<clang::CXXRecordDecl *>(Class), Quals, RValueThis, ThisQuals);
}
...
CXCXXMethodDecl clang_Sema_LookupSpecialMember(CXSema S, CXCXXRecordDecl D,
  ...
  clang::Sema::SpecialMemberOverloadResult R =
      static_cast<clang::Sema *>(S)->LookupSpecialMember(
          static_cast<clang::CXXRecordDecl *>(D),
...
bool clang_Sema_LookupBuiltin(CXSema S, CXLookupResult R) {
  return static_cast<clang::Sema *>(S)->LookupBuiltin(
      *static_cast<clang::LookupResult *>(R));
}
...
CXModule clang_Sema_getCurrentModule(CXSema S) {
  return static_cast<clang::Sema *>(S)->getCurrentModule();
}

bool clang_Sema_hasStructuralCompatLayout(CXSema S, CXDecl D, CXDecl Suggested) {
  return static_cast<clang::Sema *>(S)->hasStructuralCompatLayout(
      static_cast<clang::Decl *>(D), static_cast<clang::Decl *>(Suggested));
}

CXCXXSpecialMember clang_Sema_getSpecialMember(CXSema S, CXCXXMethodDecl MD) {
  return static_cast<CXCXXSpecialMember>(static_cast<clang::Sema *>(S)->getSpecialMember(
...
bool clang_Sema_IsOverload(CXSema S, CXFunctionDecl New, CXFunctionDecl Old,
  ...
  return static_cast<clang::Sema *>(S)->IsOverload(
      static_cast<clang::FunctionDecl *>(New), static_cast<clang::FunctionDecl *>(Old),
      UseMemberUsingDeclRules, ConsiderCudaAttrs);
}

bool clang_Sema_IsOverride(CXSema S, CXFunctionDecl MD, CXFunctionDecl BaseMD,
                           bool UseMemberUsingDeclRules, bool ConsiderCudaAttrs) {
  return static_cast<clang::Sema *>(S)->IsOverride(
      static_cast<clang::FunctionDecl *>(MD), static_cast<clang::FunctionDecl *>(BaseMD),
      UseMemberUsingDeclRules, ConsiderCudaAttrs);
}

bool clang_Sema_IsComplexPromotion(CXSema S, CXQualType FromType, CXQualType ToType) {
  return static_cast<clang::Sema *>(S)->IsComplexPromotion(
      clang::QualType::getFromOpaquePtr(FromType),
      clang::QualType::getFromOpaquePtr(ToType));
}

bool clang_Sema_isKnownName(CXSema S, const char *Name) {
  return static_cast<clang::Sema *>(S)->isKnownName(llvm::StringRef(Name));
}

bool clang_Sema_isAcceptableNestedNameSpecifier(CXSema S, CXNamedDecl SD,
                                                bool *CanCorrect) {
  return static_cast<clang::Sema *>(S)->isAcceptableNestedNameSpecifier(
      static_cast<clang::NamedDecl *>(SD), CanCorrect);
}

bool clang_Sema_isValidPointerAttrType(CXSema S, CXQualType T, bool RefOkay) {
  return static_cast<clang::Sema *>(S)->isValidPointerAttrType(
      clang::QualType::getFromOpaquePtr(T), RefOkay);
}

bool clang_Sema_hasExplicitCallingConv(CXSema S, CXQualType T) {
  return static_cast<clang::Sema *>(S)->hasExplicitCallingConv(
      clang::QualType::getFromOpaquePtr(T));
}

CXAttributedType clang_Sema_getCallingConvAttributedType(CXSema S, CXQualType T) {
  return const_cast<clang::AttributedType *>(
      static_cast<clang::Sema *>(S)->getCallingConvAttributedType(
          clang::QualType::getFromOpaquePtr(T)));
}

CXQualType clang_Sema_getCurrentThisType(CXSema S) {
  return static_cast<clang::Sema *>(S)->getCurrentThisType().getAsOpaquePtr();
}

bool clang_Sema_isUnexpandedParameterPackPermitted(CXSema S) {
  return static_cast<clang::Sema *>(S)->isUnexpandedParameterPackPermitted();
}

bool clang_Sema_inTemplateInstantiation(CXSema S) {
  return static_cast<clang::Sema *>(S)->inTemplateInstantiation();
}

bool clang_Sema_isConstantEvaluatedContext(CXSema S) {
  return static_cast<clang::Sema *>(S)->isConstantEvaluatedContext();
}

bool clang_Sema_isAlwaysConstantEvaluatedContext(CXSema S) {
  return static_cast<clang::Sema *>(S)->isAlwaysConstantEvaluatedContext();
}

bool clang_Sema_isUnevaluatedContext(CXSema S) {
  return static_cast<clang::Sema *>(S)->isUnevaluatedContext();
}

bool clang_Sema_isImmediateFunctionContext(CXSema S) {
  return static_cast<clang::Sema *>(S)->isImmediateFunctionContext();
}

bool clang_Sema_isCheckingDefaultArgumentOrInitializer(CXSema S) {
  return static_cast<clang::Sema *>(S)->isCheckingDefaultArgumentOrInitializer();
}

bool clang_Sema_isPreciseFPEnabled(CXSema S) {
  return static_cast<clang::Sema *>(S)->isPreciseFPEnabled();
}
...
unsigned clang_Sema_LookupVisibleDeclsInContext(
  ...
  static_cast<clang::Sema *>(S)->LookupVisibleDecls(
...
bool clang_Sema_RequireNonAbstractType(CXSema S, CXSourceLocation_ Loc, CXQualType T,
                                       unsigned DiagID) {
  return static_cast<clang::Sema *>(S)->RequireNonAbstractType(
      clang::SourceLocation::getFromPtrEncoding(Loc), clang::QualType::getFromOpaquePtr(T),
      DiagID);
}

bool clang_Sema_RequireStructuralType(CXSema S, CXQualType T, CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)->RequireStructuralType(
      clang::QualType::getFromOpaquePtr(T), clang::SourceLocation::getFromPtrEncoding(Loc));
}

CXNamedDecl clang_Sema_findLocallyScopedExternCDecl(CXSema S, CXDeclarationName Name) {
  return static_cast<clang::Sema *>(S)->findLocallyScopedExternCDecl(
      clang::DeclarationName::getFromOpaquePtr(Name));
}
...
bool clang_Sema_findMacroSpelling(CXSema S, CXSourceLocation_ *Loc, const char *Name) {
  ...
  if (!static_cast<clang::Sema *>(S)->findMacroSpelling(L, llvm::StringRef(Name)))
    return false;
...
bool clang_Sema_handlerCanCatch(CXSema S, CXQualType HandlerType,
  ...
  return static_cast<clang::Sema *>(S)->handlerCanCatch(
...
bool clang_Sema_currentModuleIsImplementation(CXSema S) {
  return static_cast<clang::Sema *>(S)->currentModuleIsImplementation();
}

bool clang_Sema_currentModuleIsHeaderUnit(CXSema S) {
  return static_cast<clang::Sema *>(S)->currentModuleIsHeaderUnit();
}

bool clang_Sema_shouldLinkDependentDeclWithPrevious(CXSema S, CXDecl D, CXDecl OldDecl) {
  return static_cast<clang::Sema *>(S)->shouldLinkDependentDeclWithPrevious(
      static_cast<clang::Decl *>(D), static_cast<clang::Decl *>(OldDecl));
}
...
bool clang_Sema_FunctionParamTypesAreEqual(CXSema S, CXFunctionProtoType OldType,
                                           ...
                                           bool Reversed) {
  return static_cast<clang::Sema *>(S)->FunctionParamTypesAreEqual(
      static_cast<clang::FunctionProtoType *>(OldType),
      static_cast<clang::FunctionProtoType *>(NewType), ArgPos, Reversed);
}
...
bool clang_Sema_FunctionNonObjectParamTypesAreEqual(CXSema S, CXFunctionDecl OldFunction,
  ...
  return static_cast<clang::Sema *>(S)->FunctionNonObjectParamTypesAreEqual(
      static_cast<clang::FunctionDecl *>(OldFunction),
      static_cast<clang::FunctionDecl *>(NewFunction), ArgPos, Reversed);
}

bool clang_Sema_checkAddressOfFunctionIsAvailable(CXSema S, CXFunctionDecl Function,
                                                  bool Complain, CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)->checkAddressOfFunctionIsAvailable(
      static_cast<clang::FunctionDecl *>(Function), Complain,
      clang::SourceLocation::getFromPtrEncoding(Loc));
}
...
CXRedeclarationKind clang_Sema_forRedeclarationInCurContext(CXSema S) {
  return static_cast<CXRedeclarationKind>(
      static_cast<clang::Sema *>(S)->forRedeclarationInCurContext());
}

CXValueDecl clang_Sema_tryLookupUnambiguousFieldDecl(CXSema S, CXRecordDecl ClassDecl,
                                                     CXIdentifierInfo MemberOrBase) {
  return static_cast<clang::Sema *>(S)->tryLookupUnambiguousFieldDecl(
      static_cast<clang::RecordDecl *>(ClassDecl),
      static_cast<clang::IdentifierInfo *>(MemberOrBase));
}
...
CXExpr clang_Sema_IgnoredValueConversions(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->IgnoredValueConversions(static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_UsualUnaryConversions(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->UsualUnaryConversions(static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_DefaultFunctionArrayConversion(CXSema S, CXExpr E, bool Diagnose,
                                                 bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->DefaultFunctionArrayConversion(
      static_cast<clang::Expr *>(E), Diagnose);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_DefaultFunctionArrayLvalueConversion(CXSema S, CXExpr E, bool Diagnose,
                                                       bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->DefaultFunctionArrayLvalueConversion(
      static_cast<clang::Expr *>(E), Diagnose);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_DefaultLvalueConversion(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->DefaultLvalueConversion(static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}

CXExpr clang_Sema_DefaultArgumentPromotion(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->DefaultArgumentPromotion(
      static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
clang_Sema_CompareReferenceRelationship(CXSema S, CXSourceLocation_ Loc, CXQualType T1,
  ...
  clang::Sema::ReferenceCompareResult Result =
      static_cast<clang::Sema *>(S)->CompareReferenceRelationship(
          clang::SourceLocation::getFromPtrEncoding(Loc),
...
CXFormatStringType clang_Sema_GetFormatStringType(CXFormatAttr Format) {
  return static_cast<CXFormatStringType>(
      clang::Sema::GetFormatStringType(static_cast<clang::FormatAttr *>(Format)));
}

bool clang_Sema_GetFormatNSStringIdx(CXFormatAttr Format, unsigned *Idx) {
  return clang::Sema::GetFormatNSStringIdx(static_cast<clang::FormatAttr *>(Format), *Idx);
}

bool clang_Sema_FormatStringHasSArg(CXSema S, CXStringLiteral FExpr) {
  return static_cast<clang::Sema *>(S)->FormatStringHasSArg(
      static_cast<clang::StringLiteral *>(FExpr));
}
...
CXExpr clang_Sema_PerformImplicitObjectArgumentInitialization(
  ...
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->PerformImplicitObjectArgumentInitialization(
          static_cast<clang::Expr *>(From),
          static_cast<clang::NestedNameSpecifier *>(Qualifier),
          static_cast<clang::NamedDecl *>(FoundDecl),
...
CXExpr clang_Sema_PerformContextuallyConvertToBool(CXSema S, CXExpr From, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->PerformContextuallyConvertToBool(
      static_cast<clang::Expr *>(From));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_PerformMemberExprBaseConversion(CXSema S, CXExpr Base, bool IsArrow,
                                                  bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->PerformMemberExprBaseConversion(
      static_cast<clang::Expr *>(Base), IsArrow);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_PerformObjectMemberConversion(CXSema S, CXExpr From,
                                                ...
                                                bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->PerformObjectMemberConversion(
      static_cast<clang::Expr *>(From),
      static_cast<clang::NestedNameSpecifier *>(Qualifier),
      static_cast<clang::NamedDecl *>(FoundDecl), static_cast<clang::NamedDecl *>(Member));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}

void clang_Sema_MarkTypoCorrectedFunctionDefinition(CXSema S, CXNamedDecl F) {
  static_cast<clang::Sema *>(S)->MarkTypoCorrectedFunctionDefinition(
      static_cast<clang::NamedDecl *>(F));
}

void clang_Sema_MarkDeclRefReferenced(CXSema S, CXDeclRefExpr E, CXExpr Base) {
  static_cast<clang::Sema *>(S)->MarkDeclRefReferenced(
      static_cast<clang::DeclRefExpr *>(E), static_cast<const clang::Expr *>(Base));
}

void clang_Sema_MarkMemberReferenced(CXSema S, CXMemberExpr E) {
  static_cast<clang::Sema *>(S)->MarkMemberReferenced(static_cast<clang::MemberExpr *>(E));
}
...
void clang_Sema_MarkDeclarationsReferencedInExpr(CXSema S, CXExpr E,
  ...
  for (unsigned I = 0; I != NumStopAt; ++I)
    Stops.push_back(static_cast<const clang::Expr *>(StopAt[I]));
  static_cast<clang::Sema *>(S)->MarkDeclarationsReferencedInExpr(
      static_cast<clang::Expr *>(E), SkipLocalVariables, Stops);
}

void clang_Sema_MarkVirtualBaseDestructorsReferenced(CXSema S, CXSourceLocation_ Location,
                                                     CXCXXRecordDecl ClassDecl) {
  static_cast<clang::Sema *>(S)->MarkVirtualBaseDestructorsReferenced(
...
void clang_Sema_MarkUsedTemplateParameters(CXSema S, CXExpr E, bool OnlyDeduced,
  ...
  static_cast<clang::Sema *>(S)->MarkUsedTemplateParameters(
      static_cast<const clang::Expr *>(E), OnlyDeduced, Depth, Bits);
  unsigned Count = static_cast<unsigned>(Bits.size());
  if (N < Count)
    Count = N;
  for (unsigned I = 0; I != Count; ++I)
...
CXExpr clang_Sema_PerformImplicitConversion(CXSema S, CXExpr From, CXQualType ToType,
                                            ...
                                            bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->PerformImplicitConversion(
      static_cast<clang::Expr *>(From), clang::QualType::getFromOpaquePtr(ToType),
...
CXExpr clang_Sema_PerformQualificationConversion(CXSema S, CXExpr E, CXQualType Ty,
                                                 ...
                                                 bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->PerformQualificationConversion(
      static_cast<clang::Expr *>(E), clang::QualType::getFromOpaquePtr(Ty),
...
bool clang_Sema_CheckQualifiedFunctionForTypeId(CXSema S, CXQualType T,
                                                CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)->CheckQualifiedFunctionForTypeId(
      clang::QualType::getFromOpaquePtr(T), clang::SourceLocation::getFromPtrEncoding(Loc));
}
...
bool clang_Sema_CheckSpecifiedExceptionType(CXSema S, CXQualType *T,
  ...
  bool Bad = static_cast<clang::Sema *>(S)->CheckSpecifiedExceptionType(
...
bool clang_Sema_CheckEquivalentExceptionSpec(CXSema S, CXFunctionDecl Old,
                                             CXFunctionDecl New) {
  return static_cast<clang::Sema *>(S)->CheckEquivalentExceptionSpec(
      static_cast<clang::FunctionDecl *>(Old), static_cast<clang::FunctionDecl *>(New));
}

bool clang_Sema_CheckConstexprFunctionDefinition(CXSema S, CXFunctionDecl FD,
                                                 CXCheckConstexprKind Kind) {
  return static_cast<clang::Sema *>(S)->CheckConstexprFunctionDefinition(
      static_cast<clang::FunctionDecl *>(FD),
      static_cast<clang::Sema::CheckConstexprKind>(Kind));
}

bool clang_Sema_CheckEnumUnderlyingType(CXSema S, CXTypeSourceInfo TI) {
  return static_cast<clang::Sema *>(S)->CheckEnumUnderlyingType(
      static_cast<clang::TypeSourceInfo *>(TI));
}

bool clang_Sema_CheckRedeclarationModuleOwnership(CXSema S, CXNamedDecl New,
                                                  CXNamedDecl Old) {
  return static_cast<clang::Sema *>(S)->CheckRedeclarationModuleOwnership(
      static_cast<clang::NamedDecl *>(New), static_cast<clang::NamedDecl *>(Old));
}

bool clang_Sema_CheckRedeclarationExported(CXSema S, CXNamedDecl New, CXNamedDecl Old) {
  return static_cast<clang::Sema *>(S)->CheckRedeclarationExported(
      static_cast<clang::NamedDecl *>(New), static_cast<clang::NamedDecl *>(Old));
}

bool clang_Sema_CheckRedeclarationInModule(CXSema S, CXNamedDecl New, CXNamedDecl Old) {
  return static_cast<clang::Sema *>(S)->CheckRedeclarationInModule(
      static_cast<clang::NamedDecl *>(New), static_cast<clang::NamedDecl *>(Old));
}

CXExpr clang_Sema_CheckPlaceholderExpr(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->CheckPlaceholderExpr(static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
bool clang_Sema_CheckAllocatedType(CXSema S, CXQualType AllocType, CXSourceLocation_ Loc,
  ...
  return static_cast<clang::Sema *>(S)->CheckAllocatedType(
...
bool clang_Sema_CheckOverridingFunctionAttributes(CXSema S, CXCXXMethodDecl New,
                                                  CXCXXMethodDecl Old) {
  return static_cast<clang::Sema *>(S)->CheckOverridingFunctionAttributes(
      static_cast<clang::CXXMethodDecl *>(New), static_cast<clang::CXXMethodDecl *>(Old));
}

bool clang_Sema_CheckOverridingFunctionReturnType(CXSema S, CXCXXMethodDecl New,
                                                  CXCXXMethodDecl Old) {
  return static_cast<clang::Sema *>(S)->CheckOverridingFunctionReturnType(
      static_cast<clang::CXXMethodDecl *>(New), static_cast<clang::CXXMethodDecl *>(Old));
}

bool clang_Sema_CheckOverridingFunctionExceptionSpec(CXSema S, CXCXXMethodDecl New,
                                                     CXCXXMethodDecl Old) {
  return static_cast<clang::Sema *>(S)->CheckOverridingFunctionExceptionSpec(
      static_cast<clang::CXXMethodDecl *>(New), static_cast<clang::CXXMethodDecl *>(Old));
}

bool clang_Sema_CheckOverloadedOperatorDeclaration(CXSema S, CXFunctionDecl FnDecl) {
  return static_cast<clang::Sema *>(S)->CheckOverloadedOperatorDeclaration(
      static_cast<clang::FunctionDecl *>(FnDecl));
}

bool clang_Sema_CheckLiteralOperatorDeclaration(CXSema S, CXFunctionDecl FnDecl) {
  return static_cast<clang::Sema *>(S)->CheckLiteralOperatorDeclaration(
      static_cast<clang::FunctionDecl *>(FnDecl));
}
...
CXAssignConvertType clang_Sema_CheckAssignmentConstraints(CXSema S, CXSourceLocation_ Loc,
  ...
  return static_cast<CXAssignConvertType>(
      static_cast<clang::Sema *>(S)->CheckAssignmentConstraints(
          clang::SourceLocation::getFromPtrEncoding(Loc),
...
bool clang_Sema_CheckForConstantInitializer(CXSema S, CXExpr E, CXQualType T) {
  return static_cast<clang::Sema *>(S)->CheckForConstantInitializer(
      static_cast<clang::Expr *>(E), clang::QualType::getFromOpaquePtr(T));
}

CXExpr clang_Sema_CheckBooleanCondition(CXSema S, CXSourceLocation_ Loc, CXExpr E,
                                        bool IsConstexpr, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CheckBooleanCondition(
      clang::SourceLocation::getFromPtrEncoding(Loc), static_cast<clang::Expr *>(E),
      IsConstexpr);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_VerifyIntegerConstantExpression(CXSema S, CXExpr E,
                                                  ...
                                                  bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->VerifyIntegerConstantExpression(
      static_cast<clang::Expr *>(E), static_cast<llvm::APSInt *>(nullptr),
...
void clang_Sema_FilterAcceptableTemplateNames(CXSema S, CXLookupResult R,
                                              ...
                                              bool AllowDependent) {
  static_cast<clang::Sema *>(S)->FilterAcceptableTemplateNames(
      *static_cast<clang::LookupResult *>(R), AllowFunctionTemplates, AllowDependent);
}

void clang_Sema_FilterLookupForScope(CXSema S, CXLookupResult R, CXDeclContext Ctx,
                                     CXScope Sp, bool ConsiderLinkage,
                                     bool AllowInlineNamespace) {
  static_cast<clang::Sema *>(S)->FilterLookupForScope(
      *static_cast<clang::LookupResult *>(R), static_cast<clang::DeclContext *>(Ctx),
      static_cast<clang::Scope *>(Sp), ConsiderLinkage, AllowInlineNamespace);
}

void clang_Sema_FilterUsingLookup(CXSema S, CXScope Sp, CXLookupResult R) {
  static_cast<clang::Sema *>(S)->FilterUsingLookup(static_cast<clang::Scope *>(Sp),
                                                   *static_cast<clang::LookupResult *>(R));
}

void clang_Sema_setTagNameForLinkagePurposes(CXSema S, CXTagDecl TagFromDeclSpec,
                                             CXTypedefNameDecl NewTD) {
  static_cast<clang::Sema *>(S)->setTagNameForLinkagePurposes(
      static_cast<clang::TagDecl *>(TagFromDeclSpec),
      static_cast<clang::TypedefNameDecl *>(NewTD));
}
...
void clang_Sema_RegisterTypeTagForDatatype(CXSema S, CXIdentifierInfo ArgumentKind,
  ...
  static_cast<clang::Sema *>(S)->RegisterTypeTagForDatatype(
      static_cast<const clang::IdentifierInfo *>(ArgumentKind), MagicValue,
      clang::QualType::getFromOpaquePtr(Type), LayoutCompatible, MustBeNull);
}

void clang_Sema_AddCFAuditedAttribute(CXSema S, CXDecl D) {
  static_cast<clang::Sema *>(S)->AddCFAuditedAttribute(static_cast<clang::Decl *>(D));
}

void clang_Sema_AddPragmaAttributes(CXSema S, CXScope Sp, CXDecl D) {
  static_cast<clang::Sema *>(S)->AddPragmaAttributes(static_cast<clang::Scope *>(Sp),
                                                     static_cast<clang::Decl *>(D));
}

CXDeclGroupRef clang_Sema_ConvertDeclToDeclGroup(CXSema S, CXDecl D, CXDecl OwnedType) {
  return static_cast<clang::Sema *>(S)
      ->ConvertDeclToDeclGroup(static_cast<clang::Decl *>(D),
                               static_cast<clang::Decl *>(OwnedType))
      .getAsOpaquePtr();
}
...
CXExpr clang_Sema_ConvertParamDefaultArgument(CXSema S, CXParmVarDecl Param,
                                              ...
                                              bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->ConvertParamDefaultArgument(
      static_cast<clang::ParmVarDecl *>(Param), static_cast<clang::Expr *>(DefaultArg),
      clang::SourceLocation::getFromPtrEncoding(EqualLoc));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
...
CXExpr clang_Sema_ConvertMemberDefaultInitExpression(CXSema S, CXFieldDecl FD,
                                                     ...
                                                     bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->ConvertMemberDefaultInitExpression(
      static_cast<clang::FieldDecl *>(FD), static_cast<clang::Expr *>(InitExpr),
...
bool clang_Sema_TemplateParameterListsAreEqual(CXSema S, CXTemplateParameterList New,
  ...
  return static_cast<clang::Sema *>(S)->TemplateParameterListsAreEqual(
      static_cast<clang::TemplateParameterList *>(New),
      static_cast<clang::TemplateParameterList *>(Old), Complain,
...
CXTemplateDeductionResult clang_Sema_DeduceTemplateArguments(
  ...
  return static_cast<CXTemplateDeductionResult>(
      static_cast<clang::Sema *>(S)->DeduceTemplateArguments(
          static_cast<clang::ClassTemplatePartialSpecializationDecl *>(Partial),
          *static_cast<clang::TemplateArgumentList *>(TemplateArgs),
          *static_cast<clang::sema::TemplateDeductionInfo *>(Info)));
}
...
CXTemplateDeductionResult clang_Sema_DeduceAutoType(CXSema S, CXTypeLoc AutoTypeLoc,
  ...
  clang::Sema::TemplateDeductionResult R = static_cast<clang::Sema *>(S)->DeduceAutoType(
      *static_cast<clang::TypeLoc *>(AutoTypeLoc), static_cast<clang::Expr *>(Initializer),
      Deduced, *static_cast<clang::sema::TemplateDeductionInfo *>(Info), DependentDeduction,
      IgnoreConstraints);
  if (R == clang::Sema::TDK_Success)
    *Result = Deduced.getAsOpaquePtr();
...
void clang_Sema_TryImplicitConversion(CXSema S, CXExpr From, CXQualType ToType,
  ...
  *static_cast<clang::ImplicitConversionSequence *>(Out) =
      static_cast<clang::Sema *>(S)->TryImplicitConversion(
          static_cast<clang::Expr *>(From), clang::QualType::getFromOpaquePtr(ToType),
...
bool clang_Sema_CheckPointerConversion(CXSema S, CXExpr From, CXQualType ToType,
  ...
  bool Failed = static_cast<clang::Sema *>(S)->CheckPointerConversion(
      static_cast<clang::Expr *>(From), clang::QualType::getFromOpaquePtr(ToType), K,
...
CXObjCLiteralKind clang_Sema_CheckLiteralKind(CXSema S, CXExpr FromE) {
  return static_cast<CXObjCLiteralKind>(
      static_cast<clang::Sema *>(S)->CheckLiteralKind(static_cast<clang::Expr *>(FromE)));
}

CXExpr clang_Sema_CheckUnevaluatedOperand(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R =
      static_cast<clang::Sema *>(S)->CheckUnevaluatedOperand(static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_CheckLValueToRValueConversionOperand(CXSema S, CXExpr E,
                                                       bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CheckLValueToRValueConversionOperand(
      static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
bool clang_Sema_CheckLoopHintExpr(CXSema S, CXExpr E, CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)->CheckLoopHintExpr(
      static_cast<clang::Expr *>(E), clang::SourceLocation::getFromPtrEncoding(Loc));
}

bool clang_Sema_CheckUnaryExprOrTypeTraitOperand(CXSema S, CXExpr E,
                                                 CXUnaryExprOrTypeTrait ExprKind) {
  return static_cast<clang::Sema *>(S)->CheckUnaryExprOrTypeTraitOperand(
      static_cast<clang::Expr *>(E), static_cast<clang::UnaryExprOrTypeTrait>(ExprKind));
}
...
CXAssignConvertType clang_Sema_CheckSingleAssignmentConstraints(
  ...
  clang::ExprResult R(static_cast<clang::Expr *>(RHS));
  clang::Sema::AssignConvertType Result =
      static_cast<clang::Sema *>(S)->CheckSingleAssignmentConstraints(
          clang::QualType::getFromOpaquePtr(LHSType), R, Diagnose, DiagnoseCFAudited,
          ConvertRHS);
  *IsInvalid = R.isInvalid();
  *ConvertedRHS = R.isInvalid() ? nullptr : R.get();
...
CXAssignConvertType clang_Sema_CheckTransparentUnionArgumentConstraints(
  ...
  clang::ExprResult R(static_cast<clang::Expr *>(RHS));
  clang::Sema::AssignConvertType Result =
      static_cast<clang::Sema *>(S)->CheckTransparentUnionArgumentConstraints(
...
bool clang_Sema_CheckExceptionSpecCompatibility(CXSema S, CXExpr From, CXQualType ToType) {
  return static_cast<clang::Sema *>(S)->CheckExceptionSpecCompatibility(
      static_cast<clang::Expr *>(From), clang::QualType::getFromOpaquePtr(ToType));
}
...
bool clang_Sema_CheckVectorCast(CXSema S, CXSourceLocation_ R_begin,
                                ...
                                CXCastKind *Kind) {
  clang::CastKind K = clang::CK_Dependent;
  bool Failed = static_cast<clang::Sema *>(S)->CheckVectorCast(
      clang::SourceRange(clang::SourceLocation::getFromPtrEncoding(R_begin),
                         clang::SourceLocation::getFromPtrEncoding(R_end)),
...
bool clang_Sema_CheckObjCARCUnavailableWeakConversion(CXSema S, CXQualType CastType,
                                                      CXQualType ExprType) {
  return static_cast<clang::Sema *>(S)->CheckObjCARCUnavailableWeakConversion(
...
CXExpr clang_Sema_CheckSwitchCondition(CXSema S, CXSourceLocation_ SwitchLoc, CXExpr Cond,
                                       bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CheckSwitchCondition(
      clang::SourceLocation::getFromPtrEncoding(SwitchLoc),
      static_cast<clang::Expr *>(Cond));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_CheckCXXBooleanCondition(CXSema S, CXExpr CondExpr, bool IsConstexpr,
                                           bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CheckCXXBooleanCondition(
      static_cast<clang::Expr *>(CondExpr), IsConstexpr);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_VerifyBitField(CXSema S, CXSourceLocation_ FieldLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->VerifyBitField(
      clang::SourceLocation::getFromPtrEncoding(FieldLoc),
      static_cast<clang::IdentifierInfo *>(FieldName),
      clang::QualType::getFromOpaquePtr(FieldTy), IsMsStruct,
      static_cast<clang::Expr *>(BitWidth));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
bool clang_Sema_isExternalWithNoLinkageType(CXSema S, CXValueDecl VD) {
  return static_cast<clang::Sema *>(S)->isExternalWithNoLinkageType(
      static_cast<clang::ValueDecl *>(VD));
}

bool clang_Sema_hasVisibleDeclaration(CXSema S, CXNamedDecl D) {
  return static_cast<clang::Sema *>(S)->hasVisibleDeclaration(
      static_cast<clang::NamedDecl *>(D));
}

bool clang_Sema_hasReachableDeclaration(CXSema S, CXNamedDecl D) {
  return static_cast<clang::Sema *>(S)->hasReachableDeclaration(
      static_cast<clang::NamedDecl *>(D));
}
...
bool clang_Sema_hasVisibleDefinition(CXSema S, CXNamedDecl D, CXNamedDecl *Suggested,
  ...
  bool Found = static_cast<clang::Sema *>(S)->hasVisibleDefinition(
      static_cast<clang::NamedDecl *>(D), &Hidden, OnlyNeedComplete);
  *Suggested = Hidden;
  return Found;
}
...
bool clang_Sema_hasReachableDefinition(CXSema S, CXNamedDecl D, CXNamedDecl *Suggested) {
  clang::NamedDecl *Hidden = nullptr;
  bool Found = static_cast<clang::Sema *>(S)->hasReachableDefinition(
...
bool clang_Sema_IsIntegralPromotion(CXSema S, CXExpr From, CXQualType FromType,
                                    CXQualType ToType) {
  return static_cast<clang::Sema *>(S)->IsIntegralPromotion(
...
bool clang_Sema_IsBlockPointerConversion(CXSema S, CXQualType FromType, CXQualType ToType,
  ...
  bool Ok = static_cast<clang::Sema *>(S)->IsBlockPointerConversion(
      clang::QualType::getFromOpaquePtr(FromType),
...
bool clang_Sema_IsQualificationConversion(CXSema S, CXQualType FromType, CXQualType ToType,
  ...
  bool Lifetime = false;
  bool Ok = static_cast<clang::Sema *>(S)->IsQualificationConversion(
      clang::QualType::getFromOpaquePtr(FromType),
...
bool clang_Sema_IsFunctionConversion(CXSema S, CXQualType FromType, CXQualType ToType,
  ...
  bool Ok = static_cast<clang::Sema *>(S)->IsFunctionConversion(
      clang::QualType::getFromOpaquePtr(FromType),
      clang::QualType::getFromOpaquePtr(ToType), Result);
  *ResultTy = Result.getAsOpaquePtr();
  return Ok;
}

bool clang_Sema_isSameOrCompatibleFunctionType(CXSema S, CXQualType Param, CXQualType Arg) {
  return static_cast<clang::Sema *>(S)->isSameOrCompatibleFunctionType(
...
CXSourceRange_ clang_Sema_getExprRange(CXSema S, CXExpr E) {
  clang::SourceRange R =
      static_cast<clang::Sema *>(S)->getExprRange(static_cast<clang::Expr *>(E));
...
bool clang_Sema_areLaxCompatibleVectorTypes(CXSema S, CXQualType SrcType,
                                            CXQualType DestType) {
  return static_cast<clang::Sema *>(S)->areLaxCompatibleVectorTypes(
      clang::QualType::getFromOpaquePtr(SrcType),
      clang::QualType::getFromOpaquePtr(DestType));
}

bool clang_Sema_isLaxVectorConversion(CXSema S, CXQualType SrcType, CXQualType DestType) {
  return static_cast<clang::Sema *>(S)->isLaxVectorConversion(
      clang::QualType::getFromOpaquePtr(SrcType),
      clang::QualType::getFromOpaquePtr(DestType));
}
...
CXSourceLocation_ clang_Sema_getLocationOfStringLiteralByte(CXSema S, CXStringLiteral SL,
                                                            unsigned ByteNo) {
  return static_cast<clang::Sema *>(S)
      ->getLocationOfStringLiteralByte(static_cast<clang::StringLiteral *>(SL), ByteNo)
      .getPtrEncoding();
}

unsigned clang_Sema_getNumWeakTopLevelDecls(CXSema S) {
  return static_cast<unsigned>(static_cast<clang::Sema *>(S)->WeakTopLevelDecls().size());
}

CXDecl clang_Sema_getWeakTopLevelDecl(CXSema S, unsigned I) {
  return static_cast<clang::Sema *>(S)->WeakTopLevelDecls()[I];
}

CXIdentifierInfo
clang_Sema_InventAbbreviatedTemplateParameterTypeName(CXSema S, CXIdentifierInfo ParamName,
                                                      unsigned Index) {
  return static_cast<clang::Sema *>(S)->InventAbbreviatedTemplateParameterTypeName(
      static_cast<clang::IdentifierInfo *>(ParamName), Index);
}

bool clang_Sema_mightBeIntendedToBeTemplateName(CXSema S, CXExpr E, bool *Dependent) {
  return static_cast<clang::Sema *>(S)->mightBeIntendedToBeTemplateName(
      static_cast<clang::Expr *>(E), *Dependent);
}

bool clang_Sema_adjustContextForLocalExternDecl(CXDeclContext *DC) {
  clang::DeclContext *Ctx = static_cast<clang::DeclContext *>(*DC);
...
bool clang_Sema_NeedToCaptureVariable(CXSema S, CXValueDecl Var, CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)->NeedToCaptureVariable(
      static_cast<clang::ValueDecl *>(Var), clang::SourceLocation::getFromPtrEncoding(Loc));
}

bool clang_Sema_UseArgumentDependentLookup(CXSema S, CXCXXScopeSpec SS, CXLookupResult R,
                                           bool HasTrailingLParen) {
  return static_cast<clang::Sema *>(S)->UseArgumentDependentLookup(
      *static_cast<clang::CXXScopeSpec *>(SS), *static_cast<clang::LookupResult *>(R),
      HasTrailingLParen);
}
...
unsigned clang_Sema_LookupBinOp(CXSema S, CXScope Sc, CXSourceLocation_ OpLoc,
  ...
  static_cast<clang::Sema *>(S)->LookupBinOp(
      static_cast<clang::Scope *>(Sc), clang::SourceLocation::getFromPtrEncoding(OpLoc),
...
uint64_t clang_Sema_CurFPFeatureOverrides(CXSema S) {
  return static_cast<clang::Sema *>(S)->CurFPFeatureOverrides().getAsOpaqueInt();
}

bool clang_Sema_anyAltivecTypes(CXSema S, CXQualType SrcType, CXQualType DestType) {
  return static_cast<clang::Sema *>(S)->anyAltivecTypes(
      clang::QualType::getFromOpaquePtr(SrcType),
      clang::QualType::getFromOpaquePtr(DestType));
}

CXExpr clang_Sema_CallExprUnaryConversions(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CallExprUnaryConversions(
      static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_TemporaryMaterializationConversion(CXSema S, CXExpr E, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->TemporaryMaterializationConversion(
      static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_DefaultVariadicArgumentPromotion(CXSema S, CXExpr E,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->DefaultVariadicArgumentPromotion(
      static_cast<clang::Expr *>(E), static_cast<clang::Sema::VariadicCallType>(CT),
      static_cast<clang::FunctionDecl *>(FDecl));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXQualType clang_Sema_UsualArithmeticConversions(CXSema S, CXExpr LHS, CXExpr RHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->UsualArithmeticConversions(
      L, R, clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::Sema::ArithConvKind>(ACK));
  *LHSOut = L.isInvalid() ? nullptr : L.get();
  *RHSOut = R.isInvalid() ? nullptr : R.get();
  return T.getAsOpaquePtr();
}

CXExpr clang_Sema_prepareVectorSplat(CXSema S, CXQualType VectorTy, CXExpr SplattedExpr,
                                     bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->prepareVectorSplat(
      clang::QualType::getFromOpaquePtr(VectorTy),
      static_cast<clang::Expr *>(SplattedExpr));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
bool clang_Sema_SpecialMemberIsTrivial(CXSema S, CXCXXMethodDecl MD, CXCXXSpecialMember CSM,
  ...
  return static_cast<clang::Sema *>(S)->SpecialMemberIsTrivial(
      static_cast<clang::CXXMethodDecl *>(MD),
...
llvm::SmallVector<clang::Expr *, 8> makeExprArgs(const CXExpr *Args, unsigned NumArgs) {
  ...
  Out.reserve(NumArgs);
  for (unsigned I = 0; I < NumArgs; ++I)
    Out.push_back(static_cast<clang::Expr *>(Args[I]));
  return Out;
}
...
unsigned clang_Sema_FindHiddenVirtualMethods(CXSema S, CXCXXMethodDecl MD,
  ...
  static_cast<clang::Sema *>(S)->FindHiddenVirtualMethods(
      static_cast<clang::CXXMethodDecl *>(MD), Found);
  if (Buf)
...
void clang_Sema_AddOverloadCandidate(CXSema S, CXFunctionDecl Function,
  ...
  static_cast<clang::Sema *>(S)->AddOverloadCandidate(
      static_cast<clang::FunctionDecl *>(Function),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(FoundDecl),
                                  static_cast<clang::AccessSpecifier>(FoundAccess)),
      As, *static_cast<clang::OverloadCandidateSet *>(CandidateSet),
...
void clang_Sema_AddFunctionCandidates(CXSema S, const CXNamedDecl *Functions,
  ...
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddFunctionCandidates(
      Fns, As, *static_cast<clang::OverloadCandidateSet *>(CandidateSet),
      static_cast<clang::TemplateArgumentListInfo *>(ExplicitTemplateArgs),
...
void clang_Sema_AddMethodCandidate(CXSema S, CXCXXMethodDecl Method, CXNamedDecl FoundDecl,
                                   ...
                                   bool SuppressUserConversions, bool PartialOverloading,
                                   bool Reversed) {
  clang::Sema *Sm = static_cast<clang::Sema *>(S);
  clang::Expr *Obj = static_cast<clang::Expr *>(Object);
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  Sm->AddMethodCandidate(
      static_cast<clang::CXXMethodDecl *>(Method),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(FoundDecl),
                                  static_cast<clang::AccessSpecifier>(FoundAccess)),
      static_cast<clang::CXXRecordDecl *>(ActingContext), Obj->getType(),
      Obj->Classify(Sm->getASTContext()), As,
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet), SuppressUserConversions,
...
void clang_Sema_AddTemplateOverloadCandidate(
  ...
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddTemplateOverloadCandidate(
      static_cast<clang::FunctionTemplateDecl *>(FunctionTemplate),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(FoundDecl),
                                  static_cast<clang::AccessSpecifier>(FoundAccess)),
      static_cast<clang::TemplateArgumentListInfo *>(ExplicitTemplateArgs), As,
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet), SuppressUserConversions,
...
void clang_Sema_AddMemberOperatorCandidates(CXSema S, CXOverloadedOperatorKind Op,
                                            ...
                                            bool Reversed) {
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddMemberOperatorCandidates(
      static_cast<clang::OverloadedOperatorKind>(Op),
      clang::SourceLocation::getFromPtrEncoding(OpLoc), As,
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet),
      Reversed ? clang::OverloadCandidateParamOrder::Reversed
               : clang::OverloadCandidateParamOrder::Normal);
}
...
void clang_Sema_AddBuiltinCandidate(CXSema S, const CXQualType *ParamTys,
  ...
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddBuiltinCandidate(
      Ps.data(), As, *static_cast<clang::OverloadCandidateSet *>(CandidateSet),
...
void clang_Sema_AddBuiltinOperatorCandidates(CXSema S, CXOverloadedOperatorKind Op,
                                             ...
                                             CXOverloadCandidateSet CandidateSet) {
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddBuiltinOperatorCandidates(
      static_cast<clang::OverloadedOperatorKind>(Op),
      clang::SourceLocation::getFromPtrEncoding(OpLoc), As,
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet));
}
...
void clang_Sema_AddArgumentDependentLookupCandidates(
  ...
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddArgumentDependentLookupCandidates(
      clang::DeclarationName::getFromOpaquePtr(Name),
      clang::SourceLocation::getFromPtrEncoding(Loc), As,
      static_cast<clang::TemplateArgumentListInfo *>(ExplicitTemplateArgs),
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet), PartialOverloading);
}
...
void clang_Sema_AddMethodTemplateCandidate(
  ...
  Sm->AddMethodTemplateCandidate(
      static_cast<clang::FunctionTemplateDecl *>(MethodTmpl),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(FoundDecl),
                                  static_cast<clang::AccessSpecifier>(FoundAccess)),
      static_cast<clang::CXXRecordDecl *>(ActingContext),
      static_cast<clang::TemplateArgumentListInfo *>(ExplicitTemplateArgs), Obj->getType(),
      Obj->Classify(Sm->getASTContext()), As,
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet), SuppressUserConversions,
      PartialOverloading,
      Reversed ? clang::OverloadCandidateParamOrder::Reversed
...
void clang_Sema_AddConversionCandidate(CXSema S, CXCXXConversionDecl Conversion,
  ...
  static_cast<clang::Sema *>(S)->AddConversionCandidate(
      static_cast<clang::CXXConversionDecl *>(Conversion),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(FoundDecl),
                                  static_cast<clang::AccessSpecifier>(FoundAccess)),
      static_cast<clang::CXXRecordDecl *>(ActingContext), static_cast<clang::Expr *>(From),
      clang::QualType::getFromOpaquePtr(ToType),
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet),
...
void clang_Sema_AddTemplateConversionCandidate(
  ...
  static_cast<clang::Sema *>(S)->AddTemplateConversionCandidate(
      static_cast<clang::FunctionTemplateDecl *>(FunctionTemplate),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(FoundDecl),
                                  static_cast<clang::AccessSpecifier>(FoundAccess)),
      static_cast<clang::CXXRecordDecl *>(ActingContext), static_cast<clang::Expr *>(From),
...
void clang_Sema_AddSurrogateCandidate(CXSema S, CXCXXConversionDecl Conversion,
                                      ...
                                      CXOverloadCandidateSet CandidateSet) {
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddSurrogateCandidate(
      static_cast<clang::CXXConversionDecl *>(Conversion),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(FoundDecl),
                                  static_cast<clang::AccessSpecifier>(FoundAccess)),
      static_cast<clang::CXXRecordDecl *>(ActingContext),
      static_cast<clang::FunctionProtoType *>(Proto), static_cast<clang::Expr *>(Object),
      As, *static_cast<clang::OverloadCandidateSet *>(CandidateSet));
}
...
void clang_Sema_AddNonMemberOperatorCandidates(
  ...
  fillUnresolvedSet(Fns, Functions, Accesses, NumFunctions);
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddNonMemberOperatorCandidates(
      Fns, As, *static_cast<clang::OverloadCandidateSet *>(CandidateSet),
      static_cast<clang::TemplateArgumentListInfo *>(ExplicitTemplateArgs));
}
...
CXFunctionDecl clang_Sema_ResolveAddressOfOverloadedFunction(
  ...
  clang::FunctionDecl *FD =
      static_cast<clang::Sema *>(S)->ResolveAddressOfOverloadedFunction(
          static_cast<clang::Expr *>(AddressOfExpr),
...
void clang_Sema_AddOverloadedCallCandidates(CXSema S, CXUnresolvedLookupExpr ULE,
                                            ...
                                            bool PartialOverloading) {
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->AddOverloadedCallCandidates(
      static_cast<clang::UnresolvedLookupExpr *>(ULE), As,
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet), PartialOverloading);
}
...
void clang_Sema_FindAssociatedClassesAndNamespaces(
  ...
  static_cast<clang::Sema *>(S)->FindAssociatedClassesAndNamespaces(
...
bool clang_Sema_CompleteConstructorCall(CXSema S, CXCXXConstructorDecl Constructor,
  ...
  bool Invalid = static_cast<clang::Sema *>(S)->CompleteConstructorCall(
      static_cast<clang::CXXConstructorDecl *>(Constructor),
...
bool clang_Sema_GatherArgumentsForCall(CXSema S, CXSourceLocation_ CallLoc,
  ...
  bool Invalid = static_cast<clang::Sema *>(S)->GatherArgumentsForCall(
      clang::SourceLocation::getFromPtrEncoding(CallLoc),
      static_cast<clang::FunctionDecl *>(FDecl),
      static_cast<clang::FunctionProtoType *>(Proto), FirstParam, As, Gathered,
      static_cast<clang::Sema::VariadicCallType>(CallType), AllowExplicit,
      IsListInitialization);
  if (AllArgs)
    for (unsigned I = 0; I < AllArgsSize && I < Gathered.size(); ++I)
      AllArgs[I] = Gathered[I];
...
void clang_Sema_DeclareGlobalAllocationFunction(CXSema S, CXDeclarationName Name,
  ...
  static_cast<clang::Sema *>(S)->DeclareGlobalAllocationFunction(
      clang::DeclarationName::getFromOpaquePtr(Name),
...
bool clang_Sema_FindDeallocationFunction(CXSema S, CXSourceLocation_ StartLoc,
  ...
  bool Failed = static_cast<clang::Sema *>(S)->FindDeallocationFunction(
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
      static_cast<clang::CXXRecordDecl *>(RD),
...
void clang_Sema_CheckDelegatingCtorCycles(CXSema S) {
  static_cast<clang::Sema *>(S)->CheckDelegatingCtorCycles();
}

void clang_Sema_CheckCastAlign(CXSema S, CXExpr Op, CXQualType T,
                               CXSourceLocation_ TRange_begin,
                               CXSourceLocation_ TRange_end) {
  static_cast<clang::Sema *>(S)->CheckCastAlign(
      static_cast<clang::Expr *>(Op), clang::QualType::getFromOpaquePtr(T),
...
bool clang_Sema_CheckNontrivialField(CXSema S, CXFieldDecl FD) {
  return static_cast<clang::Sema *>(S)->CheckNontrivialField(
...
void clang_Sema_CheckCompatibleReinterpretCast(CXSema S, CXQualType SrcType,
                                               ...
                                               CXSourceLocation_ Range_begin,
                                               CXSourceLocation_ Range_end) {
  static_cast<clang::Sema *>(S)->CheckCompatibleReinterpretCast(
      clang::QualType::getFromOpaquePtr(SrcType),
...
bool clang_Sema_CheckConstraintExpression(CXSema S, CXExpr CE, bool *PossibleNonPrimary,
  ...
  return static_cast<clang::Sema *>(S)->CheckConstraintExpression(
      static_cast<clang::Expr *>(CE), NextToken, PossibleNonPrimary,
      IsTrailingRequiresClause);
}

void clang_Sema_CheckConstructor(CXSema S, CXCXXConstructorDecl Constructor) {
  static_cast<clang::Sema *>(S)->CheckConstructor(
      static_cast<clang::CXXConstructorDecl *>(Constructor));
}

void clang_Sema_CheckOverrideControl(CXSema S, CXNamedDecl D) {
  static_cast<clang::Sema *>(S)->CheckOverrideControl(static_cast<clang::NamedDecl *>(D));
}

void clang_Sema_CheckFloatComparison(CXSema S, CXSourceLocation_ Loc, CXExpr LHS,
                                     CXExpr RHS, CXBinaryOperatorKind Opcode) {
  static_cast<clang::Sema *>(S)->CheckFloatComparison(
      clang::SourceLocation::getFromPtrEncoding(Loc), static_cast<clang::Expr *>(LHS),
      static_cast<clang::Expr *>(RHS), static_cast<clang::BinaryOperatorKind>(Opcode));
}

// --- Sema state queries: current context, modules and type classification ---

CXASTConsumer clang_Sema_getASTConsumer(CXSema S) {
  return &static_cast<clang::Sema *>(S)->getASTConsumer();
}

CXScope clang_Sema_getScopeForContext(CXSema S, CXDeclContext Ctx) {
  return static_cast<clang::Sema *>(S)->getScopeForContext(
      static_cast<clang::DeclContext *>(Ctx));
}

bool clang_Sema_hasCurFunction(CXSema S) {
  return static_cast<clang::Sema *>(S)->getCurFunction() != nullptr;
}

bool clang_Sema_hasAnyUnrecoverableErrorsInThisFunction(CXSema S) {
  return static_cast<clang::Sema *>(S)->hasAnyUnrecoverableErrorsInThisFunction();
}

bool clang_Sema_isModuleVisible(CXSema S, CXModule M, bool ModulePrivate) {
  return static_cast<clang::Sema *>(S)->isModuleVisible(static_cast<clang::Module *>(M),
                                                        ModulePrivate);
}

bool clang_Sema_hasMergedDefinitionInCurrentModule(CXSema S, CXNamedDecl Def) {
  return static_cast<clang::Sema *>(S)->hasMergedDefinitionInCurrentModule(
      static_cast<clang::NamedDecl *>(Def));
}

CXQualType clang_Sema_getDecltypeForExpr(CXSema S, CXExpr E) {
  return static_cast<clang::Sema *>(S)
      ->getDecltypeForExpr(static_cast<clang::Expr *>(E))
      .getAsOpaquePtr();
}

bool clang_Sema_isSimpleTypeSpecifier(CXSema S, unsigned Kind) {
  return static_cast<clang::Sema *>(S)->isSimpleTypeSpecifier(
      static_cast<clang::tok::TokenKind>(Kind));
}

bool clang_Sema_isDeclInScope(CXSema S, CXNamedDecl D, CXDeclContext Ctx, CXScope Sc,
                              bool AllowInlineNamespace) {
  return static_cast<clang::Sema *>(S)->isDeclInScope(
      static_cast<clang::NamedDecl *>(D), static_cast<clang::DeclContext *>(Ctx),
      static_cast<clang::Scope *>(Sc), AllowInlineNamespace);
}

bool clang_Sema_IsStringInit(CXSema S, CXExpr Init, CXArrayType AT) {
  return static_cast<clang::Sema *>(S)->IsStringInit(static_cast<clang::Expr *>(Init),
                                                     static_cast<clang::ArrayType *>(AT));
}
...
CXFunctionEmissionStatus clang_Sema_getEmissionStatus(CXSema S, CXFunctionDecl FD,
  ...
  return static_cast<CXFunctionEmissionStatus>(
      static_cast<clang::Sema *>(S)->getEmissionStatus(
          static_cast<clang::FunctionDecl *>(FD), Final));
}

CXLangAS clang_Sema_getDefaultCXXMethodAddrSpace(CXSema S) {
  return static_cast<CXLangAS>(
      static_cast<clang::Sema *>(S)->getDefaultCXXMethodAddrSpace());
}

CXEnumDecl clang_Sema_getStdAlignValT(CXSema S) {
  return static_cast<clang::Sema *>(S)->getStdAlignValT();
}

bool clang_Sema_isThisOutsideMemberFunctionBody(CXSema S, CXQualType BaseType) {
  return static_cast<clang::Sema *>(S)->isThisOutsideMemberFunctionBody(
...
bool clang_Sema_isUnavailableAlignedAllocationFunction(CXSema S, CXFunctionDecl FD) {
  return static_cast<clang::Sema *>(S)->isUnavailableAlignedAllocationFunction(
      *static_cast<clang::FunctionDecl *>(FD));
}

bool clang_Sema_IsInsideALocalClassWithinATemplateFunction(CXSema S) {
  return static_cast<clang::Sema *>(S)->IsInsideALocalClassWithinATemplateFunction();
}

bool clang_Sema_CanBeGetReturnObject(CXFunctionDecl FD) {
  return clang::Sema::CanBeGetReturnObject(static_cast<clang::FunctionDecl *>(FD));
}

bool clang_Sema_IsStringLiteralToNonConstPointerConversion(CXSema S, CXExpr From,
                                                           CXQualType ToType) {
  return static_cast<clang::Sema *>(S)->IsStringLiteralToNonConstPointerConversion(
      static_cast<clang::Expr *>(From), clang::QualType::getFromOpaquePtr(ToType));
}

bool clang_Sema_isValidSveBitcast(CXSema S, CXQualType SrcType, CXQualType DestType) {
  return static_cast<clang::Sema *>(S)->isValidSveBitcast(
      clang::QualType::getFromOpaquePtr(SrcType),
      clang::QualType::getFromOpaquePtr(DestType));
}

bool clang_Sema_isValidRVVBitcast(CXSema S, CXQualType SrcType, CXQualType DestType) {
  return static_cast<clang::Sema *>(S)->isValidRVVBitcast(
      clang::QualType::getFromOpaquePtr(SrcType),
      clang::QualType::getFromOpaquePtr(DestType));
}
...
CXDeclContext clang_Sema_getCurObjCLexicalContext(CXSema S) {
  return const_cast<clang::DeclContext *>(
      static_cast<clang::Sema *>(S)->getCurObjCLexicalContext());
}

// Sema::AlignPackInfo
CXAlignPackInfo clang_AlignPackInfo_createPack(CXAlignPackInfo_Mode M, unsigned Num,
                                               bool IsXL) {
  return new clang::Sema::AlignPackInfo( // NOLINT(*-owning-memory)
...
clang_DefaultedFunctionKind_asComparison(CXDefaultedFunctionKind DFK) {
  return static_cast<CXDefaultedComparisonKind>(
      static_cast<clang::Sema::DefaultedFunctionKind *>(DFK)->asComparison());
}

unsigned clang_DefaultedFunctionKind_getDiagnosticIndex(CXDefaultedFunctionKind DFK) {
  return static_cast<clang::Sema::DefaultedFunctionKind *>(DFK)->getDiagnosticIndex();
}

// Sema::SFINAETrap
CXSFINAETrap clang_SFINAETrap_create(CXSema S, bool AccessCheckingSFINAE) {
  return new clang::Sema::SFINAETrap( // NOLINT(*-owning-memory)
      *static_cast<clang::Sema *>(S), AccessCheckingSFINAE);
}

void clang_SFINAETrap_dispose(CXSFINAETrap Trap) {
  delete static_cast<clang::Sema::SFINAETrap *>(Trap);
}

bool clang_SFINAETrap_hasErrorOccurred(CXSFINAETrap Trap) {
  return static_cast<clang::Sema::SFINAETrap *>(Trap)->hasErrorOccurred();
}
...
unsigned clang_Sema_LookupOverloadedOperatorName(CXSema S, CXOverloadedOperatorKind Op,
                                                 ...
                                                 unsigned BufSize) {
  clang::UnresolvedSet<8> Functions;
  static_cast<clang::Sema *>(S)->LookupOverloadedOperatorName(
      static_cast<clang::OverloadedOperatorKind>(Op), static_cast<clang::Scope *>(Sc),
      Functions);
  unsigned N = 0;
  for (clang::NamedDecl *ND : Functions) {
    if (Buf) {
...
void clang_Sema_LookupOverloadedBinOp(CXSema S, CXOverloadCandidateSet CandidateSet,
  ...
  fillUnresolvedSet(Fns, Functions, Accesses, NumFunctions);
  llvm::SmallVector<clang::Expr *, 8> As = makeExprArgs(Args, NumArgs);
  static_cast<clang::Sema *>(S)->LookupOverloadedBinOp(
      *static_cast<clang::OverloadCandidateSet *>(CandidateSet),
...
CXExpressionEvaluationContextRecord clang_Sema_currentEvaluationContext(CXSema S) {
  return const_cast<EvalCtxRecord *>(
      &static_cast<clang::Sema *>(S)->currentEvaluationContext());
}
...
bool clang_ExpressionEvaluationContextRecord_getDelayedDefaultInitializationContext(
  ...
  return unpackInitContext(
      static_cast<EvalCtxRecord *>(Rec)->DelayedDefaultInitializationContext, Loc, Decl,
      Ctx);
}
...
bool clang_Sema_InnermostDeclarationWithDelayedImmediateInvocations(CXSema S,
                                                                    ...
                                                                    CXDeclContext *Ctx) {
  return unpackInitContext(
      static_cast<clang::Sema *>(S)->InnermostDeclarationWithDelayedImmediateInvocations(),
      Loc, Decl, Ctx);
}
...
bool clang_Sema_OutermostDeclarationWithDelayedImmediateInvocations(CXSema S,
                                                                    ...
                                                                    CXDeclContext *Ctx) {
  return unpackInitContext(
      static_cast<clang::Sema *>(S)->OutermostDeclarationWithDelayedImmediateInvocations(),
      Loc, Decl, Ctx);
}
...
CXCUDAFunctionTarget clang_Sema_IdentifyCUDATarget(CXSema S, CXFunctionDecl D,
  ...
  return static_cast<CXCUDAFunctionTarget>(
      static_cast<clang::Sema *>(S)->IdentifyCUDATarget(
          static_cast<clang::FunctionDecl *>(D), IgnoreImplicitHDAttr));
}

CXCUDAFunctionTarget clang_Sema_CurrentCUDATarget(CXSema S) {
  return static_cast<CXCUDAFunctionTarget>(
      static_cast<clang::Sema *>(S)->CurrentCUDATarget());
}
...
CXCUDAFunctionPreference clang_Sema_IdentifyCUDAPreference(CXSema S, CXFunctionDecl Caller,
  ...
  return static_cast<CXCUDAFunctionPreference>(
      static_cast<clang::Sema *>(S)->IdentifyCUDAPreference(
          static_cast<clang::FunctionDecl *>(Caller),
          static_cast<clang::FunctionDecl *>(Callee)));
}
...
bool clang_Sema_FindAllocationFunctions(
  ...
  bool Failed = static_cast<clang::Sema *>(S)->FindAllocationFunctions(
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
      clang::SourceRange(clang::SourceLocation::getFromPtrEncoding(Range_begin),
                         clang::SourceLocation::getFromPtrEncoding(Range_end)),
...
CXQualType clang_Sema_FindCompositePointerType(CXSema S, CXSourceLocation_ Loc, CXExpr *E1,
  ...
  clang::Expr *A = static_cast<clang::Expr *>(*E1);
  clang::Expr *B = static_cast<clang::Expr *>(*E2);
  clang::QualType T = static_cast<clang::Sema *>(S)->FindCompositePointerType(
...
CXNamedDecl clang_Sema_FindInstantiatedDecl(CXSema S, CXSourceLocation_ Loc, CXNamedDecl D,
  ...
  return static_cast<clang::Sema *>(S)->FindInstantiatedDecl(
      clang::SourceLocation::getFromPtrEncoding(Loc), static_cast<clang::NamedDecl *>(D),
...
clang_Sema_FindInstantiatedContext(CXSema S, CXSourceLocation_ Loc, CXDeclContext DC,
                                   CXMultiLevelTemplateArgumentList TemplateArgs) {
  return static_cast<clang::Sema *>(S)->FindInstantiatedContext(
      clang::SourceLocation::getFromPtrEncoding(Loc), static_cast<clang::DeclContext *>(DC),
      extra::unboxMultiLevelTemplateArgumentList(TemplateArgs));
}
...
CXFunctionDecl clang_Sema_ResolveSingleFunctionTemplateSpecialization(
  ...
  clang::DeclAccessPair Found = clang::DeclAccessPair::make(nullptr, clang::AS_none);
  clang::FunctionDecl *FD =
      static_cast<clang::Sema *>(S)->ResolveSingleFunctionTemplateSpecialization(
          static_cast<clang::OverloadExpr *>(Ovl), Complain, &Found);
  *FoundDecl = Found.getDecl();
  *FoundAccess = static_cast<CXAccessSpecifier>(Found.getAccess());
  return FD;
}
...
CXQualType clang_Sema_AdjustParameterTypeForObjCAutoRefCount(CXSema S, CXQualType T,
  ...
  return static_cast<clang::Sema *>(S)
      ->AdjustParameterTypeForObjCAutoRefCount(
          clang::QualType::getFromOpaquePtr(T),
          clang::SourceLocation::getFromPtrEncoding(NameLoc),
          static_cast<clang::TypeSourceInfo *>(TSInfo))
      .getAsOpaquePtr();
}

void clang_Sema_SetFunctionBodyKind(CXSema S, CXDecl D, CXSourceLocation_ Loc,
                                    CXFnBodyKind BodyKind) {
  static_cast<clang::Sema *>(S)->SetFunctionBodyKind(
      static_cast<clang::Decl *>(D), clang::SourceLocation::getFromPtrEncoding(Loc),
...
void clang_Sema_setExceptionMode(CXSema S, CXSourceLocation_ Loc,
  ...
  static_cast<clang::Sema *>(S)->setExceptionMode(
      clang::SourceLocation::getFromPtrEncoding(Loc),
...
void clang_Sema_RegisterLocallyScopedExternCDecl(CXSema S, CXNamedDecl ND, CXScope Sc) {
  static_cast<clang::Sema *>(S)->RegisterLocallyScopedExternCDecl(
      static_cast<clang::NamedDecl *>(ND), static_cast<clang::Scope *>(Sc));
}

void clang_Sema_MergeVarDeclTypes(CXSema S, CXVarDecl New, CXVarDecl Old,
                                  bool MergeTypeWithOld) {
  static_cast<clang::Sema *>(S)->MergeVarDeclTypes(static_cast<clang::VarDecl *>(New),
                                                   static_cast<clang::VarDecl *>(Old),
                                                   MergeTypeWithOld);
}

void clang_Sema_MergeVarDeclExceptionSpecs(CXSema S, CXVarDecl New, CXVarDecl Old) {
  static_cast<clang::Sema *>(S)->MergeVarDeclExceptionSpecs(
      static_cast<clang::VarDecl *>(New), static_cast<clang::VarDecl *>(Old));
}
...
CXQualType clang_Sema_CheckMultiplyDivideOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckMultiplyDivideOperands(
      L, R, clang::SourceLocation::getFromPtrEncoding(Loc), IsCompAssign, IsDivide);
  *LHS = L.isInvalid() ? nullptr : L.get();
  *RHS = R.isInvalid() ? nullptr : R.get();
  return T.getAsOpaquePtr();
}
...
CXQualType clang_Sema_CheckRemainderOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckRemainderOperands(
...
CXQualType clang_Sema_CheckAdditionOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType Comp;
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckAdditionOperands(
      L, R, clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::BinaryOperatorKind>(Opc), IsCompAssign ? &Comp : nullptr);
  *LHS = L.isInvalid() ? nullptr : L.get();
  *RHS = R.isInvalid() ? nullptr : R.get();
  if (IsCompAssign)
    *CompLHSTy = Comp.getAsOpaquePtr();
  return T.getAsOpaquePtr();
}
...
CXQualType clang_Sema_CheckSubtractionOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType Comp;
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckSubtractionOperands(
...
CXQualType clang_Sema_CheckShiftOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckShiftOperands(
      L, R, clang::SourceLocation::getFromPtrEncoding(Loc),
...
void clang_Sema_CheckPtrComparisonWithNullChar(CXSema S, CXExpr *E, CXExpr *NullE) {
  clang::ExprResult L = static_cast<clang::Expr *>(*E);
  clang::ExprResult R = static_cast<clang::Expr *>(*NullE);
  static_cast<clang::Sema *>(S)->CheckPtrComparisonWithNullChar(L, R);
  *E = L.isInvalid() ? nullptr : L.get();
  *NullE = R.isInvalid() ? nullptr : R.get();
}
...
CXQualType clang_Sema_CheckCompareOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckCompareOperands(
      L, R, clang::SourceLocation::getFromPtrEncoding(Loc),
...
CXQualType clang_Sema_CheckAssignmentOperands(CXSema S, CXExpr LHSExpr, CXExpr *RHS,
                                              ...
                                              CXBinaryOperatorKind Opc) {
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckAssignmentOperands(
      static_cast<clang::Expr *>(LHSExpr), R,
      clang::SourceLocation::getFromPtrEncoding(Loc),
...
CXQualType clang_Sema_CheckPointerToMemberOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckPointerToMemberOperands(
...
CXQualType clang_Sema_CheckAddressOfOperand(CXSema S, CXExpr *Operand,
                                            CXSourceLocation_ OpLoc) {
  clang::ExprResult Op = static_cast<clang::Expr *>(*Operand);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckAddressOfOperand(
      Op, clang::SourceLocation::getFromPtrEncoding(OpLoc));
  *Operand = Op.isInvalid() ? nullptr : Op.get();
  return T.getAsOpaquePtr();
}
...
CXExpr clang_Sema_CheckExtVectorCast(CXSema S, CXSourceLocation_ R_begin,
  ...
  clang::CastKind K = clang::CK_Dependent;
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CheckExtVectorCast(
      clang::SourceRange(clang::SourceLocation::getFromPtrEncoding(R_begin),
                         clang::SourceLocation::getFromPtrEncoding(R_end)),
      clang::QualType::getFromOpaquePtr(DestTy), static_cast<clang::Expr *>(CastExpr), K);
  *Kind = static_cast<CXCastKind>(K);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
bool clang_Sema_CheckMemberPointerConversion(CXSema S, CXExpr From, CXQualType ToType,
  ...
  clang::CastKind K = clang::CK_Dependent;
  clang::CXXCastPath BasePath;
  bool Failed = static_cast<clang::Sema *>(S)->CheckMemberPointerConversion(
      static_cast<clang::Expr *>(From), clang::QualType::getFromOpaquePtr(ToType), K,
...
bool clang_Sema_CheckExplicitObjectOverride(CXSema S, CXCXXMethodDecl New,
                                            CXCXXMethodDecl Old) {
  return static_cast<clang::Sema *>(S)->CheckExplicitObjectOverride(
      static_cast<clang::CXXMethodDecl *>(New), static_cast<clang::CXXMethodDecl *>(Old));
}

void clang_Sema_CheckDelayedMemberExceptionSpecs(CXSema S) {
  static_cast<clang::Sema *>(S)->CheckDelayedMemberExceptionSpecs();
}

void clang_Sema_CheckCoroutineWrapper(CXSema S, CXFunctionDecl FD) {
  static_cast<clang::Sema *>(S)->CheckCoroutineWrapper(
      static_cast<clang::FunctionDecl *>(FD));
}
...
CXExpr clang_Sema_CreateOverloadedArraySubscriptExpr(CXSema S, CXSourceLocation_ LLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CreateOverloadedArraySubscriptExpr(
      clang::SourceLocation::getFromPtrEncoding(LLoc),
      clang::SourceLocation::getFromPtrEncoding(RLoc), static_cast<clang::Expr *>(Base),
      ArgVec);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildCallToObjectOfClassType(CXSema S, CXScope Sp, CXExpr Object,
  ...
  for (unsigned I = 0; I != NumArgs; ++I)
    ArgVec.push_back(static_cast<clang::Expr *>(Args[I]));
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCallToObjectOfClassType(
      static_cast<clang::Scope *>(Sp), static_cast<clang::Expr *>(Object),
...
CXExpr clang_Sema_BuildOverloadedArrowExpr(CXSema S, CXScope Sp, CXExpr Base,
  ...
  bool NoArrow = false;
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildOverloadedArrowExpr(
      static_cast<clang::Scope *>(Sp), static_cast<clang::Expr *>(Base),
...
CXStmt clang_Sema_BuildAttributedStmt(CXSema S, CXSourceLocation_ AttrsLoc,
  ...
  for (unsigned I = 0; I != NumAttrs; ++I)
    AttrVec.push_back(static_cast<const clang::Attr *>(Attrs[I]));
  clang::StmtResult R = static_cast<clang::Sema *>(S)->BuildAttributedStmt(
...
CXExpr clang_Sema_CreateGenericSelectionExpr(
  ...
  for (unsigned I = 0; I != NumAssocs; ++I) {
    TypeVec.push_back(static_cast<clang::TypeSourceInfo *>(Types[I]));
    ExprVec.push_back(static_cast<clang::Expr *>(Exprs[I]));
  }
  clang::ExprResult R = static_cast<clang::Sema *>(S)->CreateGenericSelectionExpr(
      clang::SourceLocation::getFromPtrEncoding(KeyLoc),
      clang::SourceLocation::getFromPtrEncoding(DefaultLoc),
...
CXExpr clang_Sema_BuildResolvedCallExpr(CXSema S, CXExpr Fn, CXNamedDecl NDecl,
  ...
  for (unsigned I = 0; I != NumArgs; ++I)
    ArgVec.push_back(static_cast<clang::Expr *>(Args[I]));
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildResolvedCallExpr(
      static_cast<clang::Expr *>(Fn), static_cast<clang::NamedDecl *>(NDecl),
      clang::SourceLocation::getFromPtrEncoding(LParenLoc), ArgVec,
      clang::SourceLocation::getFromPtrEncoding(RParenLoc),
      static_cast<clang::Expr *>(Config), IsExecConfig,
...
CXExpr clang_Sema_BuildCXXDefaultInitExpr(CXSema S, CXSourceLocation_ Loc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXDefaultInitExpr(
      clang::SourceLocation::getFromPtrEncoding(Loc),
...
CXExpr clang_Sema_BuildCXXDefaultArgExpr(CXSema S, CXSourceLocation_ CallLoc,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXDefaultArgExpr(
      clang::SourceLocation::getFromPtrEncoding(CallLoc),
      static_cast<clang::FunctionDecl *>(FD), static_cast<clang::ParmVarDecl *>(Param),
...
CXExpr clang_Sema_BuildCXXMemberCallExpr(CXSema S, CXExpr Exp, CXNamedDecl FoundDecl,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXMemberCallExpr(
      static_cast<clang::Expr *>(Exp), static_cast<clang::NamedDecl *>(FoundDecl),
      static_cast<clang::CXXConversionDecl *>(Method), HadMultipleCandidates);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXCXXCtorInitializer clang_Sema_BuildMemberInitializer(CXSema S, CXValueDecl Member,
                                                       ...
                                                       bool *IsInvalid) {
  clang::MemInitResult R = static_cast<clang::Sema *>(S)->BuildMemberInitializer(
      static_cast<clang::ValueDecl *>(Member), static_cast<clang::Expr *>(Init),
      clang::SourceLocation::getFromPtrEncoding(IdLoc));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
bool clang_Sema_isObjCMethodDecl(CXSema S, CXDecl D) {
  return static_cast<clang::Sema *>(S)->isObjCMethodDecl(static_cast<clang::Decl *>(D));
}

bool clang_Sema_canSkipFunctionBody(CXSema S, CXDecl D) {
  return static_cast<clang::Sema *>(S)->canSkipFunctionBody(static_cast<clang::Decl *>(D));
}

bool clang_Sema_IsRedefinitionInModule(CXSema S, CXNamedDecl New, CXNamedDecl Old) {
  return static_cast<clang::Sema *>(S)->IsRedefinitionInModule(
      static_cast<clang::NamedDecl *>(New), static_cast<clang::NamedDecl *>(Old));
}

bool clang_Sema_isValidSectionSpecifier(CXSema S, const char *Str) {
  llvm::Error E = static_cast<clang::Sema *>(S)->isValidSectionSpecifier(Str);
  if (!E)
    return true;
...
bool clang_Sema_ShouldWarnIfUnusedFileScopedDecl(CXSema S, CXDeclaratorDecl D) {
  return static_cast<clang::Sema *>(S)->ShouldWarnIfUnusedFileScopedDecl(
      static_cast<clang::DeclaratorDecl *>(D));
}
...
CXNonOdrUseReason clang_Sema_getNonOdrUseReasonInCurrentContext(CXSema S, CXValueDecl D) {
  return static_cast<CXNonOdrUseReason>(
      static_cast<clang::Sema *>(S)->getNonOdrUseReasonInCurrentContext(
          static_cast<clang::ValueDecl *>(D)));
}

bool clang_Sema_isQualifiedMemberAccess(CXSema S, CXExpr E) {
  return static_cast<clang::Sema *>(S)->isQualifiedMemberAccess(
      static_cast<clang::Expr *>(E));
}
...
CXQualType clang_Sema_getLambdaConversionFunctionResultType(CXSema S,
  ...
  return static_cast<clang::Sema *>(S)
      ->getLambdaConversionFunctionResultType(
          static_cast<clang::FunctionProtoType *>(CallOpType),
...
bool clang_Sema_IsSimplyAccessible(CXSema S, CXNamedDecl D, CXCXXRecordDecl NamingClass,
                                   CXQualType BaseType) {
  return static_cast<clang::Sema *>(S)->IsSimplyAccessible(
      static_cast<clang::NamedDecl *>(D), static_cast<clang::CXXRecordDecl *>(NamingClass),
      clang::QualType::getFromOpaquePtr(BaseType));
}

CXSourceLocation_ clang_Sema_getTopMostPointOfInstantiation(CXSema S, CXNamedDecl ND) {
  return static_cast<clang::Sema *>(S)
      ->getTopMostPointOfInstantiation(static_cast<clang::NamedDecl *>(ND))
      .getPtrEncoding();
}

bool clang_Sema_isSFINAEContext(CXSema S, CXTemplateDeductionInfo *Info) {
  std::optional<clang::sema::TemplateDeductionInfo *> R =
      static_cast<clang::Sema *>(S)->isSFINAEContext();
  if (!R)
    return false;
  if (Info)
    *Info = *R;
...
bool clang_Sema_isInOpenMPAssumeScope(CXSema S) {
  return static_cast<clang::Sema *>(S)->isInOpenMPAssumeScope();
}

bool clang_Sema_hasGlobalOpenMPAssumes(CXSema S) {
  return static_cast<clang::Sema *>(S)->hasGlobalOpenMPAssumes();
}
...
CXVariadicCallType clang_Sema_getVariadicCallType(CXSema S, CXFunctionDecl FDecl,
  ...
  return static_cast<CXVariadicCallType>(static_cast<clang::Sema *>(S)->getVariadicCallType(
      static_cast<clang::FunctionDecl *>(FDecl),
      static_cast<clang::FunctionProtoType *>(Proto), static_cast<clang::Expr *>(Fn)));
}
...
bool clang_Sema_shouldIgnoreInHostDeviceCheck(CXSema S, CXFunctionDecl Callee) {
  return static_cast<clang::Sema *>(S)->shouldIgnoreInHostDeviceCheck(
      static_cast<clang::FunctionDecl *>(Callee));
}
...
CXQualType clang_Sema_adjustMemberFunctionCC(CXSema S, CXQualType T, bool HasThisPointer,
  ...
  static_cast<clang::Sema *>(S)->adjustMemberFunctionCC(
...
CXExpr clang_Sema_HandleExprEvaluationContextForTypeof(CXSema S, CXExpr E,
                                                       bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->HandleExprEvaluationContextForTypeof(
      static_cast<clang::Expr *>(E));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_tryConvertExprToType(CXSema S, CXExpr E, CXQualType Ty, bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->tryConvertExprToType(
      static_cast<clang::Expr *>(E), clang::QualType::getFromOpaquePtr(Ty));
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXCastKind clang_Sema_PrepareScalarCast(CXSema S, CXExpr Src, CXQualType DestTy,
                                        CXExpr *Adjusted) {
  clang::ExprResult E(static_cast<clang::Expr *>(Src));
  clang::CastKind CK = static_cast<clang::Sema *>(S)->PrepareScalarCast(
      E, clang::QualType::getFromOpaquePtr(DestTy));
  *Adjusted = E.isInvalid() ? nullptr : E.get();
  return static_cast<CXCastKind>(CK);
}

CXExpr clang_Sema_MaybeCreateExprWithCleanups(CXSema S, CXExpr SubExpr) {
  return static_cast<clang::Sema *>(S)->MaybeCreateExprWithCleanups(
      static_cast<clang::Expr *>(SubExpr));
}

CXStmt clang_Sema_MaybeCreateStmtWithCleanups(CXSema S, CXStmt SubStmt) {
  return static_cast<clang::Sema *>(S)->MaybeCreateStmtWithCleanups(
      static_cast<clang::Stmt *>(SubStmt));
}

void clang_Sema_LoadExternalVTableUses(CXSema S) {
  static_cast<clang::Sema *>(S)->LoadExternalVTableUses();
}
...
CXString clang_Sema_EvaluateStaticAssertMessageAsString(CXSema S, CXExpr Message,
                                                        ...
                                                        bool *Ok) {
  std::string Str;
  *Ok = static_cast<clang::Sema *>(S)->EvaluateStaticAssertMessageAsString(
      static_cast<clang::Expr *>(Message), Str, *static_cast<clang::ASTContext *>(Ctx),
...
bool clang_Sema_AreConstraintExpressionsEqual(CXSema S, CXNamedDecl Old, CXExpr OldConstr,
  ...
  return static_cast<clang::Sema *>(S)->AreConstraintExpressionsEqual(
      static_cast<clang::NamedDecl *>(Old), static_cast<clang::Expr *>(OldConstr),
      clang::Sema::TemplateCompareNewDeclInfo(static_cast<clang::NamedDecl *>(New)),
      static_cast<clang::Expr *>(NewConstr));
}
...
CXExpr clang_Sema_ImpCastExprToType(CXSema S, CXExpr E, CXQualType Type, CXCastKind CK,
                                    ...
                                    bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->ImpCastExprToType(
      static_cast<clang::Expr *>(E), clang::QualType::getFromOpaquePtr(Type),
...
bool clang_Sema_CheckArgsForPlaceholders(CXSema S, CXExpr *Args, unsigned NumArgs) {
  ...
  Buf.reserve(NumArgs);
  for (unsigned I = 0; I != NumArgs; ++I)
    Buf.push_back(static_cast<clang::Expr *>(Args[I]));
  bool Failed = static_cast<clang::Sema *>(S)->CheckArgsForPlaceholders(Buf);
  for (unsigned I = 0; I != NumArgs; ++I)
    Args[I] = Buf[I];
  return Failed;
}
...
CXAttr clang_Sema_CheckEnableIf(CXSema S, CXFunctionDecl Function,
  ...
  for (unsigned I = 0; I != NumArgs; ++I)
    Buf.push_back(static_cast<clang::Expr *>(Args[I]));
  return static_cast<clang::Sema *>(S)->CheckEnableIf(
      static_cast<clang::FunctionDecl *>(Function),
...
bool clang_Sema_CheckAlignasTypeArgument(CXSema S, const char *KWName,
  ...
  return static_cast<clang::Sema *>(S)->CheckAlignasTypeArgument(
      llvm::StringRef(KWName), static_cast<clang::TypeSourceInfo *>(TInfo),
      clang::SourceLocation::getFromPtrEncoding(OpLoc),
      clang::SourceRange(clang::SourceLocation::getFromPtrEncoding(R_begin),
                         clang::SourceLocation::getFromPtrEncoding(R_end)));
}
...
bool clang_Sema_CheckCXXThrowOperand(CXSema S, CXSourceLocation_ ThrowLoc,
  ...
  return static_cast<clang::Sema *>(S)->CheckCXXThrowOperand(
      clang::SourceLocation::getFromPtrEncoding(ThrowLoc),
      clang::QualType::getFromOpaquePtr(ThrowTy), static_cast<clang::Expr *>(E));
}
...
CXAccessResult clang_Sema_CheckMemberAccess(CXSema S, CXSourceLocation_ UseLoc,
                                            ...
                                            CXAccessSpecifier FoundAccess) {
  return static_cast<CXAccessResult>(static_cast<clang::Sema *>(S)->CheckMemberAccess(
      clang::SourceLocation::getFromPtrEncoding(UseLoc),
      static_cast<clang::CXXRecordDecl *>(NamingClass),
      clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(Found),
                                  static_cast<clang::AccessSpecifier>(FoundAccess))));
}
...
CXAccessResult clang_Sema_CheckStructuredBindingMemberAccess(
  ...
  return static_cast<CXAccessResult>(
      static_cast<clang::Sema *>(S)->CheckStructuredBindingMemberAccess(
          clang::SourceLocation::getFromPtrEncoding(UseLoc),
          static_cast<clang::CXXRecordDecl *>(DecomposedClass),
          clang::DeclAccessPair::make(static_cast<clang::NamedDecl *>(Field),
...
CXQualType clang_Sema_CheckConditionalOperands(CXSema S, CXExpr *Cond, CXExpr *LHS,
  ...
  clang::ExprResult C = static_cast<clang::Expr *>(*Cond);
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::ExprValueKind K = clang::VK_PRValue;
  clang::ExprObjectKind O = clang::OK_Ordinary;
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckConditionalOperands(
      C, L, R, K, O, clang::SourceLocation::getFromPtrEncoding(QuestionLoc));
  *Cond = C.isInvalid() ? nullptr : C.get();
  *LHS = L.isInvalid() ? nullptr : L.get();
  *RHS = R.isInvalid() ? nullptr : R.get();
  *VK = static_cast<CXExprValueKind>(K);
...
CXQualType clang_Sema_CXXCheckConditionalOperands(CXSema S, CXExpr *Cond, CXExpr *LHS,
  ...
  clang::ExprValueKind K = clang::VK_PRValue;
  clang::ExprObjectKind O = clang::OK_Ordinary;
  clang::QualType T = static_cast<clang::Sema *>(S)->CXXCheckConditionalOperands(
      C, L, R, K, O, clang::SourceLocation::getFromPtrEncoding(QuestionLoc));
  *Cond = C.isInvalid() ? nullptr : C.get();
  *LHS = L.isInvalid() ? nullptr : L.get();
  *RHS = R.isInvalid() ? nullptr : R.get();
...
CXQualType clang_Sema_CheckVectorConditionalTypes(CXSema S, CXExpr *Cond, CXExpr *LHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckVectorConditionalTypes(
...
CXQualType clang_Sema_CheckVectorOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckVectorOperands(
...
CXQualType clang_Sema_CheckVectorCompareOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckVectorCompareOperands(
      L, R, clang::SourceLocation::getFromPtrEncoding(Loc),
      static_cast<clang::BinaryOperatorKind>(Opc));
  *LHS = L.isInvalid() ? nullptr : L.get();
  *RHS = R.isInvalid() ? nullptr : R.get();
...
CXQualType clang_Sema_CheckVectorLogicalOperands(CXSema S, CXExpr *LHS, CXExpr *RHS,
  ...
  clang::ExprResult L = static_cast<clang::Expr *>(*LHS);
  clang::ExprResult R = static_cast<clang::Expr *>(*RHS);
  clang::QualType T = static_cast<clang::Sema *>(S)->CheckVectorLogicalOperands(
      L, R, clang::SourceLocation::getFromPtrEncoding(Loc));
  *LHS = L.isInvalid() ? nullptr : L.get();
  *RHS = R.isInvalid() ? nullptr : R.get();
  return T.getAsOpaquePtr();
...
CXFunctionDecl clang_Sema_CreateBuiltin(CXSema S, CXIdentifierInfo II, CXQualType Type,
  ...
  return static_cast<clang::Sema *>(S)->CreateBuiltin(
      static_cast<clang::IdentifierInfo *>(II), clang::QualType::getFromOpaquePtr(Type), ID,
      clang::SourceLocation::getFromPtrEncoding(Loc));
}
...
CXRecordDecl clang_Sema_CreateCapturedStmtRecordDecl(CXSema S, CXCapturedDecl *CD,
  ...
  clang::RecordDecl *RD = static_cast<clang::Sema *>(S)->CreateCapturedStmtRecordDecl(
...
CXExpr clang_Sema_BuildStmtExpr(CXSema S, CXSourceLocation_ LPLoc, CXStmt SubStmt,
                                ...
                                bool *IsInvalid) {
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildStmtExpr(
      clang::SourceLocation::getFromPtrEncoding(LPLoc), static_cast<clang::Stmt *>(SubStmt),
...
CXNamedDecl clang_Sema_BuildUsingPackDecl(CXSema S, CXNamedDecl InstantiatedFrom,
  ...
  for (unsigned I = 0; I != NumExpansions; ++I)
    Expanded.push_back(static_cast<clang::NamedDecl *>(Expansions[I]));
  return static_cast<clang::Sema *>(S)->BuildUsingPackDecl(
      static_cast<clang::NamedDecl *>(InstantiatedFrom), Expanded);
}
...
CXExpr clang_Sema_BuildCXXFoldExpr(CXSema S, CXUnresolvedLookupExpr Callee,
  ...
  clang::ExprResult R = static_cast<clang::Sema *>(S)->BuildCXXFoldExpr(
      static_cast<clang::UnresolvedLookupExpr *>(Callee),
      clang::SourceLocation::getFromPtrEncoding(LParenLoc), static_cast<clang::Expr *>(LHS),
      static_cast<clang::BinaryOperatorKind>(Operator),
      clang::SourceLocation::getFromPtrEncoding(EllipsisLoc),
      static_cast<clang::Expr *>(RHS), clang::SourceLocation::getFromPtrEncoding(RParenLoc),
      HasNumExpansions ? std::optional<unsigned>(NumExpansions) : std::nullopt);
  *IsInvalid = R.isInvalid();
  return R.isInvalid() ? nullptr : R.get();
}
...
CXExpr clang_Sema_BuildCXXThisExpr(CXSema S, CXSourceLocation_ Loc, CXQualType Type,
                                   bool IsImplicit) {
  return static_cast<clang::Sema *>(S)->BuildCXXThisExpr(
      clang::SourceLocation::getFromPtrEncoding(Loc),
...
unsigned clang_Sema_getUndefinedButUsed(CXSema S, CXNamedDecl *Decls,
  ...
  static_cast<clang::Sema *>(S)->getUndefinedButUsed(Undefined);
  unsigned Total = static_cast<unsigned>(Undefined.size());
  if (Decls && Locs) {
    unsigned N = Capacity < Total ? Capacity : Total;
    for (unsigned I = 0; I != N; ++I) {
      Decls[I] = Undefined[I].first;
      Locs[I] = Undefined[I].second.getPtrEncoding();
    }
  }
  return Total;
}
...
CXCanThrowResult clang_Sema_canCalleeThrow(CXSema S, CXExpr E, CXDecl D,
  ...
  return static_cast<CXCanThrowResult>(clang::Sema::canCalleeThrow(
      *static_cast<clang::Sema *>(S), static_cast<clang::Expr *>(E),
      static_cast<clang::Decl *>(D), clang::SourceLocation::getFromPtrEncoding(Loc)));
}
...
clang_Sema_getTemplateNameKindForDiagnostics(CXSema S, CXTemplateName Name) {
  return static_cast<CXTemplateNameKindForDiagnostics>(
      static_cast<clang::Sema *>(S)->getTemplateNameKindForDiagnostics(
...
CXNonTagKind clang_Sema_getNonTagTypeDeclKind(CXSema S, CXDecl D, CXTagTypeKind TTK) {
  return static_cast<CXNonTagKind>(static_cast<clang::Sema *>(S)->getNonTagTypeDeclKind(
      static_cast<clang::Decl *>(D), static_cast<clang::TagTypeKind>(TTK)));
}
...
CXFieldDecl clang_Sema_getSelfAssignmentClassMemberCandidate(CXSema S,
  ...
  return const_cast<clang::FieldDecl *>(
      static_cast<clang::Sema *>(S)->getSelfAssignmentClassMemberCandidate(
          static_cast<clang::ValueDecl *>(SelfAssigned)));
}

bool clang_Sema_CanUseDecl(CXSema S, CXNamedDecl D, bool TreatUnavailableAsInvalid) {
  return static_cast<clang::Sema *>(S)->CanUseDecl(static_cast<clang::NamedDecl *>(D),
                                                   TreatUnavailableAsInvalid);
}

bool clang_Sema_ShouldSplatAltivecScalarInCast(CXSema S, CXVectorType VecTy) {
  return static_cast<clang::Sema *>(S)->ShouldSplatAltivecScalarInCast(
      static_cast<clang::VectorType *>(VecTy));
}

bool clang_Sema_IsInvalidSMECallConversion(CXSema S, CXQualType FromType,
                                           CXQualType ToType) {
  return static_cast<clang::Sema *>(S)->IsInvalidSMECallConversion(
      clang::QualType::getFromOpaquePtr(FromType),
      clang::QualType::getFromOpaquePtr(ToType));
}
...
bool clang_Sema_hasAnyAcceptableTemplateNames(CXSema S, CXLookupResult R,
  ...
  return static_cast<clang::Sema *>(S)->hasAnyAcceptableTemplateNames(
      *static_cast<clang::LookupResult *>(R), AllowFunctionTemplates, AllowDependent,
...
CXTypeLoc clang_Sema_getReturnTypeLoc(CXSema S, CXFunctionDecl FD) {
  return new clang::TypeLoc( // NOLINT(*-owning-memory)
      static_cast<clang::Sema *>(S)->getReturnTypeLoc(
          static_cast<clang::FunctionDecl *>(FD)));
}
...
CXClassTemplatePartialSpecializationDecl clang_Sema_getMoreSpecializedPartialSpecialization(
  ...
  return static_cast<clang::Sema *>(S)->getMoreSpecializedPartialSpecialization(
      static_cast<clang::ClassTemplatePartialSpecializationDecl *>(PS1),
      static_cast<clang::ClassTemplatePartialSpecializationDecl *>(PS2),
      clang::SourceLocation::getFromPtrEncoding(Loc));
}
...
bool clang_Sema_isMoreSpecializedThanPrimary(CXSema S,
                                             ...
                                             CXTemplateDeductionInfo Info) {
  return static_cast<clang::Sema *>(S)->isMoreSpecializedThanPrimary(
      static_cast<clang::ClassTemplatePartialSpecializationDecl *>(T),
      *static_cast<clang::sema::TemplateDeductionInfo *>(Info));
}

bool clang_Sema_isInOpenMPDeclareVariantScope(CXSema S) {
  return static_cast<clang::Sema *>(S)->isInOpenMPDeclareVariantScope();
}

bool clang_Sema_isInOpenMPDeclareTargetContext(CXSema S) {
  return static_cast<clang::Sema *>(S)->isInOpenMPDeclareTargetContext();
}

CXIdentifierInfo clang_Sema_getNullabilityKeyword(CXSema S, CXNullabilityKind Nullability) {
  return static_cast<clang::Sema *>(S)->getNullabilityKeyword(
      static_cast<clang::NullabilityKind>(Nullability));
}

bool clang_Sema_isCFError(CXSema S, CXRecordDecl D) {
  return static_cast<clang::Sema *>(S)->isCFError(static_cast<clang::RecordDecl *>(D));
}

void clang_Sema_PushDeclContext(CXSema S, CXScope Sc, CXDeclContext DC) {
  static_cast<clang::Sema *>(S)->PushDeclContext(static_cast<clang::Scope *>(Sc),
                                                 static_cast<clang::DeclContext *>(DC));
}

void clang_Sema_PopDeclContext(CXSema S) {
  static_cast<clang::Sema *>(S)->PopDeclContext();
}

void clang_Sema_PushFunctionScope(CXSema S) {
  static_cast<clang::Sema *>(S)->PushFunctionScope();
}

void clang_Sema_PushBlockScope(CXSema S, CXScope BlockScope, CXBlockDecl Block) {
  static_cast<clang::Sema *>(S)->PushBlockScope(static_cast<clang::Scope *>(BlockScope),
                                                static_cast<clang::BlockDecl *>(Block));
}
...
void clang_Sema_PushCapturedRegionScope(CXSema S, CXScope RegionScope, CXCapturedDecl CD,
  ...
  static_cast<clang::Sema *>(S)->PushCapturedRegionScope(
      static_cast<clang::Scope *>(RegionScope), static_cast<clang::CapturedDecl *>(CD),
      static_cast<clang::RecordDecl *>(RD), static_cast<clang::CapturedRegionKind>(K),
      OpenMPCaptureLevel);
}

void clang_Sema_PushCompoundScope(CXSema S, bool IsStmtExpr) {
  static_cast<clang::Sema *>(S)->PushCompoundScope(IsStmtExpr);
}

void clang_Sema_PopCompoundScope(CXSema S) {
  static_cast<clang::Sema *>(S)->PopCompoundScope();
}
...
void clang_Sema_PushExpressionEvaluationContext(CXSema S,
  ...
  static_cast<clang::Sema *>(S)->PushExpressionEvaluationContext(
      static_cast<clang::Sema::ExpressionEvaluationContext>(NewContext),
      static_cast<clang::Decl *>(LambdaContextDecl),
...
void clang_Sema_PopExpressionEvaluationContext(CXSema S) {
  static_cast<clang::Sema *>(S)->PopExpressionEvaluationContext();
}

void clang_Sema_PushForceCUDAHostDevice(CXSema S) {
  static_cast<clang::Sema *>(S)->PushForceCUDAHostDevice();
}

bool clang_Sema_PopForceCUDAHostDevice(CXSema S) {
  return static_cast<clang::Sema *>(S)->PopForceCUDAHostDevice();
}

void clang_Sema_PopPragmaVisibility(CXSema S, bool IsNamespaceEnd,
                                    CXSourceLocation_ EndLoc) {
  static_cast<clang::Sema *>(S)->PopPragmaVisibility(
...
void clang_Sema_PushOnScopeChains(CXSema S, CXNamedDecl D, CXScope Sc, bool AddToContext) {
  static_cast<clang::Sema *>(S)->PushOnScopeChains(
      static_cast<clang::NamedDecl *>(D), static_cast<clang::Scope *>(Sc), AddToContext);
}

void clang_Sema_PushUsingDirective(CXSema S, CXScope Sc, CXUsingDirectiveDecl UDir) {
  static_cast<clang::Sema *>(S)->PushUsingDirective(
      static_cast<clang::Scope *>(Sc), static_cast<clang::UsingDirectiveDecl *>(UDir));
}

void clang_Sema_PushNamespaceVisibilityAttr(CXSema S, CXVisibilityAttr Attr,
                                            CXSourceLocation_ Loc) {
  static_cast<clang::Sema *>(S)->PushNamespaceVisibilityAttr(
      static_cast<clang::VisibilityAttr *>(Attr),
      clang::SourceLocation::getFromPtrEncoding(Loc));
}

CXCXXRecordDecl clang_Sema_getCurrentInstantiationOf(CXSema S, CXNestedNameSpecifier NNS) {
  return static_cast<clang::Sema *>(S)->getCurrentInstantiationOf(
...
CXDefaultedComparisonKind clang_Sema_getDefaultedComparisonKind(CXSema S,
                                                                CXFunctionDecl FD) {
  return static_cast<CXDefaultedComparisonKind>(
      static_cast<clang::Sema *>(S)->getDefaultedComparisonKind(
          static_cast<clang::FunctionDecl *>(FD)));
}

CXScope clang_Sema_getNonFieldDeclScope(CXSema S, CXScope Sc) {
  return static_cast<clang::Sema *>(S)->getNonFieldDeclScope(
      static_cast<clang::Scope *>(Sc));
}

CXNamespaceDecl clang_Sema_getOrCreateStdNamespace(CXSema S) {
  return static_cast<clang::Sema *>(S)->getOrCreateStdNamespace();
}

CXModule clang_Sema_getOwningModule(CXSema S, CXDecl Entity) {
  return static_cast<clang::Sema *>(S)->getOwningModule(static_cast<clang::Decl *>(Entity));
}

CXScope clang_Sema_getScopeForDeclContext(CXScope Sc, CXDeclContext DC) {
  return clang::Sema::getScopeForDeclContext(static_cast<clang::Scope *>(Sc),
                                             static_cast<clang::DeclContext *>(DC));
}

unsigned clang_Sema_getTemplateDepth(CXSema S, CXScope Sc) {
  return static_cast<clang::Sema *>(S)->getTemplateDepth(static_cast<clang::Scope *>(Sc));
}

CXModuleLoader clang_Sema_getModuleLoader(CXSema S) {
  return &static_cast<clang::Sema *>(S)->getModuleLoader();
}

CXQualType clang_Sema_getCapturedDeclRefType(CXSema S, CXValueDecl Var,
                                             CXSourceLocation_ Loc) {
  return static_cast<clang::Sema *>(S)
      ->getCapturedDeclRefType(static_cast<clang::ValueDecl *>(Var),
                               clang::SourceLocation::getFromPtrEncoding(Loc))
      .getAsOpaquePtr();
}
