...
CXIdentifierTable clang_IdentifierTable_create(CXLangOptions LO) {
  auto IT =
      std::make_unique<clang::IdentifierTable>(*reinterpret_cast<clang::LangOptions *>(LO));
  return reinterpret_cast<CXIdentifierTable>(IT.release());
}

void clang_IdentifierTable_dispose(CXIdentifierTable IT) {
  delete reinterpret_cast<clang::IdentifierTable *>(IT);
}

unsigned clang_IdentifierTable_size(CXIdentifierTable IT) {
  return reinterpret_cast<clang::IdentifierTable *>(IT)->size();
}

bool clang_IdentifierTable_contains(CXIdentifierTable IT, const char *Name) {
  auto Table = reinterpret_cast<clang::IdentifierTable *>(IT);
...
void clang_IdentifierInfo_clearBuiltinID(CXIdentifierInfo II) {
  reinterpret_cast<clang::IdentifierInfo *>(II)->clearBuiltinID();
}
...
void clang_IdentifierInfo_setFETokenInfoChangedSinceDeserialization(CXIdentifierInfo II) {
  reinterpret_cast<clang::IdentifierInfo *>(II)->setFETokenInfoChangedSinceDeserialization();
}

bool clang_IdentifierInfo_isOutOfDate(CXIdentifierInfo II) {
  return reinterpret_cast<clang::IdentifierInfo *>(II)->isOutOfDate();
}

void clang_IdentifierInfo_setOutOfDate(CXIdentifierInfo II, bool OOD) {
  reinterpret_cast<clang::IdentifierInfo *>(II)->setOutOfDate(OOD);
}

bool clang_IdentifierInfo_isModulesImport(CXIdentifierInfo II) {
  return reinterpret_cast<clang::IdentifierInfo *>(II)->isModulesImport();
}

void clang_IdentifierInfo_setModulesImport(CXIdentifierInfo II, bool I) {
  reinterpret_cast<clang::IdentifierInfo *>(II)->setModulesImport(I);
}

bool clang_IdentifierInfo_isMangledOpenMPVariantName(CXIdentifierInfo II) {
  return reinterpret_cast<clang::IdentifierInfo *>(II)->isMangledOpenMPVariantName();
}

void clang_IdentifierInfo_setMangledOpenMPVariantName(CXIdentifierInfo II, bool I) {
  reinterpret_cast<clang::IdentifierInfo *>(II)->setMangledOpenMPVariantName(I);
}

bool clang_IdentifierInfo_isEditorPlaceholder(CXIdentifierInfo II) {
  return reinterpret_cast<clang::IdentifierInfo *>(II)->isEditorPlaceholder();
}
...
CXReservedIdentifierStatus clang_IdentifierInfo_isReserved(CXIdentifierInfo II,
  ...
  return static_cast<CXReservedIdentifierStatus>(
      reinterpret_cast<clang::IdentifierInfo *>(II)->isReserved(
          *reinterpret_cast<clang::LangOptions *>(LO)));
}
...
clang_IdentifierInfo_isReservedLiteralSuffixId(CXIdentifierInfo II) {
  return static_cast<CXReservedLiteralSuffixIdStatus>(
      reinterpret_cast<clang::IdentifierInfo *>(II)->isReservedLiteralSuffixId());
}

CXString clang_IdentifierInfo_deuglifiedName(CXIdentifierInfo II) {
  return extra::makeCXString(
      reinterpret_cast<clang::IdentifierInfo *>(II)->deuglifiedName().str());
}

bool clang_IdentifierInfo_isPlaceholder(CXIdentifierInfo II) {
  return reinterpret_cast<clang::IdentifierInfo *>(II)->isPlaceholder();
}

void clang_IdentifierTable_PrintStats(CXIdentifierTable IT) {
  reinterpret_cast<clang::IdentifierTable *>(IT)->PrintStats();
}

CXIdentifierInfo clang_IdentifierTable_get(CXIdentifierTable Idents, const char *Name) {
  return reinterpret_cast<CXIdentifierInfo>(&reinterpret_cast<clang::IdentifierTable *>(Idents)->get(llvm::StringRef(Name)));
}

CXIdentifierInfo clang_IdentifierTable_getOwn(CXIdentifierTable IT, const char *Name) {
  return reinterpret_cast<CXIdentifierInfo>(&reinterpret_cast<clang::IdentifierTable *>(IT)->getOwn(llvm::StringRef(Name)));
}

const char *clang_IdentifierInfo_getName(CXIdentifierInfo II) {
  return reinterpret_cast<clang::IdentifierInfo *>(II)->getName().data();
}
...
CXSelector clang_Selector_getEmptyMarker(void) {
  return reinterpret_cast<CXSelector>(clang::Selector::getEmptyMarker().getAsOpaquePtr());
}

CXSelector clang_Selector_getTombstoneMarker(void) {
  return reinterpret_cast<CXSelector>(clang::Selector::getTombstoneMarker().getAsOpaquePtr());
}
...
CXSelector clang_SelectorTable_getUnarySelector(CXSelectorTable SelTab,
                                                CXIdentifierInfo ID) {
  return reinterpret_cast<CXSelector>(reinterpret_cast<clang::SelectorTable *>(SelTab)
      ->getUnarySelector(reinterpret_cast<clang::IdentifierInfo *>(ID))
      .getAsOpaquePtr());
}
...
CXSelector clang_SelectorTable_getNullarySelector(CXSelectorTable SelTab,
                                                  CXIdentifierInfo ID) {
  return reinterpret_cast<CXSelector>(reinterpret_cast<clang::SelectorTable *>(SelTab)
      ->getNullarySelector(reinterpret_cast<clang::IdentifierInfo *>(ID))
      .getAsOpaquePtr());
}

size_t clang_SelectorTable_getTotalMemory(CXSelectorTable SelTab) {
  return reinterpret_cast<clang::SelectorTable *>(SelTab)->getTotalMemory();
}
...
CXSelector clang_SelectorTable_constructSetterSelector(CXIdentifierTable Idents,
  ...
  return reinterpret_cast<CXSelector>(clang::SelectorTable::constructSetterSelector(
             *reinterpret_cast<clang::IdentifierTable *>(Idents),
             *reinterpret_cast<clang::SelectorTable *>(SelTab),
...
unsigned clang_IdentifierTable_getFutureCompatDiagKind(CXIdentifierTable IT,
  ...
  return reinterpret_cast<clang::IdentifierTable *>(IT)->getFutureCompatDiagKind(
