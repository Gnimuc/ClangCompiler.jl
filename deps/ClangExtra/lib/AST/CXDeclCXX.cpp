...
CXCXXMethodDecl clang_CXXRecordDecl_getLambdaCallOperator(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXMethodDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaCallOperator());
}

CXFunctionTemplateDecl
clang_CXXRecordDecl_getDependentLambdaCallOperator(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXFunctionTemplateDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getDependentLambdaCallOperator());
}

CXCXXMethodDecl clang_CXXRecordDecl_getLambdaStaticInvoker(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXMethodDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaStaticInvoker());
}
...
CXLambdaCaptureDefault clang_CXXRecordDecl_getLambdaCaptureDefault(CXCXXRecordDecl CXXRD) {
  return static_cast<CXLambdaCaptureDefault>(
      reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaCaptureDefault());
}

unsigned clang_CXXRecordDecl_getLambdaManglingNumber(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaManglingNumber();
}

unsigned clang_CXXRecordDecl_getLambdaIndexInContext(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaIndexInContext();
}

CXDecl clang_CXXRecordDecl_getLambdaContextDecl(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaContextDecl());
}

CXTypeSourceInfo clang_CXXRecordDecl_getLambdaTypeInfo(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXTypeSourceInfo>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaTypeInfo());
}

void clang_CXXRecordDecl_setLambdaTypeInfo(CXCXXRecordDecl CXXRD, CXTypeSourceInfo TS) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setLambdaTypeInfo(
      reinterpret_cast<clang::TypeSourceInfo *>(TS));
}

CXCXXDestructorDecl clang_CXXRecordDecl_getDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXDestructorDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getDestructor());
}

unsigned clang_CXXRecordDecl_getNumVisibleConversionFunctions(CXCXXRecordDecl CXXRD) {
  auto *D = reinterpret_cast<clang::CXXRecordDecl *>(CXXRD);
  unsigned N = 0;
...
void clang_CXXRecordDecl_getVisibleConversionFunctions(CXCXXRecordDecl CXXRD,
  ...
  unsigned I = 0;
  for (auto *C : D->getVisibleConversionFunctions())
    Buf[I++] = reinterpret_cast<CXNamedDecl>(C);
}

CXCXXRecordDecl clang_CXXRecordDecl_getTemplateInstantiationPattern(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getTemplateInstantiationPattern());
}
...
clang_CXXRecordDecl_getTemplateSpecializationKind(CXCXXRecordDecl CXXRD) {
  return static_cast<CXTemplateSpecializationKind>(
      reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getTemplateSpecializationKind());
}

void clang_CXXRecordDecl_setTemplateSpecializationKind(CXCXXRecordDecl CXXRD,
                                                       CXTemplateSpecializationKind TSK) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setTemplateSpecializationKind(
...
CXCXXRecordDecl clang_CXXRecordDecl_getInstantiatedFromMemberClass(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getInstantiatedFromMemberClass());
}

void clang_CXXRecordDecl_setInstantiationOfMemberClass(CXCXXRecordDecl CXXRD,
                                                       CXCXXRecordDecl RD,
                                                       CXTemplateSpecializationKind TSK) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setInstantiationOfMemberClass(
      reinterpret_cast<clang::CXXRecordDecl *>(RD),
      static_cast<clang::TemplateSpecializationKind>(TSK));
}

CXFunctionDecl clang_CXXRecordDecl_isLocalClass(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXFunctionDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isLocalClass());
}

unsigned clang_CXXRecordDecl_getODRHash(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getODRHash();
}

bool clang_CXXRecordDecl_implicitCopyConstructorHasConstParam(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->implicitCopyConstructorHasConstParam();
}

bool clang_CXXRecordDecl_implicitCopyAssignmentHasConstParam(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->implicitCopyAssignmentHasConstParam();
}

bool clang_CXXRecordDecl_lambdaIsDefaultConstructibleAndAssignable(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)
...
unsigned clang_CXXRecordDecl_getNumLambdaExplicitTemplateParameters(CXCXXRecordDecl CXXRD) {
  auto Params =
      reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaExplicitTemplateParameters();
...
CXNamedDecl clang_CXXRecordDecl_getLambdaExplicitTemplateParameter(CXCXXRecordDecl CXXRD,
                                                                   unsigned i) {
  return reinterpret_cast<CXNamedDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)
      ->getLambdaExplicitTemplateParameters()[i]);
}

unsigned clang_CXXRecordDecl_capture_size(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->capture_size();
}
...
CXLambdaCapture clang_CXXRecordDecl_getCapture(CXCXXRecordDecl CXXRD, unsigned I) {
  return reinterpret_cast<CXLambdaCapture>(const_cast<clang::LambdaCapture *>(
      reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getCapture(I)));
}
...
unsigned clang_CXXRecordDecl_getNumCaptureFields(CXCXXRecordDecl CXXRD) {
  ...
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getCaptureFields(Captures, ThisCapture);
...
void clang_CXXRecordDecl_getCaptureFields(CXCXXRecordDecl CXXRD, CXValueDecl *VarBuf,
  ...
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getCaptureFields(Captures, This);
  unsigned I = 0;
  for (const auto &Entry : Captures) {
    VarBuf[I] = reinterpret_cast<CXValueDecl>(const_cast<clang::ValueDecl *>(Entry.first));
    FieldBuf[I] = reinterpret_cast<CXFieldDecl>(Entry.second);
    ++I;
  }
  *ThisCapture = reinterpret_cast<CXFieldDecl>(This);
}

CXMemberSpecializationInfo
clang_CXXRecordDecl_getMemberSpecializationInfo(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXMemberSpecializationInfo>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getMemberSpecializationInfo());
}

CXClassTemplateDecl clang_CXXRecordDecl_getDescribedClassTemplate(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXClassTemplateDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getDescribedClassTemplate());
}

void clang_CXXRecordDecl_setDescribedClassTemplate(CXCXXRecordDecl CXXRD,
                                                   CXClassTemplateDecl Template) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setDescribedClassTemplate(
      reinterpret_cast<clang::ClassTemplateDecl *>(Template));
}

bool clang_CXXRecordDecl_isCurrentInstantiation(CXCXXRecordDecl CXXRD,
                                                CXDeclContext CurContext) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isCurrentInstantiation(
      reinterpret_cast<clang::DeclContext *>(CurContext));
}

bool clang_CXXRecordDecl_isProvablyNotDerivedFrom(CXCXXRecordDecl CXXRD,
                                                  CXCXXRecordDecl Base) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isProvablyNotDerivedFrom(
      reinterpret_cast<clang::CXXRecordDecl *>(Base));
}

unsigned clang_CXXRecordDecl_getNumIndirectPrimaryBases(CXCXXRecordDecl CXXRD) {
  clang::CXXIndirectPrimaryBaseSet Bases;
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getIndirectPrimaryBases(Bases);
...
void clang_CXXRecordDecl_getIndirectPrimaryBases(CXCXXRecordDecl CXXRD,
  ...
  for (const clang::CXXRecordDecl *RD : Bases)
    Buf[I++] = reinterpret_cast<CXCXXRecordDecl>(const_cast<clang::CXXRecordDecl *>(RD));
}

bool clang_CXXRecordDecl_hasMemberName(CXCXXRecordDecl CXXRD, CXDeclarationName N) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasMemberName(
...
void clang_CXXRecordDecl_lookupDependentName(CXCXXRecordDecl CXXRD, CXDeclarationName Name,
  ...
  std::vector<const clang::NamedDecl *> Results =
      reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->lookupDependentName(
          clang::DeclarationName::getFromOpaquePtr(Name),
          [](const clang::NamedDecl *) { return true; });
  unsigned I = 0;
  for (const clang::NamedDecl *ND : Results)
    Buf[I++] = reinterpret_cast<CXNamedDecl>(const_cast<clang::NamedDecl *>(ND));
}
...
unsigned clang_CXXRecordDecl_getDeviceLambdaManglingNumber(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getDeviceLambdaManglingNumber();
}
...
CXLambdaDependencyKind clang_CXXRecordDecl_getLambdaDependencyKind(CXCXXRecordDecl CXXRD) {
  return static_cast<CXLambdaDependencyKind>(
      reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getLambdaDependencyKind());
}
...
CXNamedDecl clang_CXXRecordDecl_getConversion(CXCXXRecordDecl CXXRD, unsigned i) {
  auto *D = reinterpret_cast<clang::CXXRecordDecl *>(CXXRD);
  return reinterpret_cast<CXNamedDecl>(*(D->conversion_begin() + i));
}

void clang_CXXRecordDecl_setImplicitCopyConstructorIsDeleted(CXCXXRecordDecl CXXRD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setImplicitCopyConstructorIsDeleted();
}

void clang_CXXRecordDecl_setImplicitMoveConstructorIsDeleted(CXCXXRecordDecl CXXRD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setImplicitMoveConstructorIsDeleted();
}

void clang_CXXRecordDecl_setImplicitDestructorIsDeleted(CXCXXRecordDecl CXXRD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setImplicitDestructorIsDeleted();
}

void clang_CXXRecordDecl_setImplicitCopyAssignmentIsDeleted(CXCXXRecordDecl CXXRD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setImplicitCopyAssignmentIsDeleted();
}

void clang_CXXRecordDecl_setImplicitMoveAssignmentIsDeleted(CXCXXRecordDecl CXXRD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setImplicitMoveAssignmentIsDeleted();
}

void clang_CXXRecordDecl_removeConversion(CXCXXRecordDecl CXXRD, CXNamedDecl Old) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->removeConversion(
      reinterpret_cast<clang::NamedDecl *>(Old));
}
...
void clang_CXXRecordDecl_setHasTrivialSpecialMemberForCall(CXCXXRecordDecl CXXRD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setHasTrivialSpecialMemberForCall();
}

void clang_CXXRecordDecl_finishedDefaultedOrDeletedMember(CXCXXRecordDecl CXXRD,
                                                          CXCXXMethodDecl MD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->finishedDefaultedOrDeletedMember(
...
void clang_CXXRecordDecl_setTrivialForCallFlags(CXCXXRecordDecl CXXRD, CXCXXMethodDecl MD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setTrivialForCallFlags(
      reinterpret_cast<clang::CXXMethodDecl *>(MD));
}
...
void clang_CXXRecordDecl_setLambdaNumbering(CXCXXRecordDecl CXXRD, CXDecl ContextDecl,
  ...
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setLambdaNumbering(
      {reinterpret_cast<clang::Decl *>(ContextDecl), IndexInContext, ManglingNumber,
...
void clang_CXXRecordDecl_setLambdaIsGeneric(CXCXXRecordDecl CXXRD, bool IsGeneric) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setLambdaIsGeneric(IsGeneric);
}

void clang_CXXRecordDecl_markAbstract(CXCXXRecordDecl CXXRD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->markAbstract();
}
...
CXAccessSpecDecl clang_AccessSpecDecl_Create(CXASTContext C, CXAccessSpecifier AS,
  ...
  return reinterpret_cast<CXAccessSpecDecl>(clang::AccessSpecDecl::Create(*reinterpret_cast<clang::ASTContext *>(C),
...
CXAccessSpecDecl clang_AccessSpecDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXAccessSpecDecl>(clang::AccessSpecDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// CXXBaseSpecifier
CXSourceRange_ clang_CXXBaseSpecifier_getSourceRange(CXCXXBaseSpecifier CXXBS) {
  auto rng = reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getSourceRange();
  CXSourceLocation_ B = reinterpret_cast<CXSourceLocation_>(rng.getBegin().getPtrEncoding());
  CXSourceLocation_ E = reinterpret_cast<CXSourceLocation_>(rng.getEnd().getPtrEncoding());
  return CXSourceRange_{B, E};
}
...
CXSourceLocation_ clang_CXXBaseSpecifier_getBeginLoc(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getBeginLoc().getPtrEncoding());
}

CXSourceLocation_ clang_CXXBaseSpecifier_getEndLoc(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getEndLoc().getPtrEncoding());
}

CXSourceLocation_ clang_CXXBaseSpecifier_getBaseTypeLoc(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getBaseTypeLoc().getPtrEncoding());
}

bool clang_CXXBaseSpecifier_isVirtual(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->isVirtual();
}

bool clang_CXXBaseSpecifier_isBaseOfClass(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->isBaseOfClass();
}

bool clang_CXXBaseSpecifier_isPackExpansion(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->isPackExpansion();
}

bool clang_CXXBaseSpecifier_getInheritConstructors(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getInheritConstructors();
}

void clang_CXXBaseSpecifier_setInheritConstructors(CXCXXBaseSpecifier CXXBS, bool Inherit) {
  reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->setInheritConstructors(Inherit);
}

CXSourceLocation_ clang_CXXBaseSpecifier_getEllipsisLoc(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getEllipsisLoc().getPtrEncoding());
}

CXAccessSpecifier clang_CXXBaseSpecifier_getAccessSpecifier(CXCXXBaseSpecifier CXXBS) {
  return static_cast<CXAccessSpecifier>(
      reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getAccessSpecifier());
}

CXAccessSpecifier
clang_CXXBaseSpecifier_getAccessSpecifierAsWritten(CXCXXBaseSpecifier CXXBS) {
  return static_cast<CXAccessSpecifier>(
      reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getAccessSpecifierAsWritten());
}

CXQualType clang_CXXBaseSpecifier_getType(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getType().getAsOpaquePtr());
}

CXTypeSourceInfo clang_CXXBaseSpecifier_getTypeSourceInfo(CXCXXBaseSpecifier CXXBS) {
  return reinterpret_cast<CXTypeSourceInfo>(reinterpret_cast<clang::CXXBaseSpecifier *>(CXXBS)->getTypeSourceInfo());
}

// CXXRecordDecl
CXCXXRecordDecl clang_CXXRecordDecl_getCanonicalDecl(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getCanonicalDecl());
}

CXCXXRecordDecl clang_CXXRecordDecl_getPreviousDecl(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getPreviousDecl());
}

CXCXXRecordDecl clang_CXXRecordDecl_getMostRecentDecl(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getMostRecentDecl());
}

CXCXXRecordDecl clang_CXXRecordDecl_getMostRecentNonInjectedDecl(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getMostRecentNonInjectedDecl());
}

CXCXXRecordDecl clang_CXXRecordDecl_getDefinition(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getDefinition());
}

bool clang_CXXRecordDecl_hasDefinition(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasDefinition();
}
...
CXCXXRecordDecl clang_CXXRecordDecl_Create(CXASTContext C, CXTagTypeKind TK,
  ...
  return reinterpret_cast<CXCXXRecordDecl>(clang::CXXRecordDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), static_cast<clang::TagTypeKind>(TK),
      ...
      reinterpret_cast<clang::CXXRecordDecl *>(PrevDecl), DelayTypeCreation));
}
...
CXCXXRecordDecl clang_CXXRecordDecl_CreateLambda(CXASTContext C, CXDeclContext DC,
  ...
  return reinterpret_cast<CXCXXRecordDecl>(clang::CXXRecordDecl::CreateLambda(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      reinterpret_cast<clang::TypeSourceInfo *>(Info),
...
bool clang_CXXRecordDecl_isDynamicClass(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isDynamicClass();
}

bool clang_CXXRecordDecl_isLambda(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isLambda();
}

bool clang_CXXRecordDecl_isGenericLambda(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isGenericLambda();
}

CXTemplateParameterList
clang_CXXRecordDecl_getGenericLambdaTemplateParameterList(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<CXTemplateParameterList>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)
      ->getGenericLambdaTemplateParameterList());
}

bool clang_CXXRecordDecl_isAggregate(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isAggregate();
}

bool clang_CXXRecordDecl_isPOD(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isPOD();
}

bool clang_CXXRecordDecl_isCLike(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isCLike();
}

bool clang_CXXRecordDecl_isEmpty(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isEmpty();
}

bool clang_CXXRecordDecl_allowConstDefaultInit(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->allowConstDefaultInit();
}

bool clang_CXXRecordDecl_defaultedCopyConstructorIsDeleted(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->defaultedCopyConstructorIsDeleted();
}

bool clang_CXXRecordDecl_defaultedDefaultConstructorIsConstexpr(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->defaultedDefaultConstructorIsConstexpr();
}

bool clang_CXXRecordDecl_defaultedDestructorIsConstexpr(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->defaultedDestructorIsConstexpr();
}

bool clang_CXXRecordDecl_defaultedDestructorIsDeleted(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->defaultedDestructorIsDeleted();
}

bool clang_CXXRecordDecl_defaultedMoveConstructorIsDeleted(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->defaultedMoveConstructorIsDeleted();
}

bool clang_CXXRecordDecl_hasAnyDependentBases(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasAnyDependentBases();
}

bool clang_CXXRecordDecl_hasConstexprDefaultConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasConstexprDefaultConstructor();
}

bool clang_CXXRecordDecl_hasConstexprDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasConstexprDestructor();
}

bool clang_CXXRecordDecl_hasConstexprNonCopyMoveConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasConstexprNonCopyMoveConstructor();
}

bool clang_CXXRecordDecl_hasCopyAssignmentWithConstParam(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasCopyAssignmentWithConstParam();
}

bool clang_CXXRecordDecl_hasCopyConstructorWithConstParam(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasCopyConstructorWithConstParam();
}

bool clang_CXXRecordDecl_hasDefaultConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasDefaultConstructor();
}

bool clang_CXXRecordDecl_hasDirectFields(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasDirectFields();
}

bool clang_CXXRecordDecl_hasFriends(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasFriends();
}

bool clang_CXXRecordDecl_hasInClassInitializer(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasInClassInitializer();
}

bool clang_CXXRecordDecl_hasInheritedAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasInheritedAssignment();
}

bool clang_CXXRecordDecl_hasInheritedConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasInheritedConstructor();
}

bool clang_CXXRecordDecl_hasInitMethod(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasInitMethod();
}

void clang_CXXRecordDecl_setInitMethod(CXCXXRecordDecl CXXRD, bool Val) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setInitMethod(Val);
}

bool clang_CXXRecordDecl_hasIrrelevantDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasIrrelevantDestructor();
}

bool clang_CXXRecordDecl_hasKnownLambdaInternalLinkage(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasKnownLambdaInternalLinkage();
}

bool clang_CXXRecordDecl_hasMoveAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasMoveAssignment();
}

bool clang_CXXRecordDecl_hasMoveConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasMoveConstructor();
}

bool clang_CXXRecordDecl_hasMutableFields(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasMutableFields();
}

bool clang_CXXRecordDecl_hasNonLiteralTypeFieldsOrBases(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonLiteralTypeFieldsOrBases();
}

bool clang_CXXRecordDecl_hasNonTrivialCopyAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialCopyAssignment();
}

bool clang_CXXRecordDecl_hasNonTrivialCopyConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialCopyConstructor();
}

bool clang_CXXRecordDecl_hasNonTrivialCopyConstructorForCall(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialCopyConstructorForCall();
}

bool clang_CXXRecordDecl_hasNonTrivialDefaultConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialDefaultConstructor();
}

bool clang_CXXRecordDecl_hasNonTrivialDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialDestructor();
}

bool clang_CXXRecordDecl_hasNonTrivialDestructorForCall(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialDestructorForCall();
}

bool clang_CXXRecordDecl_hasNonTrivialMoveAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialMoveAssignment();
}

bool clang_CXXRecordDecl_hasNonTrivialMoveConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialMoveConstructor();
}

bool clang_CXXRecordDecl_hasNonTrivialMoveConstructorForCall(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasNonTrivialMoveConstructorForCall();
}

bool clang_CXXRecordDecl_hasPrivateFields(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasPrivateFields();
}

bool clang_CXXRecordDecl_hasProtectedFields(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasProtectedFields();
}

bool clang_CXXRecordDecl_hasSimpleCopyAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasSimpleCopyAssignment();
}

bool clang_CXXRecordDecl_hasSimpleCopyConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasSimpleCopyConstructor();
}

bool clang_CXXRecordDecl_hasSimpleDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasSimpleDestructor();
}

bool clang_CXXRecordDecl_hasSimpleMoveAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasSimpleMoveAssignment();
}

bool clang_CXXRecordDecl_hasSimpleMoveConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasSimpleMoveConstructor();
}

bool clang_CXXRecordDecl_hasTrivialCopyAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialCopyAssignment();
}

bool clang_CXXRecordDecl_hasTrivialCopyConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialCopyConstructor();
}

bool clang_CXXRecordDecl_hasTrivialCopyConstructorForCall(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialCopyConstructorForCall();
}

bool clang_CXXRecordDecl_hasTrivialDefaultConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialDefaultConstructor();
}

bool clang_CXXRecordDecl_hasTrivialDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialDestructor();
}

bool clang_CXXRecordDecl_hasTrivialDestructorForCall(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialDestructorForCall();
}

bool clang_CXXRecordDecl_hasTrivialMoveAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialMoveAssignment();
}

bool clang_CXXRecordDecl_hasTrivialMoveConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialMoveConstructor();
}

bool clang_CXXRecordDecl_hasTrivialMoveConstructorForCall(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasTrivialMoveConstructorForCall();
}

bool clang_CXXRecordDecl_hasUninitializedReferenceMember(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUninitializedReferenceMember();
}

bool clang_CXXRecordDecl_hasUserDeclaredConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUserDeclaredConstructor();
}

bool clang_CXXRecordDecl_hasUserDeclaredCopyAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUserDeclaredCopyAssignment();
}

bool clang_CXXRecordDecl_hasUserDeclaredCopyConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUserDeclaredCopyConstructor();
}

bool clang_CXXRecordDecl_hasUserDeclaredDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUserDeclaredDestructor();
}

bool clang_CXXRecordDecl_hasUserDeclaredMoveAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUserDeclaredMoveAssignment();
}

bool clang_CXXRecordDecl_hasUserDeclaredMoveConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUserDeclaredMoveConstructor();
}

bool clang_CXXRecordDecl_hasUserDeclaredMoveOperation(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUserDeclaredMoveOperation();
}

bool clang_CXXRecordDecl_hasUserProvidedDefaultConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasUserProvidedDefaultConstructor();
}

bool clang_CXXRecordDecl_hasVariantMembers(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->hasVariantMembers();
}

bool clang_CXXRecordDecl_isAbstract(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isAbstract();
}

bool clang_CXXRecordDecl_isAnyDestructorNoReturn(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isAnyDestructorNoReturn();
}

bool clang_CXXRecordDecl_isCXX11StandardLayout(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isCXX11StandardLayout();
}

bool clang_CXXRecordDecl_isCapturelessLambda(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isCapturelessLambda();
}

bool clang_CXXRecordDecl_isDependentLambda(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isDependentLambda();
}

bool clang_CXXRecordDecl_isDerivedFrom(CXCXXRecordDecl CXXRD, CXCXXRecordDecl Base) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isDerivedFrom(
      reinterpret_cast<clang::CXXRecordDecl *>(Base));
}

bool clang_CXXRecordDecl_isEffectivelyFinal(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isEffectivelyFinal();
}

bool clang_CXXRecordDecl_isInterfaceLike(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isInterfaceLike();
}

bool clang_CXXRecordDecl_isLiteral(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isLiteral();
}

bool clang_CXXRecordDecl_isNeverDependentLambda(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isNeverDependentLambda();
}

bool clang_CXXRecordDecl_isParsingBaseSpecifiers(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isParsingBaseSpecifiers();
}

void clang_CXXRecordDecl_setIsParsingBaseSpecifiers(CXCXXRecordDecl CXXRD) {
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->setIsParsingBaseSpecifiers();
}

bool clang_CXXRecordDecl_isPolymorphic(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isPolymorphic();
}

bool clang_CXXRecordDecl_isStandardLayout(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isStandardLayout();
}

bool clang_CXXRecordDecl_isStructural(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isStructural();
}

bool clang_CXXRecordDecl_isTrivial(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isTrivial();
}

bool clang_CXXRecordDecl_isTriviallyCopyConstructible(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isTriviallyCopyConstructible();
}

bool clang_CXXRecordDecl_isTriviallyCopyable(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isTriviallyCopyable();
}

bool clang_CXXRecordDecl_isVirtuallyDerivedFrom(CXCXXRecordDecl CXXRD,
                                                CXCXXRecordDecl Base) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->isVirtuallyDerivedFrom(
      reinterpret_cast<clang::CXXRecordDecl *>(Base));
}

bool clang_CXXRecordDecl_mayBeAbstract(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->mayBeAbstract();
}

bool clang_CXXRecordDecl_mayBeDynamicClass(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->mayBeDynamicClass();
}

bool clang_CXXRecordDecl_mayBeNonDynamicClass(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->mayBeNonDynamicClass();
}

bool clang_CXXRecordDecl_needsImplicitCopyAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsImplicitCopyAssignment();
}

bool clang_CXXRecordDecl_needsImplicitCopyConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsImplicitCopyConstructor();
}

bool clang_CXXRecordDecl_needsImplicitDefaultConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsImplicitDefaultConstructor();
}

bool clang_CXXRecordDecl_needsImplicitDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsImplicitDestructor();
}

bool clang_CXXRecordDecl_needsImplicitMoveAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsImplicitMoveAssignment();
}

bool clang_CXXRecordDecl_needsImplicitMoveConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsImplicitMoveConstructor();
}

bool clang_CXXRecordDecl_needsOverloadResolutionForCopyAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsOverloadResolutionForCopyAssignment();
}

bool clang_CXXRecordDecl_needsOverloadResolutionForCopyConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsOverloadResolutionForCopyConstructor();
}

bool clang_CXXRecordDecl_needsOverloadResolutionForDestructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsOverloadResolutionForDestructor();
}

bool clang_CXXRecordDecl_needsOverloadResolutionForMoveAssignment(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsOverloadResolutionForMoveAssignment();
}

bool clang_CXXRecordDecl_needsOverloadResolutionForMoveConstructor(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->needsOverloadResolutionForMoveConstructor();
}

unsigned clang_CXXRecordDecl_getNumBases(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getNumBases();
}

CXCXXBaseSpecifier clang_CXXRecordDecl_getBase(CXCXXRecordDecl CXXRD, unsigned i) {
  return reinterpret_cast<CXCXXBaseSpecifier>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->bases_begin() + i);
}

unsigned clang_CXXRecordDecl_getNumVBases(CXCXXRecordDecl CXXRD) {
  return reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getNumVBases();
}

CXCXXBaseSpecifier clang_CXXRecordDecl_getVBase(CXCXXRecordDecl CXXRD, unsigned i) {
  return reinterpret_cast<CXCXXBaseSpecifier>(reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->vbases_begin() + i);
}
...
void clang_CXXRecordDecl_getMethods(CXCXXRecordDecl CXXRD, CXCXXMethodDecl *Buf) {
  ...
  unsigned I = 0;
  for (auto *M : D->methods())
    Buf[I++] = reinterpret_cast<CXCXXMethodDecl>(M);
}
...
void clang_CXXRecordDecl_getCtors(CXCXXRecordDecl CXXRD, CXCXXConstructorDecl *Buf) {
  ...
  unsigned I = 0;
  for (auto *C : D->ctors())
    Buf[I++] = reinterpret_cast<CXCXXConstructorDecl>(C);
}
...
void clang_CXXRecordDecl_getFriends(CXCXXRecordDecl CXXRD, CXDecl *Buf) {
  ...
  unsigned I = 0;
  for (auto *F : D->friends())
    Buf[I++] = reinterpret_cast<CXDecl>(F);
}

// ExplicitSpecifier
CXExplicitSpecKind clang_ExplicitSpecifier_getKind(CXExplicitSpecifier ES) {
  return static_cast<CXExplicitSpecKind>(
      reinterpret_cast<clang::ExplicitSpecifier *>(ES)->getKind());
}

CXExpr clang_ExplicitSpecifier_getExpr(CXExplicitSpecifier ES) {
  return reinterpret_cast<CXExpr>(reinterpret_cast<clang::ExplicitSpecifier *>(ES)->getExpr());
}

bool clang_ExplicitSpecifier_isSpecified(CXExplicitSpecifier ES) {
  return reinterpret_cast<clang::ExplicitSpecifier *>(ES)->isSpecified();
}

bool clang_ExplicitSpecifier_isEquivalent(CXExplicitSpecifier ES,
                                          CXExplicitSpecifier Other) {
  return reinterpret_cast<clang::ExplicitSpecifier *>(ES)->isEquivalent(
      *reinterpret_cast<clang::ExplicitSpecifier *>(Other));
}

bool clang_ExplicitSpecifier_isExplicit(CXExplicitSpecifier ES) {
  return reinterpret_cast<clang::ExplicitSpecifier *>(ES)->isExplicit();
}

bool clang_ExplicitSpecifier_isInvalid(CXExplicitSpecifier ES) {
  return reinterpret_cast<clang::ExplicitSpecifier *>(ES)->isInvalid();
}

void clang_ExplicitSpecifier_setKind(CXExplicitSpecifier ES, CXExplicitSpecKind Kind) {
  reinterpret_cast<clang::ExplicitSpecifier *>(ES)->setKind(
      static_cast<clang::ExplicitSpecKind>(Kind));
}

void clang_ExplicitSpecifier_setExpr(CXExplicitSpecifier ES, CXExpr E) {
  reinterpret_cast<clang::ExplicitSpecifier *>(ES)->setExpr(reinterpret_cast<clang::Expr *>(E));
}

// getFromDecl
// Invalid
CXExplicitSpecifier clang_ExplicitSpecifier_getFromDecl(CXFunctionDecl FD) {
  auto ES = clang::ExplicitSpecifier::getFromDecl(reinterpret_cast<clang::FunctionDecl *>(FD));
  return reinterpret_cast<CXExplicitSpecifier>(std::make_unique<clang::ExplicitSpecifier>(ES).release());
}
...
void clang_ExplicitSpecifier_dispose(CXExplicitSpecifier ES) {
  delete reinterpret_cast<clang::ExplicitSpecifier *>(ES);
}

// CXXDeductionGuideDecl
bool clang_CXXDeductionGuideDecl_isExplicit(CXCXXDeductionGuideDecl DGD) {
  return reinterpret_cast<clang::CXXDeductionGuideDecl *>(DGD)->isExplicit();
}

CXExplicitSpecifier
clang_CXXDeductionGuideDecl_getExplicitSpecifier(CXCXXDeductionGuideDecl DGD) {
  auto ES = reinterpret_cast<clang::CXXDeductionGuideDecl *>(DGD)->getExplicitSpecifier();
  return reinterpret_cast<CXExplicitSpecifier>(std::make_unique<clang::ExplicitSpecifier>(ES).release());
}

CXCXXConstructorDecl
clang_CXXDeductionGuideDecl_getCorrespondingConstructor(CXCXXDeductionGuideDecl DGD) {
  return reinterpret_cast<CXCXXConstructorDecl>(reinterpret_cast<clang::CXXDeductionGuideDecl *>(DGD)->getCorrespondingConstructor());
}

CXTemplateDecl
clang_CXXDeductionGuideDecl_getDeducedTemplate(CXCXXDeductionGuideDecl DGD) {
  return reinterpret_cast<CXTemplateDecl>(reinterpret_cast<clang::CXXDeductionGuideDecl *>(DGD)->getDeducedTemplate());
}
...
clang_CXXDeductionGuideDecl_getDeductionCandidateKind(CXCXXDeductionGuideDecl DGD) {
  return static_cast<CXDeductionCandidate>(
      reinterpret_cast<clang::CXXDeductionGuideDecl *>(DGD)->getDeductionCandidateKind());
}

void clang_CXXDeductionGuideDecl_setDeductionCandidateKind(CXCXXDeductionGuideDecl DGD,
                                                           CXDeductionCandidate K) {
  reinterpret_cast<clang::CXXDeductionGuideDecl *>(DGD)->setDeductionCandidateKind(
...
CXCXXDeductionGuideDecl clang_CXXDeductionGuideDecl_Create(
  ...
  return reinterpret_cast<CXCXXDeductionGuideDecl>(clang::CXXDeductionGuideDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
      *reinterpret_cast<clang::ExplicitSpecifier *>(ES),
      *reinterpret_cast<clang::DeclarationNameInfo *>(NameInfo),
      clang::QualType::getFromOpaquePtr(T), reinterpret_cast<clang::TypeSourceInfo *>(TInfo),
      clang::SourceLocation::getFromPtrEncoding(EndLocation),
      reinterpret_cast<clang::CXXConstructorDecl *>(Ctor),
...
CXCXXDeductionGuideDecl clang_CXXDeductionGuideDecl_CreateDeserialized(CXASTContext C,
                                                                       unsigned ID) {
  return reinterpret_cast<CXCXXDeductionGuideDecl>(clang::CXXDeductionGuideDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// RequiresExprBodyDecl
CXRequiresExprBodyDecl clang_RequiresExprBodyDecl_Create(CXASTContext C, CXDeclContext DC,
                                                         CXSourceLocation_ StartLoc) {
  return reinterpret_cast<CXRequiresExprBodyDecl>(clang::RequiresExprBodyDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(StartLoc)));
}
...
CXRequiresExprBodyDecl clang_RequiresExprBodyDecl_CreateDeserialized(CXASTContext C,
                                                                     unsigned ID) {
  return reinterpret_cast<CXRequiresExprBodyDecl>(clang::RequiresExprBodyDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// RequiresExprBodyDecl Cast
CXDeclContext clang_RequiresExprBodyDecl_castToDeclContext(CXRequiresExprBodyDecl REBD) {
  return reinterpret_cast<CXDeclContext>(clang::RequiresExprBodyDecl::castToDeclContext(
      reinterpret_cast<clang::RequiresExprBodyDecl *>(REBD)));
}

CXRequiresExprBodyDecl clang_RequiresExprBodyDecl_castFromDeclContext(CXDeclContext DC) {
  return reinterpret_cast<CXRequiresExprBodyDecl>(clang::RequiresExprBodyDecl::castFromDeclContext(
      reinterpret_cast<clang::DeclContext *>(DC)));
}
...
clang_CXXMethodDecl_Create(CXASTContext C, CXCXXRecordDecl RD, CXSourceLocation_ StartLoc,
  ...
  return reinterpret_cast<CXCXXMethodDecl>(clang::CXXMethodDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::CXXRecordDecl *>(RD),
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
      *reinterpret_cast<clang::DeclarationNameInfo *>(NameInfo),
      clang::QualType::getFromOpaquePtr(T), reinterpret_cast<clang::TypeSourceInfo *>(TInfo),
...
CXCXXMethodDecl clang_CXXMethodDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXCXXMethodDecl>(clang::CXXMethodDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

bool clang_CXXMethodDecl_isStatic(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isStatic();
}

bool clang_CXXMethodDecl_isInstance(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isInstance();
}
...
bool clang_CXXMethodDecl_isConst(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isConst();
}

bool clang_CXXMethodDecl_isVolatile(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isVolatile();
}

bool clang_CXXMethodDecl_isVirtual(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isVirtual();
}

CXCXXMethodDecl clang_CXXMethodDecl_getDevirtualizedMethod(CXCXXMethodDecl CXXMD,
                                                           CXExpr Base, bool IsAppleKext) {
  return reinterpret_cast<CXCXXMethodDecl>(reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getDevirtualizedMethod(
      reinterpret_cast<clang::Expr *>(Base), IsAppleKext));
}
...
bool clang_CXXMethodDecl_isUsualDeallocationFunction(CXCXXMethodDecl CXXMD) {
  ...
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isUsualDeallocationFunction(
      PreventedBy);
}

bool clang_CXXMethodDecl_isCopyAssignmentOperator(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isCopyAssignmentOperator();
}

bool clang_CXXMethodDecl_isMoveAssignmentOperator(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isMoveAssignmentOperator();
}

CXCXXMethodDecl clang_CXXMethodDecl_getCanonicalDecl(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<CXCXXMethodDecl>(reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getCanonicalDecl());
}

CXCXXMethodDecl clang_CXXMethodDecl_getMostRecentDecl(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<CXCXXMethodDecl>(reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getMostRecentDecl());
}

void clang_CXXMethodDecl_addOverriddenMethod(CXCXXMethodDecl CXXMD, CXCXXMethodDecl MD) {
  reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->addOverriddenMethod(
      reinterpret_cast<clang::CXXMethodDecl *>(MD));
}

CXCXXRecordDecl clang_CXXMethodDecl_getParent(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getParent());
}

CXQualType clang_CXXMethodDecl_getThisType(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getThisType().getAsOpaquePtr());
}

CXQualType
clang_CXXMethodDecl_getFunctionObjectParameterReferenceType(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)
...
unsigned clang_CXXMethodDecl_getMethodQualifiers(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)
      ->getMethodQualifiers()
      .getAsOpaqueValue();
}
...
CXRefQualifierKind clang_CXXMethodDecl_getRefQualifier(CXCXXMethodDecl CXXMD) {
  return static_cast<CXRefQualifierKind>(
      reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getRefQualifier());
}

bool clang_CXXMethodDecl_hasInlineBody(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->hasInlineBody();
}

bool clang_CXXMethodDecl_isLambdaStaticInvoker(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isLambdaStaticInvoker();
}

CXCXXMethodDecl clang_CXXMethodDecl_getCorrespondingMethodInClass(CXCXXMethodDecl CXXMD,
                                                                  CXCXXRecordDecl RD,
                                                                  bool MayBeBase) {
  return reinterpret_cast<CXCXXMethodDecl>(reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getCorrespondingMethodInClass(
      reinterpret_cast<clang::CXXRecordDecl *>(RD), MayBeBase));
}
...
CXCXXMethodDecl clang_CXXMethodDecl_getCorrespondingMethodDeclaredInClass(
  ...
  return reinterpret_cast<CXCXXMethodDecl>(reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getCorrespondingMethodDeclaredInClass(
      reinterpret_cast<clang::CXXRecordDecl *>(RD), MayBeBase));
}

bool clang_CXXMethodDecl_isExplicitObjectMemberFunction(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isExplicitObjectMemberFunction();
}

bool clang_CXXMethodDecl_isImplicitObjectMemberFunction(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->isImplicitObjectMemberFunction();
}

unsigned clang_CXXMethodDecl_size_overridden_methods(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->size_overridden_methods();
}

void clang_CXXMethodDecl_getOverriddenMethods(CXCXXMethodDecl CXXMD, CXCXXMethodDecl *Buf) {
  auto *D = reinterpret_cast<clang::CXXMethodDecl *>(CXXMD);
  unsigned I = 0;
  for (auto It = D->begin_overridden_methods(), E = D->end_overridden_methods(); It != E;
       ++It)
    Buf[I++] = reinterpret_cast<CXCXXMethodDecl>(const_cast<clang::CXXMethodDecl *>(*It));
}

unsigned clang_CXXMethodDecl_getNumExplicitParams(CXCXXMethodDecl CXXMD) {
  return reinterpret_cast<clang::CXXMethodDecl *>(CXXMD)->getNumExplicitParams();
}
...
int64_t clang_CXXCtorInitializer_getID(CXCXXCtorInitializer CI, CXASTContext C) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getID(
      *reinterpret_cast<clang::ASTContext *>(C));
}
bool clang_CXXCtorInitializer_isBaseInitializer(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isBaseInitializer();
}

bool clang_CXXCtorInitializer_isMemberInitializer(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isMemberInitializer();
}

bool clang_CXXCtorInitializer_isAnyMemberInitializer(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isAnyMemberInitializer();
}

bool clang_CXXCtorInitializer_isDelegatingInitializer(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isDelegatingInitializer();
}

CXFieldDecl clang_CXXCtorInitializer_getMember(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXFieldDecl>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getMember());
}
...
CXType_ clang_CXXCtorInitializer_getBaseClass(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXType_>(const_cast<clang::Type *>(
      reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getBaseClass()));
}

CXExpr clang_CXXCtorInitializer_getInit(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXExpr>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getInit());
}

CXSourceLocation_ clang_CXXCtorInitializer_getSourceLocation(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getSourceLocation().getPtrEncoding());
}

bool clang_CXXCtorInitializer_isIndirectMemberInitializer(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isIndirectMemberInitializer();
}

bool clang_CXXCtorInitializer_isInClassMemberInitializer(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isInClassMemberInitializer();
}

bool clang_CXXCtorInitializer_isPackExpansion(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isPackExpansion();
}

CXSourceLocation_ clang_CXXCtorInitializer_getEllipsisLoc(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getEllipsisLoc().getPtrEncoding());
}
...
CXTypeLoc clang_CXXCtorInitializer_getBaseClassLoc(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXTypeLoc>(new clang::TypeLoc( // NOLINT(*-owning-memory)
      reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getBaseClassLoc()));
}

bool clang_CXXCtorInitializer_isBaseVirtual(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isBaseVirtual();
}

CXTypeSourceInfo clang_CXXCtorInitializer_getTypeSourceInfo(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXTypeSourceInfo>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getTypeSourceInfo());
}

CXFieldDecl clang_CXXCtorInitializer_getAnyMember(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXFieldDecl>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getAnyMember());
}

CXIndirectFieldDecl clang_CXXCtorInitializer_getIndirectMember(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXIndirectFieldDecl>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getIndirectMember());
}

CXSourceLocation_ clang_CXXCtorInitializer_getMemberLocation(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getMemberLocation().getPtrEncoding());
}

CXSourceRange_ clang_CXXCtorInitializer_getSourceRange(CXCXXCtorInitializer CI) {
  auto rng = reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getSourceRange();
  CXSourceLocation_ B = reinterpret_cast<CXSourceLocation_>(rng.getBegin().getPtrEncoding());
  CXSourceLocation_ E = reinterpret_cast<CXSourceLocation_>(rng.getEnd().getPtrEncoding());
  return CXSourceRange_{B, E};
}
...
bool clang_CXXCtorInitializer_isWritten(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->isWritten();
}

int clang_CXXCtorInitializer_getSourceOrder(CXCXXCtorInitializer CI) {
  return reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getSourceOrder();
}

void clang_CXXCtorInitializer_setSourceOrder(CXCXXCtorInitializer CI, int Pos) {
  reinterpret_cast<clang::CXXCtorInitializer *>(CI)->setSourceOrder(Pos);
}

CXSourceLocation_ clang_CXXCtorInitializer_getLParenLoc(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getLParenLoc().getPtrEncoding());
}

CXSourceLocation_ clang_CXXCtorInitializer_getRParenLoc(CXCXXCtorInitializer CI) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::CXXCtorInitializer *>(CI)->getRParenLoc().getPtrEncoding());
}
...
clang_CXXConstructorDecl_getInheritedConstructorBaseCtor(CXCXXConstructorDecl CD) {
  return reinterpret_cast<CXCXXConstructorDecl>(reinterpret_cast<clang::CXXConstructorDecl *>(CD)
      ->getInheritedConstructor()
      .getConstructor());
}

unsigned clang_CXXConstructorDecl_getNumCtorInitializers(CXCXXConstructorDecl CD) {
  return reinterpret_cast<clang::CXXConstructorDecl *>(CD)->getNumCtorInitializers();
}

CXCXXCtorInitializer
clang_CXXConstructorDecl_getCtorInitializer(CXCXXConstructorDecl CD, unsigned i) {
  return reinterpret_cast<CXCXXCtorInitializer>(reinterpret_cast<clang::CXXConstructorDecl *>(CD)->init_begin()[i]);
}

CXCXXConstructorDecl clang_CXXConstructorDecl_getTargetConstructor(CXCXXConstructorDecl CD) {
  return reinterpret_cast<CXCXXConstructorDecl>(reinterpret_cast<clang::CXXConstructorDecl *>(CD)->getTargetConstructor());
}

bool clang_CXXConstructorDecl_isConvertingConstructor(CXCXXConstructorDecl CD,
                                                      bool AllowExplicit) {
  return reinterpret_cast<clang::CXXConstructorDecl *>(CD)->isConvertingConstructor(
      AllowExplicit);
}

CXCXXConstructorDecl clang_CXXConstructorDecl_getCanonicalDecl(CXCXXConstructorDecl CD) {
  return reinterpret_cast<CXCXXConstructorDecl>(reinterpret_cast<clang::CXXConstructorDecl *>(CD)->getCanonicalDecl());
}
...
CXCXXConstructorDecl clang_CXXConstructorDecl_Create(
  ...
  return reinterpret_cast<CXCXXConstructorDecl>(clang::CXXConstructorDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::CXXRecordDecl *>(RD),
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
      *reinterpret_cast<clang::DeclarationNameInfo *>(NameInfo),
      clang::QualType::getFromOpaquePtr(T), reinterpret_cast<clang::TypeSourceInfo *>(TInfo),
      *reinterpret_cast<clang::ExplicitSpecifier *>(ES), UsesFPIntrin, isInline,
      isImplicitlyDeclared, static_cast<clang::ConstexprSpecKind>(ConstexprKind),
      clang::InheritedConstructor(
          reinterpret_cast<clang::ConstructorUsingShadowDecl *>(InheritedShadow),
          reinterpret_cast<clang::CXXConstructorDecl *>(InheritedBaseCtor)),
      reinterpret_cast<clang::Expr *>(TrailingRequiresClause)));
}
...
CXCXXConstructorDecl clang_CXXConstructorDecl_CreateDeserialized(CXASTContext C,
                                                                 unsigned ID,
                                                                 uint64_t AllocKind) {
  return reinterpret_cast<CXCXXConstructorDecl>(clang::CXXConstructorDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID), AllocKind));
}

// CXXDestructorDecl
CXFunctionDecl clang_CXXDestructorDecl_getOperatorDelete(CXCXXDestructorDecl DD) {
  return reinterpret_cast<CXFunctionDecl>(const_cast<clang::FunctionDecl *>(
      reinterpret_cast<clang::CXXDestructorDecl *>(DD)->getOperatorDelete()));
}

CXExpr clang_CXXDestructorDecl_getOperatorDeleteThisArg(CXCXXDestructorDecl DD) {
  return reinterpret_cast<CXExpr>(reinterpret_cast<clang::CXXDestructorDecl *>(DD)->getOperatorDeleteThisArg());
}

CXCXXDestructorDecl clang_CXXDestructorDecl_getCanonicalDecl(CXCXXDestructorDecl DD) {
  return reinterpret_cast<CXCXXDestructorDecl>(reinterpret_cast<clang::CXXDestructorDecl *>(DD)->getCanonicalDecl());
}
...
CXCXXDestructorDecl clang_CXXDestructorDecl_Create(
  ...
  return reinterpret_cast<CXCXXDestructorDecl>(clang::CXXDestructorDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::CXXRecordDecl *>(RD),
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
      *reinterpret_cast<clang::DeclarationNameInfo *>(NameInfo),
      clang::QualType::getFromOpaquePtr(T), reinterpret_cast<clang::TypeSourceInfo *>(TInfo),
...
CXCXXDestructorDecl clang_CXXDestructorDecl_CreateDeserialized(CXASTContext C,
                                                               unsigned ID) {
  return reinterpret_cast<CXCXXDestructorDecl>(clang::CXXDestructorDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

void clang_CXXDestructorDecl_setOperatorDelete(CXCXXDestructorDecl DD, CXFunctionDecl OD,
                                               CXExpr ThisArg) {
  reinterpret_cast<clang::CXXDestructorDecl *>(DD)->setOperatorDelete(
      reinterpret_cast<clang::FunctionDecl *>(OD), reinterpret_cast<clang::Expr *>(ThisArg));
}

// CXXConversionDecl
CXQualType clang_CXXConversionDecl_getConversionType(CXCXXConversionDecl CD) {
  return reinterpret_cast<CXQualType>(reinterpret_cast<clang::CXXConversionDecl *>(CD)->getConversionType().getAsOpaquePtr());
}

bool clang_CXXConversionDecl_isExplicit(CXCXXConversionDecl CD) {
  return reinterpret_cast<clang::CXXConversionDecl *>(CD)->isExplicit();
}

CXExplicitSpecifier clang_CXXConversionDecl_getExplicitSpecifier(CXCXXConversionDecl CD) {
  auto ES = reinterpret_cast<clang::CXXConversionDecl *>(CD)->getExplicitSpecifier();
  return reinterpret_cast<CXExplicitSpecifier>(std::make_unique<clang::ExplicitSpecifier>(ES).release());
}

void clang_CXXConversionDecl_setExplicitSpecifier(CXCXXConversionDecl CD,
                                                  CXExplicitSpecifier ES) {
  reinterpret_cast<clang::CXXConversionDecl *>(CD)->setExplicitSpecifier(
      *reinterpret_cast<clang::ExplicitSpecifier *>(ES));
}

bool clang_CXXConversionDecl_isLambdaToBlockPointerConversion(CXCXXConversionDecl CD) {
  return reinterpret_cast<clang::CXXConversionDecl *>(CD)->isLambdaToBlockPointerConversion();
}

CXCXXConversionDecl clang_CXXConversionDecl_getCanonicalDecl(CXCXXConversionDecl CD) {
  return reinterpret_cast<CXCXXConversionDecl>(reinterpret_cast<clang::CXXConversionDecl *>(CD)->getCanonicalDecl());
}
...
CXCXXConversionDecl clang_CXXConversionDecl_Create(
    ...
    CXSourceLocation_ EndLocation, CXExpr TrailingRequiresClause) {
  return reinterpret_cast<CXCXXConversionDecl>(clang::CXXConversionDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::CXXRecordDecl *>(RD),
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
      *reinterpret_cast<clang::DeclarationNameInfo *>(NameInfo),
      clang::QualType::getFromOpaquePtr(T), reinterpret_cast<clang::TypeSourceInfo *>(TInfo),
      UsesFPIntrin, isInline, *reinterpret_cast<clang::ExplicitSpecifier *>(ES),
      static_cast<clang::ConstexprSpecKind>(ConstexprKind),
      clang::SourceLocation::getFromPtrEncoding(EndLocation),
      reinterpret_cast<clang::Expr *>(TrailingRequiresClause)));
}
...
CXCXXConversionDecl clang_CXXConversionDecl_CreateDeserialized(CXASTContext C,
                                                               unsigned ID) {
  return reinterpret_cast<CXCXXConversionDecl>(clang::CXXConversionDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}
...
CXLinkageSpecDecl clang_LinkageSpecDecl_Create(CXASTContext C, CXDeclContext DC,
                                               ...
                                               bool HasBraces) {
  return reinterpret_cast<CXLinkageSpecDecl>(clang::LinkageSpecDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
...
CXLinkageSpecDecl clang_LinkageSpecDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXLinkageSpecDecl>(clang::LinkageSpecDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}
...
CXLinkageSpecLanguageIDs clang_LinkageSpecDecl_getLanguage(CXLinkageSpecDecl LSD) {
  return static_cast<CXLinkageSpecLanguageIDs>(
      reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->getLanguage());
}

void clang_LinkageSpecDecl_setLanguage(CXLinkageSpecDecl LSD,
                                       CXLinkageSpecLanguageIDs Lang) {
  reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->setLanguage(
      static_cast<clang::LinkageSpecLanguageIDs>(Lang));
}

bool clang_LinkageSpecDecl_hasBraces(CXLinkageSpecDecl LSD) {
  return reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->hasBraces();
}

CXSourceLocation_ clang_LinkageSpecDecl_getExternLoc(CXLinkageSpecDecl LSD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->getExternLoc().getPtrEncoding());
}

CXSourceLocation_ clang_LinkageSpecDecl_getRBraceLoc(CXLinkageSpecDecl LSD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->getRBraceLoc().getPtrEncoding());
}

void clang_LinkageSpecDecl_setExternLoc(CXLinkageSpecDecl LSD, CXSourceLocation_ Loc) {
  reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->setExternLoc(
      clang::SourceLocation::getFromPtrEncoding(Loc));
}

void clang_LinkageSpecDecl_setRBraceLoc(CXLinkageSpecDecl LSD, CXSourceLocation_ Loc) {
  reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->setRBraceLoc(
      clang::SourceLocation::getFromPtrEncoding(Loc));
}

CXSourceLocation_ clang_LinkageSpecDecl_getEndLoc(CXLinkageSpecDecl LSD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->getEndLoc().getPtrEncoding());
}

CXSourceRange_ clang_LinkageSpecDecl_getSourceRange(CXLinkageSpecDecl LSD) {
  auto rng = reinterpret_cast<clang::LinkageSpecDecl *>(LSD)->getSourceRange();
  CXSourceLocation_ B = reinterpret_cast<CXSourceLocation_>(rng.getBegin().getPtrEncoding());
  CXSourceLocation_ E = reinterpret_cast<CXSourceLocation_>(rng.getEnd().getPtrEncoding());
  return CXSourceRange_{B, E};
}
...
CXDeclContext clang_LinkageSpecDecl_castToDeclContext(CXLinkageSpecDecl LSD) {
  return reinterpret_cast<CXDeclContext>(clang::LinkageSpecDecl::castToDeclContext(
      reinterpret_cast<clang::LinkageSpecDecl *>(LSD)));
}

CXLinkageSpecDecl clang_LinkageSpecDecl_castFromDeclContext(CXDeclContext DC) {
  return reinterpret_cast<CXLinkageSpecDecl>(clang::LinkageSpecDecl::castFromDeclContext(reinterpret_cast<clang::DeclContext *>(DC)));
}

// UsingDirectiveDecl
CXNamespaceDecl clang_UsingDirectiveDecl_getNominatedNamespace(CXUsingDirectiveDecl UDD) {
  return reinterpret_cast<CXNamespaceDecl>(reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getNominatedNamespace());
}

CXSourceRange_ clang_UsingDirectiveDecl_getQualifierRange(CXUsingDirectiveDecl UDD) {
  auto Q = reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getQualifierLoc();
...
CXNestedNameSpecifier clang_UsingDirectiveDecl_getQualifier(CXUsingDirectiveDecl UDD) {
  return reinterpret_cast<CXNestedNameSpecifier>(reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getQualifier());
}

CXNamedDecl
clang_UsingDirectiveDecl_getNominatedNamespaceAsWritten(CXUsingDirectiveDecl UDD) {
  return reinterpret_cast<CXNamedDecl>(reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getNominatedNamespaceAsWritten());
}

CXDeclContext clang_UsingDirectiveDecl_getCommonAncestor(CXUsingDirectiveDecl UDD) {
  return reinterpret_cast<CXDeclContext>(reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getCommonAncestor());
}

CXSourceLocation_ clang_UsingDirectiveDecl_getUsingLoc(CXUsingDirectiveDecl UDD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getUsingLoc().getPtrEncoding());
}

CXSourceLocation_
clang_UsingDirectiveDecl_getNamespaceKeyLocation(CXUsingDirectiveDecl UDD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)
      ->getNamespaceKeyLocation()
      .getPtrEncoding());
}

CXSourceLocation_ clang_UsingDirectiveDecl_getIdentLocation(CXUsingDirectiveDecl UDD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getIdentLocation().getPtrEncoding());
}

CXSourceRange_ clang_UsingDirectiveDecl_getSourceRange(CXUsingDirectiveDecl UDD) {
  clang::SourceRange R = reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}

CXUsingDirectiveDecl clang_UsingDirectiveDecl_CreateDeserialized(CXASTContext C,
                                                                 unsigned ID) {
  return reinterpret_cast<CXUsingDirectiveDecl>(clang::UsingDirectiveDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// NamespaceAliasDecl
CXNamespaceAliasDecl clang_NamespaceAliasDecl_getCanonicalDecl(CXNamespaceAliasDecl NAD) {
  return reinterpret_cast<CXNamespaceAliasDecl>(reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getCanonicalDecl());
}

CXSourceRange_ clang_NamespaceAliasDecl_getQualifierRange(CXNamespaceAliasDecl NAD) {
  auto Q = reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getQualifierLoc();
  clang::SourceRange R = Q.getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}

CXNestedNameSpecifier clang_NamespaceAliasDecl_getQualifier(CXNamespaceAliasDecl NAD) {
  return reinterpret_cast<CXNestedNameSpecifier>(reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getQualifier());
}

CXNamespaceDecl clang_NamespaceAliasDecl_getNamespace(CXNamespaceAliasDecl NAD) {
  return reinterpret_cast<CXNamespaceDecl>(reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getNamespace());
}

CXSourceLocation_ clang_NamespaceAliasDecl_getAliasLoc(CXNamespaceAliasDecl NAD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getAliasLoc().getPtrEncoding());
}

CXSourceLocation_ clang_NamespaceAliasDecl_getNamespaceLoc(CXNamespaceAliasDecl NAD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getNamespaceLoc().getPtrEncoding());
}

CXSourceLocation_ clang_NamespaceAliasDecl_getTargetNameLoc(CXNamespaceAliasDecl NAD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getTargetNameLoc().getPtrEncoding());
}

CXNamedDecl clang_NamespaceAliasDecl_getAliasedNamespace(CXNamespaceAliasDecl NAD) {
  return reinterpret_cast<CXNamedDecl>(reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getAliasedNamespace());
}

CXSourceRange_ clang_NamespaceAliasDecl_getSourceRange(CXNamespaceAliasDecl NAD) {
  clang::SourceRange R = reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}

CXNamespaceAliasDecl clang_NamespaceAliasDecl_CreateDeserialized(CXASTContext C,
                                                                 unsigned ID) {
  return reinterpret_cast<CXNamespaceAliasDecl>(clang::NamespaceAliasDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// LifetimeExtendedTemporaryDecl
CXValueDecl
clang_LifetimeExtendedTemporaryDecl_getExtendingDecl(CXLifetimeExtendedTemporaryDecl D) {
  return reinterpret_cast<CXValueDecl>(reinterpret_cast<clang::LifetimeExtendedTemporaryDecl *>(D)->getExtendingDecl());
}
...
clang_LifetimeExtendedTemporaryDecl_getStorageDuration(CXLifetimeExtendedTemporaryDecl D) {
  return static_cast<CXStorageDuration>(
      reinterpret_cast<clang::LifetimeExtendedTemporaryDecl *>(D)->getStorageDuration());
}

bool clang_LifetimeExtendedTemporaryDecl_hasTemporaryExpr(
    CXLifetimeExtendedTemporaryDecl D) {
  auto *LETD = reinterpret_cast<clang::LifetimeExtendedTemporaryDecl *>(D);
...
clang_LifetimeExtendedTemporaryDecl_getTemporaryExpr(CXLifetimeExtendedTemporaryDecl D) {
  return reinterpret_cast<CXExpr>(reinterpret_cast<clang::LifetimeExtendedTemporaryDecl *>(D)->getTemporaryExpr());
}

unsigned
clang_LifetimeExtendedTemporaryDecl_getManglingNumber(CXLifetimeExtendedTemporaryDecl D) {
  return reinterpret_cast<clang::LifetimeExtendedTemporaryDecl *>(D)->getManglingNumber();
}

CXAPValue
clang_LifetimeExtendedTemporaryDecl_getOrCreateValue(CXLifetimeExtendedTemporaryDecl D,
                                                     bool MayCreate) {
  return reinterpret_cast<CXAPValue>(reinterpret_cast<clang::LifetimeExtendedTemporaryDecl *>(D)->getOrCreateValue(
      MayCreate));
}

CXAPValue clang_LifetimeExtendedTemporaryDecl_getValue(CXLifetimeExtendedTemporaryDecl D) {
  return reinterpret_cast<CXAPValue>(reinterpret_cast<clang::LifetimeExtendedTemporaryDecl *>(D)->getValue());
}

CXLifetimeExtendedTemporaryDecl
clang_LifetimeExtendedTemporaryDecl_Create(CXExpr Temp, CXValueDecl EDec,
                                           unsigned Mangling) {
  return reinterpret_cast<CXLifetimeExtendedTemporaryDecl>(clang::LifetimeExtendedTemporaryDecl::Create(
      reinterpret_cast<clang::Expr *>(Temp), reinterpret_cast<clang::ValueDecl *>(EDec), Mangling));
}

CXLifetimeExtendedTemporaryDecl
clang_LifetimeExtendedTemporaryDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXLifetimeExtendedTemporaryDecl>(clang::LifetimeExtendedTemporaryDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// UsingShadowDecl
CXNamedDecl clang_UsingShadowDecl_getTargetDecl(CXUsingShadowDecl USD) {
  return reinterpret_cast<CXNamedDecl>(reinterpret_cast<clang::UsingShadowDecl *>(USD)->getTargetDecl());
}

void clang_UsingShadowDecl_setTargetDecl(CXUsingShadowDecl USD, CXNamedDecl ND) {
  reinterpret_cast<clang::UsingShadowDecl *>(USD)->setTargetDecl(
      reinterpret_cast<clang::NamedDecl *>(ND));
}

CXUsingShadowDecl clang_UsingShadowDecl_getCanonicalDecl(CXUsingShadowDecl USD) {
  return reinterpret_cast<CXUsingShadowDecl>(reinterpret_cast<clang::UsingShadowDecl *>(USD)->getCanonicalDecl());
}

CXBaseUsingDecl clang_UsingShadowDecl_getIntroducer(CXUsingShadowDecl USD) {
  return reinterpret_cast<CXBaseUsingDecl>(reinterpret_cast<clang::UsingShadowDecl *>(USD)->getIntroducer());
}

CXUsingShadowDecl clang_UsingShadowDecl_getNextUsingShadowDecl(CXUsingShadowDecl USD) {
  return reinterpret_cast<CXUsingShadowDecl>(reinterpret_cast<clang::UsingShadowDecl *>(USD)->getNextUsingShadowDecl());
}
...
CXUsingShadowDecl clang_UsingShadowDecl_Create(CXASTContext C, CXDeclContext DC,
                                               ...
                                               CXNamedDecl Target) {
  return reinterpret_cast<CXUsingShadowDecl>(clang::UsingShadowDecl::Create(*reinterpret_cast<clang::ASTContext *>(C),
                                        reinterpret_cast<clang::DeclContext *>(DC),
                                        clang::SourceLocation::getFromPtrEncoding(Loc),
                                        clang::DeclarationName::getFromOpaquePtr(Name),
                                        reinterpret_cast<clang::BaseUsingDecl *>(Introducer),
                                        reinterpret_cast<clang::NamedDecl *>(Target)));
}

CXUsingShadowDecl clang_UsingShadowDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXUsingShadowDecl>(clang::UsingShadowDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}
...
CXStaticAssertDecl clang_StaticAssertDecl_Create(CXASTContext C, CXDeclContext DC,
                                                 ...
                                                 bool Failed) {
  return reinterpret_cast<CXStaticAssertDecl>(clang::StaticAssertDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(StaticAssertLoc),
      reinterpret_cast<clang::Expr *>(AssertExpr), reinterpret_cast<clang::Expr *>(Message),
...
CXStaticAssertDecl clang_StaticAssertDecl_CreateDeserialized(CXASTContext C,
                                                             unsigned ID) {
  return reinterpret_cast<CXStaticAssertDecl>(clang::StaticAssertDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

CXExpr clang_StaticAssertDecl_getAssertExpr(CXStaticAssertDecl SAD) {
  return reinterpret_cast<CXExpr>(reinterpret_cast<clang::StaticAssertDecl *>(SAD)->getAssertExpr());
}

CXExpr clang_StaticAssertDecl_getMessage(CXStaticAssertDecl SAD) {
  return reinterpret_cast<CXExpr>(reinterpret_cast<clang::StaticAssertDecl *>(SAD)->getMessage());
}

bool clang_StaticAssertDecl_isFailed(CXStaticAssertDecl SAD) {
  return reinterpret_cast<clang::StaticAssertDecl *>(SAD)->isFailed();
}

CXSourceLocation_ clang_StaticAssertDecl_getRParenLoc(CXStaticAssertDecl SAD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::StaticAssertDecl *>(SAD)->getRParenLoc().getPtrEncoding());
}

CXSourceRange_ clang_StaticAssertDecl_getSourceRange(CXStaticAssertDecl SAD) {
  clang::SourceRange R = reinterpret_cast<clang::StaticAssertDecl *>(SAD)->getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}

unsigned clang_BaseUsingDecl_shadow_size(CXBaseUsingDecl BUD) {
  return reinterpret_cast<clang::BaseUsingDecl *>(BUD)->shadow_size();
}

void clang_BaseUsingDecl_getShadows(CXBaseUsingDecl BUD, CXUsingShadowDecl *Buf) {
  auto *D = reinterpret_cast<clang::BaseUsingDecl *>(BUD);
  unsigned I = 0;
  for (auto *S : D->shadows())
    Buf[I++] = reinterpret_cast<CXUsingShadowDecl>(S);
}

void clang_BaseUsingDecl_addShadowDecl(CXBaseUsingDecl BUD, CXUsingShadowDecl S) {
  reinterpret_cast<clang::BaseUsingDecl *>(BUD)->addShadowDecl(
      reinterpret_cast<clang::UsingShadowDecl *>(S));
}

void clang_BaseUsingDecl_removeShadowDecl(CXBaseUsingDecl BUD, CXUsingShadowDecl S) {
  reinterpret_cast<clang::BaseUsingDecl *>(BUD)->removeShadowDecl(
      reinterpret_cast<clang::UsingShadowDecl *>(S));
}

// UsingDecl
CXSourceLocation_ clang_UsingDecl_getUsingLoc(CXUsingDecl UD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::UsingDecl *>(UD)->getUsingLoc().getPtrEncoding());
}

void clang_UsingDecl_setUsingLoc(CXUsingDecl UD, CXSourceLocation_ L) {
  reinterpret_cast<clang::UsingDecl *>(UD)->setUsingLoc(
      clang::SourceLocation::getFromPtrEncoding(L));
}

CXSourceRange_ clang_UsingDecl_getQualifierRange(CXUsingDecl UD) {
  auto Q = reinterpret_cast<clang::UsingDecl *>(UD)->getQualifierLoc();
  clang::SourceRange R = Q.getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}

CXNestedNameSpecifier clang_UsingDecl_getQualifier(CXUsingDecl UD) {
  return reinterpret_cast<CXNestedNameSpecifier>(reinterpret_cast<clang::UsingDecl *>(UD)->getQualifier());
}
...
CXDeclarationNameInfo clang_UsingDecl_getNameInfo(CXUsingDecl UD) {
  return reinterpret_cast<CXDeclarationNameInfo>(std::make_unique<clang::DeclarationNameInfo>(
             reinterpret_cast<clang::UsingDecl *>(UD)->getNameInfo())
      .release());
}

bool clang_UsingDecl_isAccessDeclaration(CXUsingDecl UD) {
  return reinterpret_cast<clang::UsingDecl *>(UD)->isAccessDeclaration();
}

bool clang_UsingDecl_hasTypename(CXUsingDecl UD) {
  return reinterpret_cast<clang::UsingDecl *>(UD)->hasTypename();
}

void clang_UsingDecl_setTypename(CXUsingDecl UD, bool TN) {
  reinterpret_cast<clang::UsingDecl *>(UD)->setTypename(TN);
}

CXSourceRange_ clang_UsingDecl_getSourceRange(CXUsingDecl UD) {
  clang::SourceRange R = reinterpret_cast<clang::UsingDecl *>(UD)->getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}

CXUsingDecl clang_UsingDecl_getCanonicalDecl(CXUsingDecl UD) {
  return reinterpret_cast<CXUsingDecl>(reinterpret_cast<clang::UsingDecl *>(UD)->getCanonicalDecl());
}

CXUsingDecl clang_UsingDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXUsingDecl>(clang::UsingDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// ConstructorUsingShadowDecl
CXUsingDecl
clang_ConstructorUsingShadowDecl_getIntroducer(CXConstructorUsingShadowDecl CUSD) {
  return reinterpret_cast<CXUsingDecl>(reinterpret_cast<clang::ConstructorUsingShadowDecl *>(CUSD)->getIntroducer());
}

CXCXXRecordDecl
clang_ConstructorUsingShadowDecl_getParent(CXConstructorUsingShadowDecl CUSD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::ConstructorUsingShadowDecl *>(CUSD)->getParent());
}

CXConstructorUsingShadowDecl
clang_ConstructorUsingShadowDecl_getNominatedBaseClassShadowDecl(
    CXConstructorUsingShadowDecl CUSD) {
  return reinterpret_cast<CXConstructorUsingShadowDecl>(reinterpret_cast<clang::ConstructorUsingShadowDecl *>(CUSD)
...
clang_ConstructorUsingShadowDecl_getNominatedBaseClass(CXConstructorUsingShadowDecl CUSD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::ConstructorUsingShadowDecl *>(CUSD)->getNominatedBaseClass());
}

CXCXXRecordDecl clang_ConstructorUsingShadowDecl_getConstructedBaseClass(
    CXConstructorUsingShadowDecl CUSD) {
  return reinterpret_cast<CXCXXRecordDecl>(reinterpret_cast<clang::ConstructorUsingShadowDecl *>(CUSD)->getConstructedBaseClass());
}

bool clang_ConstructorUsingShadowDecl_constructsVirtualBase(
    CXConstructorUsingShadowDecl CUSD) {
  return reinterpret_cast<clang::ConstructorUsingShadowDecl *>(CUSD)->constructsVirtualBase();
}
...
clang_ConstructorUsingShadowDecl_Create(CXASTContext C, CXDeclContext DC,
  ...
  return reinterpret_cast<CXConstructorUsingShadowDecl>(clang::ConstructorUsingShadowDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(Loc),
      reinterpret_cast<clang::UsingDecl *>(Using), reinterpret_cast<clang::NamedDecl *>(Target),
      IsVirtual));
}

CXConstructorUsingShadowDecl
clang_ConstructorUsingShadowDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXConstructorUsingShadowDecl>(clang::ConstructorUsingShadowDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// UsingEnumDecl
CXSourceLocation_ clang_UsingEnumDecl_getUsingLoc(CXUsingEnumDecl UED) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::UsingEnumDecl *>(UED)->getUsingLoc().getPtrEncoding());
}

void clang_UsingEnumDecl_setUsingLoc(CXUsingEnumDecl UED, CXSourceLocation_ L) {
  reinterpret_cast<clang::UsingEnumDecl *>(UED)->setUsingLoc(
      clang::SourceLocation::getFromPtrEncoding(L));
}

CXSourceLocation_ clang_UsingEnumDecl_getEnumLoc(CXUsingEnumDecl UED) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::UsingEnumDecl *>(UED)->getEnumLoc().getPtrEncoding());
}

void clang_UsingEnumDecl_setEnumLoc(CXUsingEnumDecl UED, CXSourceLocation_ L) {
  reinterpret_cast<clang::UsingEnumDecl *>(UED)->setEnumLoc(
      clang::SourceLocation::getFromPtrEncoding(L));
}

CXNestedNameSpecifier clang_UsingEnumDecl_getQualifier(CXUsingEnumDecl UED) {
  return reinterpret_cast<CXNestedNameSpecifier>(reinterpret_cast<clang::UsingEnumDecl *>(UED)->getQualifier());
}

CXSourceRange_ clang_UsingEnumDecl_getQualifierRange(CXUsingEnumDecl UED) {
  auto Q = reinterpret_cast<clang::UsingEnumDecl *>(UED)->getQualifierLoc();
  clang::SourceRange R = Q.getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}
...
CXTypeLoc clang_UsingEnumDecl_getEnumTypeLoc(CXUsingEnumDecl UED) {
  return reinterpret_cast<CXTypeLoc>(new clang::TypeLoc( // NOLINT(*-owning-memory)
      reinterpret_cast<clang::UsingEnumDecl *>(UED)->getEnumTypeLoc()));
}

CXTypeSourceInfo clang_UsingEnumDecl_getEnumType(CXUsingEnumDecl UED) {
  return reinterpret_cast<CXTypeSourceInfo>(reinterpret_cast<clang::UsingEnumDecl *>(UED)->getEnumType());
}

void clang_UsingEnumDecl_setEnumType(CXUsingEnumDecl UED, CXTypeSourceInfo TSI) {
  reinterpret_cast<clang::UsingEnumDecl *>(UED)->setEnumType(
      reinterpret_cast<clang::TypeSourceInfo *>(TSI));
}

CXEnumDecl clang_UsingEnumDecl_getEnumDecl(CXUsingEnumDecl UED) {
  return reinterpret_cast<CXEnumDecl>(reinterpret_cast<clang::UsingEnumDecl *>(UED)->getEnumDecl());
}

CXSourceRange_ clang_UsingEnumDecl_getSourceRange(CXUsingEnumDecl UED) {
  auto rng = reinterpret_cast<clang::UsingEnumDecl *>(UED)->getSourceRange();
  CXSourceLocation_ B = reinterpret_cast<CXSourceLocation_>(rng.getBegin().getPtrEncoding());
  CXSourceLocation_ E = reinterpret_cast<CXSourceLocation_>(rng.getEnd().getPtrEncoding());
  return CXSourceRange_{B, E};
}
...
CXUsingEnumDecl clang_UsingEnumDecl_getCanonicalDecl(CXUsingEnumDecl UED) {
  return reinterpret_cast<CXUsingEnumDecl>(reinterpret_cast<clang::UsingEnumDecl *>(UED)->getCanonicalDecl());
}
...
CXUsingEnumDecl clang_UsingEnumDecl_Create(CXASTContext C, CXDeclContext DC,
  ...
  return reinterpret_cast<CXUsingEnumDecl>(clang::UsingEnumDecl::Create(*reinterpret_cast<clang::ASTContext *>(C),
                                      reinterpret_cast<clang::DeclContext *>(DC),
                                      ...
                                      reinterpret_cast<clang::TypeSourceInfo *>(EnumType)));
}

CXUsingEnumDecl clang_UsingEnumDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXUsingEnumDecl>(clang::UsingEnumDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// UsingPackDecl
CXNamedDecl clang_UsingPackDecl_getInstantiatedFromUsingDecl(CXUsingPackDecl UPD) {
  return reinterpret_cast<CXNamedDecl>(reinterpret_cast<clang::UsingPackDecl *>(UPD)->getInstantiatedFromUsingDecl());
}

unsigned clang_UsingPackDecl_getNumExpansions(CXUsingPackDecl UPD) {
  return reinterpret_cast<clang::UsingPackDecl *>(UPD)->expansions().size();
}

CXNamedDecl clang_UsingPackDecl_getExpansion(CXUsingPackDecl UPD, unsigned i) {
  return reinterpret_cast<CXNamedDecl>(reinterpret_cast<clang::UsingPackDecl *>(UPD)->expansions()[i]);
}

CXSourceRange_ clang_UsingPackDecl_getSourceRange(CXUsingPackDecl UPD) {
  auto rng = reinterpret_cast<clang::UsingPackDecl *>(UPD)->getSourceRange();
  CXSourceLocation_ B = reinterpret_cast<CXSourceLocation_>(rng.getBegin().getPtrEncoding());
  CXSourceLocation_ E = reinterpret_cast<CXSourceLocation_>(rng.getEnd().getPtrEncoding());
  return CXSourceRange_{B, E};
}
...
CXUsingPackDecl clang_UsingPackDecl_getCanonicalDecl(CXUsingPackDecl UPD) {
  return reinterpret_cast<CXUsingPackDecl>(reinterpret_cast<clang::UsingPackDecl *>(UPD)->getCanonicalDecl());
}
...
CXUsingPackDecl clang_UsingPackDecl_Create(CXASTContext C, CXDeclContext DC,
  ...
  for (unsigned I = 0; I < NumUsingDecls; ++I)
    Decls.push_back(reinterpret_cast<clang::NamedDecl *>(UsingDecls[I]));
  return reinterpret_cast<CXUsingPackDecl>(clang::UsingPackDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      reinterpret_cast<clang::NamedDecl *>(InstantiatedFrom), Decls));
}

CXUsingPackDecl clang_UsingPackDecl_CreateDeserialized(CXASTContext C, unsigned ID,
                                                       unsigned NumExpansions) {
  return reinterpret_cast<CXUsingPackDecl>(clang::UsingPackDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID),
                                                  NumExpansions));
}
...
clang_UnresolvedUsingValueDecl_getUsingLoc(CXUnresolvedUsingValueDecl UUVD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)
      ->getUsingLoc()
      .getPtrEncoding());
}
...
void clang_UnresolvedUsingValueDecl_setUsingLoc(CXUnresolvedUsingValueDecl UUVD,
                                                CXSourceLocation_ L) {
  reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->setUsingLoc(
      clang::SourceLocation::getFromPtrEncoding(L));
}

bool clang_UnresolvedUsingValueDecl_isAccessDeclaration(CXUnresolvedUsingValueDecl UUVD) {
  return reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->isAccessDeclaration();
}

CXSourceRange_
clang_UnresolvedUsingValueDecl_getQualifierRange(CXUnresolvedUsingValueDecl UUVD) {
  auto Q = reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->getQualifierLoc();
  clang::SourceRange R = Q.getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}
...
clang_UnresolvedUsingValueDecl_getQualifier(CXUnresolvedUsingValueDecl UUVD) {
  return reinterpret_cast<CXNestedNameSpecifier>(reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->getQualifier());
}

CXDeclarationNameInfo
clang_UnresolvedUsingValueDecl_getNameInfo(CXUnresolvedUsingValueDecl UUVD) {
  return reinterpret_cast<CXDeclarationNameInfo>(std::make_unique<clang::DeclarationNameInfo>(
             reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->getNameInfo())
      .release());
}

bool clang_UnresolvedUsingValueDecl_isPackExpansion(CXUnresolvedUsingValueDecl UUVD) {
  return reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->isPackExpansion();
}
...
clang_UnresolvedUsingValueDecl_getSourceRange(CXUnresolvedUsingValueDecl UUVD) {
  clang::SourceRange R =
      reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}

CXUnresolvedUsingValueDecl
clang_UnresolvedUsingValueDecl_getCanonicalDecl(CXUnresolvedUsingValueDecl UUVD) {
  return reinterpret_cast<CXUnresolvedUsingValueDecl>(reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->getCanonicalDecl());
}

CXUnresolvedUsingValueDecl clang_UnresolvedUsingValueDecl_CreateDeserialized(CXASTContext C,
                                                                             unsigned ID) {
  return reinterpret_cast<CXUnresolvedUsingValueDecl>(clang::UnresolvedUsingValueDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// UnresolvedUsingTypenameDecl
CXSourceLocation_
clang_UnresolvedUsingTypenameDecl_getUsingLoc(CXUnresolvedUsingTypenameDecl UUTD) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::UnresolvedUsingTypenameDecl *>(UUTD)
      ->getUsingLoc()
      .getPtrEncoding());
}
...
clang_UnresolvedUsingTypenameDecl_getQualifierRange(CXUnresolvedUsingTypenameDecl UUTD) {
  auto Q = reinterpret_cast<clang::UnresolvedUsingTypenameDecl *>(UUTD)->getQualifierLoc();
  clang::SourceRange R = Q.getSourceRange();
  return CXSourceRange_{reinterpret_cast<CXSourceLocation_>(R.getBegin().getPtrEncoding()), reinterpret_cast<CXSourceLocation_>(R.getEnd().getPtrEncoding())};
}
...
clang_UnresolvedUsingTypenameDecl_getQualifier(CXUnresolvedUsingTypenameDecl UUTD) {
  return reinterpret_cast<CXNestedNameSpecifier>(reinterpret_cast<clang::UnresolvedUsingTypenameDecl *>(UUTD)->getQualifier());
}

CXDeclarationNameInfo
clang_UnresolvedUsingTypenameDecl_getNameInfo(CXUnresolvedUsingTypenameDecl UUTD) {
  return reinterpret_cast<CXDeclarationNameInfo>(std::make_unique<clang::DeclarationNameInfo>(
             reinterpret_cast<clang::UnresolvedUsingTypenameDecl *>(UUTD)->getNameInfo())
      .release());
}

bool clang_UnresolvedUsingTypenameDecl_isPackExpansion(CXUnresolvedUsingTypenameDecl UUTD) {
  return reinterpret_cast<clang::UnresolvedUsingTypenameDecl *>(UUTD)->isPackExpansion();
}
...
clang_UnresolvedUsingTypenameDecl_getCanonicalDecl(CXUnresolvedUsingTypenameDecl UUTD) {
  return reinterpret_cast<CXUnresolvedUsingTypenameDecl>(reinterpret_cast<clang::UnresolvedUsingTypenameDecl *>(UUTD)->getCanonicalDecl());
}

CXUnresolvedUsingTypenameDecl
clang_UnresolvedUsingTypenameDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXUnresolvedUsingTypenameDecl>(clang::UnresolvedUsingTypenameDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}
...
clang_UnresolvedUsingIfExistsDecl_Create(CXASTContext C, CXDeclContext DC,
  ...
  return reinterpret_cast<CXUnresolvedUsingIfExistsDecl>(clang::UnresolvedUsingIfExistsDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(Loc),
      clang::DeclarationName::getFromOpaquePtr(Name)));
}
...
clang_UnresolvedUsingIfExistsDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXUnresolvedUsingIfExistsDecl>(clang::UnresolvedUsingIfExistsDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// BindingDecl
CXExpr clang_BindingDecl_getBinding(CXBindingDecl BD) {
  return reinterpret_cast<CXExpr>(reinterpret_cast<clang::BindingDecl *>(BD)->getBinding());
}

CXValueDecl clang_BindingDecl_getDecomposedDecl(CXBindingDecl BD) {
  return reinterpret_cast<CXValueDecl>(reinterpret_cast<clang::BindingDecl *>(BD)->getDecomposedDecl());
}

CXVarDecl clang_BindingDecl_getHoldingVar(CXBindingDecl BD) {
  return reinterpret_cast<CXVarDecl>(reinterpret_cast<clang::BindingDecl *>(BD)->getHoldingVar());
}

void clang_BindingDecl_setBinding(CXBindingDecl BD, CXQualType DeclaredType,
                                  CXExpr Binding) {
  reinterpret_cast<clang::BindingDecl *>(BD)->setBinding(
      clang::QualType::getFromOpaquePtr(DeclaredType), reinterpret_cast<clang::Expr *>(Binding));
}

void clang_BindingDecl_setDecomposedDecl(CXBindingDecl BD, CXValueDecl Decomposed) {
  reinterpret_cast<clang::BindingDecl *>(BD)->setDecomposedDecl(
      reinterpret_cast<clang::ValueDecl *>(Decomposed));
}

CXBindingDecl clang_BindingDecl_Create(CXASTContext C, CXDeclContext DC,
                                       CXSourceLocation_ IdLoc, CXIdentifierInfo Id) {
  return reinterpret_cast<CXBindingDecl>(clang::BindingDecl::Create(*reinterpret_cast<clang::ASTContext *>(C),
                                    reinterpret_cast<clang::DeclContext *>(DC),
                                    clang::SourceLocation::getFromPtrEncoding(IdLoc),
                                    reinterpret_cast<clang::IdentifierInfo *>(Id)));
}
...
CXBindingDecl clang_BindingDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXBindingDecl>(clang::BindingDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}

// DecompositionDecl
unsigned clang_DecompositionDecl_getNumBindings(CXDecompositionDecl DD) {
  return reinterpret_cast<clang::DecompositionDecl *>(DD)->bindings().size();
}

CXBindingDecl clang_DecompositionDecl_getBinding(CXDecompositionDecl DD, unsigned i) {
  return reinterpret_cast<CXBindingDecl>(reinterpret_cast<clang::DecompositionDecl *>(DD)->bindings()[i]);
}
...
clang_DecompositionDecl_Create(CXASTContext C, CXDeclContext DC, CXSourceLocation_ StartLoc,
  ...
  for (unsigned i = 0; i != NumBindings; ++i)
    Bs.push_back(reinterpret_cast<clang::BindingDecl *>(Bindings[i]));
  return reinterpret_cast<CXDecompositionDecl>(clang::DecompositionDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(StartLoc),
...
CXDecompositionDecl clang_DecompositionDecl_CreateDeserialized(CXASTContext C, unsigned ID,
  ...
  return reinterpret_cast<CXDecompositionDecl>(clang::DecompositionDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID), NumBindings));
}

// MSPropertyDecl
bool clang_MSPropertyDecl_hasGetter(CXMSPropertyDecl MPD) {
  return reinterpret_cast<clang::MSPropertyDecl *>(MPD)->hasGetter();
}

CXIdentifierInfo clang_MSPropertyDecl_getGetterId(CXMSPropertyDecl MPD) {
  return reinterpret_cast<CXIdentifierInfo>(reinterpret_cast<clang::MSPropertyDecl *>(MPD)->getGetterId());
}

bool clang_MSPropertyDecl_hasSetter(CXMSPropertyDecl MPD) {
  return reinterpret_cast<clang::MSPropertyDecl *>(MPD)->hasSetter();
}

CXIdentifierInfo clang_MSPropertyDecl_getSetterId(CXMSPropertyDecl MPD) {
  return reinterpret_cast<CXIdentifierInfo>(reinterpret_cast<clang::MSPropertyDecl *>(MPD)->getSetterId());
}
...
CXMSPropertyDecl clang_MSPropertyDecl_Create(CXASTContext C, CXDeclContext DC,
  ...
  return reinterpret_cast<CXMSPropertyDecl>(clang::MSPropertyDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(L),
      ...
      reinterpret_cast<clang::IdentifierInfo *>(Getter),
      reinterpret_cast<clang::IdentifierInfo *>(Setter)));
}

CXMSPropertyDecl clang_MSPropertyDecl_CreateDeserialized(CXASTContext C, unsigned ID) {
  return reinterpret_cast<CXMSPropertyDecl>(clang::MSPropertyDecl::CreateDeserialized(*reinterpret_cast<clang::ASTContext *>(C), clang::GlobalDeclID(ID)));
}
...
uint32_t clang_MSGuidDecl_getPart1(CXMSGuidDecl GD) {
  return reinterpret_cast<clang::MSGuidDecl *>(GD)->getParts().Part1;
}

uint16_t clang_MSGuidDecl_getPart2(CXMSGuidDecl GD) {
  return reinterpret_cast<clang::MSGuidDecl *>(GD)->getParts().Part2;
}

uint16_t clang_MSGuidDecl_getPart3(CXMSGuidDecl GD) {
  return reinterpret_cast<clang::MSGuidDecl *>(GD)->getParts().Part3;
}

uint64_t clang_MSGuidDecl_getPart4And5AsUint64(CXMSGuidDecl GD) {
  return reinterpret_cast<clang::MSGuidDecl *>(GD)->getParts().getPart4And5AsUint64();
}

CXAPValue clang_MSGuidDecl_getAsAPValue(CXMSGuidDecl GD) {
  return reinterpret_cast<CXAPValue>(&reinterpret_cast<clang::MSGuidDecl *>(GD)->getAsAPValue());
}
...
unsigned clang_CXXRecordDecl_getNumFinalOverriders(CXCXXRecordDecl CXXRD) {
  ...
  reinterpret_cast<clang::CXXRecordDecl *>(CXXRD)->getFinalOverriders(Map);
  unsigned N = 0;
  ...
  for (const auto &Overridden : Map) {
    for (const auto &Subobject : Overridden.second) {
      for (const clang::UniqueVirtualMethod &Overrider : Subobject.second) {
        OverriddenBuf[I] = reinterpret_cast<CXCXXMethodDecl>(const_cast<clang::CXXMethodDecl *>(Overridden.first));
        OverriddenSubobjectBuf[I] = Subobject.first;
        OverriderBuf[I] = reinterpret_cast<CXCXXMethodDecl>(Overrider.Method);
        OverriderSubobjectBuf[I] = Overrider.Subobject;
        InVirtualSubobjectBuf[I] =
            reinterpret_cast<CXCXXRecordDecl>(const_cast<clang::CXXRecordDecl *>(Overrider.InVirtualSubobject));
        ++I;
      }
    }
  }
...
clang_UsingDirectiveDecl_getQualifierLoc(CXUsingDirectiveDecl UDD) {
  return reinterpret_cast<CXNestedNameSpecifierLoc>(new clang::NestedNameSpecifierLoc( // NOLINT(*-owning-memory)
      reinterpret_cast<clang::UsingDirectiveDecl *>(UDD)->getQualifierLoc()));
}
...
clang_NamespaceAliasDecl_getQualifierLoc(CXNamespaceAliasDecl NAD) {
  return reinterpret_cast<CXNestedNameSpecifierLoc>(new clang::NestedNameSpecifierLoc( // NOLINT(*-owning-memory)
      reinterpret_cast<clang::NamespaceAliasDecl *>(NAD)->getQualifierLoc()));
}

// UsingDecl (cont.)
CXNestedNameSpecifierLoc clang_UsingDecl_getQualifierLoc(CXUsingDecl UD) {
  return reinterpret_cast<CXNestedNameSpecifierLoc>(new clang::NestedNameSpecifierLoc( // NOLINT(*-owning-memory)
      reinterpret_cast<clang::UsingDecl *>(UD)->getQualifierLoc()));
}

// UsingEnumDecl (cont.)
CXNestedNameSpecifierLoc clang_UsingEnumDecl_getQualifierLoc(CXUsingEnumDecl UED) {
  return reinterpret_cast<CXNestedNameSpecifierLoc>(new clang::NestedNameSpecifierLoc( // NOLINT(*-owning-memory)
      reinterpret_cast<clang::UsingEnumDecl *>(UED)->getQualifierLoc()));
}
...
clang_UnresolvedUsingValueDecl_getQualifierLoc(CXUnresolvedUsingValueDecl UUVD) {
  return reinterpret_cast<CXNestedNameSpecifierLoc>(new clang::NestedNameSpecifierLoc( // NOLINT(*-owning-memory)
      reinterpret_cast<clang::UnresolvedUsingValueDecl *>(UUVD)->getQualifierLoc()));
}
...
clang_UnresolvedUsingTypenameDecl_getQualifierLoc(CXUnresolvedUsingTypenameDecl UUTD) {
  return reinterpret_cast<CXNestedNameSpecifierLoc>(new clang::NestedNameSpecifierLoc( // NOLINT(*-owning-memory)
      reinterpret_cast<clang::UnresolvedUsingTypenameDecl *>(UUTD)->getQualifierLoc()));
}
...
CXUsingDirectiveDecl clang_UsingDirectiveDecl_Create(
  ...
  return reinterpret_cast<CXUsingDirectiveDecl>(clang::UsingDirectiveDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      ...
      *reinterpret_cast<clang::NestedNameSpecifierLoc *>(QualifierLoc),
      ...
      reinterpret_cast<clang::NamedDecl *>(Nominated),
      reinterpret_cast<clang::DeclContext *>(CommonAncestor)));
}
...
CXNamespaceAliasDecl clang_NamespaceAliasDecl_Create(CXASTContext C, CXDeclContext DC,
  ...
  return reinterpret_cast<CXNamespaceAliasDecl>(clang::NamespaceAliasDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(NamespaceLoc),
      clang::SourceLocation::getFromPtrEncoding(AliasLoc),
      reinterpret_cast<clang::IdentifierInfo *>(Alias),
      *reinterpret_cast<clang::NestedNameSpecifierLoc *>(QualifierLoc),
      clang::SourceLocation::getFromPtrEncoding(IdentLoc),
      reinterpret_cast<clang::NamedDecl *>(Namespace)));
}
...
CXUsingDecl clang_UsingDecl_Create(CXASTContext C, CXDeclContext DC,
  ...
  return reinterpret_cast<CXUsingDecl>(clang::UsingDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(UsingL),
      *reinterpret_cast<clang::NestedNameSpecifierLoc *>(QualifierLoc),
      *reinterpret_cast<clang::DeclarationNameInfo *>(NameInfo), HasTypenameKeyword));
}
...
CXUnresolvedUsingValueDecl clang_UnresolvedUsingValueDecl_Create(
  ...
  return reinterpret_cast<CXUnresolvedUsingValueDecl>(clang::UnresolvedUsingValueDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(UsingLoc),
      *reinterpret_cast<clang::NestedNameSpecifierLoc *>(QualifierLoc),
      *reinterpret_cast<clang::DeclarationNameInfo *>(NameInfo),
...
CXUnresolvedUsingTypenameDecl clang_UnresolvedUsingTypenameDecl_Create(
    ...
    CXSourceLocation_ EllipsisLoc) {
  return reinterpret_cast<CXUnresolvedUsingTypenameDecl>(clang::UnresolvedUsingTypenameDecl::Create(
      *reinterpret_cast<clang::ASTContext *>(C), reinterpret_cast<clang::DeclContext *>(DC),
      clang::SourceLocation::getFromPtrEncoding(UsingLoc),
