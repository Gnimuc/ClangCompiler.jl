...
CXLexer clang_Lexer_create(CXFileID FID, LLVMMemoryBufferRef FromFile, CXSourceManager SM,
  ...
  auto L = std::make_unique<clang::Lexer>(*reinterpret_cast<clang::FileID *>(FID),
  ...
  return reinterpret_cast<CXLexer>(L.release());
}

void clang_Lexer_dispose(CXLexer Lex) { delete reinterpret_cast<clang::Lexer *>(Lex); }

CXSourceLocation_ clang_Lexer_getFileLoc(CXLexer Lex) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::Lexer *>(Lex)->getFileLoc().getPtrEncoding());
}

bool clang_Lexer_Lex(CXLexer Lex, CXToken_ Result) {
  return reinterpret_cast<clang::Lexer *>(Lex)->Lex(*reinterpret_cast<clang::Token *>(Result));
}

bool clang_Lexer_isPragmaLexer(CXLexer Lex) {
  return reinterpret_cast<clang::Lexer *>(Lex)->isPragmaLexer();
}

bool clang_Lexer_LexFromRawLexer(CXLexer Lex, CXToken_ Result) {
  return reinterpret_cast<clang::Lexer *>(Lex)->LexFromRawLexer(
      *reinterpret_cast<clang::Token *>(Result));
}

bool clang_Lexer_isKeepWhitespaceMode(CXLexer Lex) {
  return reinterpret_cast<clang::Lexer *>(Lex)->isKeepWhitespaceMode();
}

void clang_Lexer_SetKeepWhitespaceMode(CXLexer Lex, bool Val) {
  reinterpret_cast<clang::Lexer *>(Lex)->SetKeepWhitespaceMode(Val);
}

bool clang_Lexer_inKeepCommentMode(CXLexer Lex) {
  return reinterpret_cast<clang::Lexer *>(Lex)->inKeepCommentMode();
}

void clang_Lexer_SetCommentRetentionState(CXLexer Lex, bool Mode) {
  reinterpret_cast<clang::Lexer *>(Lex)->SetCommentRetentionState(Mode);
}

unsigned clang_Lexer_getCurrentBufferOffset(CXLexer Lex) {
  return reinterpret_cast<clang::Lexer *>(Lex)->getCurrentBufferOffset();
}

CXString clang_Lexer_getSpelling(CXToken_ Tok, CXSourceManager SM,
                                 CXLangOptions LangOpts) {
  return extra::makeCXString(
      clang::Lexer::getSpelling(*reinterpret_cast<clang::Token *>(Tok),
                                *reinterpret_cast<clang::SourceManager *>(SM),
                                *reinterpret_cast<clang::LangOptions *>(LangOpts)));
}
...
CXSourceLocation_ clang_Lexer_GetBeginningOfToken(CXSourceLocation_ Loc,
                                                  CXSourceManager SM,
                                                  CXLangOptions LangOpts) {
  return reinterpret_cast<CXSourceLocation_>(clang::Lexer::GetBeginningOfToken(clang::SourceLocation::getFromPtrEncoding(Loc),
                                           *reinterpret_cast<clang::SourceManager *>(SM),
                                           *reinterpret_cast<clang::LangOptions *>(LangOpts))
      .getPtrEncoding());
}
...
CXSourceLocation_ clang_Lexer_getLocForEndOfToken(CXSourceLocation_ Loc, unsigned Offset,
                                                  CXSourceManager SM,
                                                  CXLangOptions LangOpts) {
  return reinterpret_cast<CXSourceLocation_>(clang::Lexer::getLocForEndOfToken(clang::SourceLocation::getFromPtrEncoding(Loc),
                                           Offset,
                                           *reinterpret_cast<clang::SourceManager *>(SM),
                                           *reinterpret_cast<clang::LangOptions *>(LangOpts))
      .getPtrEncoding());
...
bool clang_Lexer_isAtStartOfMacroExpansion(CXSourceLocation_ Loc, CXSourceManager SM,
  ...
  bool Res = clang::Lexer::isAtStartOfMacroExpansion(
      ...
      *reinterpret_cast<clang::SourceManager *>(SM),
      *reinterpret_cast<clang::LangOptions *>(LangOpts), MacroBegin ? &MB : nullptr);
  if (Res && MacroBegin)
...
bool clang_Lexer_isAtEndOfMacroExpansion(CXSourceLocation_ Loc, CXSourceManager SM,
  ...
  bool Res = clang::Lexer::isAtEndOfMacroExpansion(
      clang::SourceLocation::getFromPtrEncoding(Loc),
      *reinterpret_cast<clang::SourceManager *>(SM),
      *reinterpret_cast<clang::LangOptions *>(LangOpts), MacroEnd ? &ME : nullptr);
  if (Res && MacroEnd)
...
CXString clang_Lexer_getSourceText(CXSourceRange_ Range, bool IsTokenRange,
  ...
  clang::CharSourceRange CSR(
      ...
      IsTokenRange);
  return extra::makeCXString(
      clang::Lexer::getSourceText(CSR, *reinterpret_cast<clang::SourceManager *>(SM),
                                  *reinterpret_cast<clang::LangOptions *>(LangOpts))
          .str());
}
...
bool clang_Lexer_findNextToken(CXSourceLocation_ Loc, CXSourceManager SM,
  ...
  if (!Tok)
    return false;
  *reinterpret_cast<clang::Token *>(Result) = *Tok;
  return true;
}

bool clang_Lexer_isFirstTimeLexingFile(CXLexer Lex) {
  return reinterpret_cast<clang::Lexer *>(Lex)->isFirstTimeLexingFile();
}

size_t clang_Lexer_getBufferLength(CXLexer Lex) {
  return reinterpret_cast<clang::Lexer *>(Lex)->getBuffer().size();
}

void clang_Lexer_getBuffer(CXLexer Lex, char *Out, size_t N) {
  llvm::StringRef B = reinterpret_cast<clang::Lexer *>(Lex)->getBuffer();
  std::memcpy(Out, B.data(), std::min(N, B.size()));
}

CXSourceLocation_ clang_Lexer_getSourceLocation(CXLexer Lex) {
  return reinterpret_cast<CXSourceLocation_>(reinterpret_cast<clang::Lexer *>(Lex)->getSourceLocation().getPtrEncoding());
}

void clang_Lexer_seek(CXLexer Lex, unsigned Offset, bool IsAtStartOfLine) {
  reinterpret_cast<clang::Lexer *>(Lex)->seek(Offset, IsAtStartOfLine);
}
...
CXSourceRange_ clang_Lexer_makeFileCharRange(CXSourceRange_ Range, bool IsTokenRange,
  ...
  clang::CharSourceRange R =
      clang::Lexer::makeFileCharRange(CSR, *reinterpret_cast<clang::SourceManager *>(SM),
                                      *reinterpret_cast<clang::LangOptions *>(LangOpts));
...
unsigned clang_Lexer_ComputePreamble(const char *Buffer, CXLangOptions LangOpts,
  ...
  clang::PreambleBounds PB = clang::Lexer::ComputePreamble(
      llvm::StringRef(Buffer), *reinterpret_cast<clang::LangOptions *>(LangOpts), MaxLines);
...
CXSourceLocation_ clang_Lexer_findLocationAfterToken(
  ...
  return reinterpret_cast<CXSourceLocation_>(clang::Lexer::findLocationAfterToken(
             clang::SourceLocation::getFromPtrEncoding(Loc),
...
bool clang_Lexer_isAsciiIdentifierContinueChar(char C, CXLangOptions LangOpts) {
  return clang::Lexer::isAsciiIdentifierContinueChar(
      C, *reinterpret_cast<clang::LangOptions *>(LangOpts));
}
