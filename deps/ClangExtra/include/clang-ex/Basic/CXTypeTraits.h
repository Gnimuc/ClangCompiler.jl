...
typedef enum CXUnaryExprOrTypeTrait {
  ...
  CXUnaryExprOrTypeTrait_UETT_PtrAuthTypeDiscriminator,
...
typedef enum CXTypeTrait {
  ...
  CXTypeTrait_UTT_IsImplicitLifetime,
  ...
  CXTypeTrait_UTT_IsBitwiseCloneable,
  ...
  CXTypeTrait_UTT_IsIntangibleType,
  CXTypeTrait_UTT_IsTypedResourceElementCompatible,
  CXTypeTrait_BTT_TypeCompatible,
  CXTypeTrait_BTT_IsNothrowAssignable,
  CXTypeTrait_BTT_IsAssignable,
  CXTypeTrait_BTT_IsVirtualBaseOf,
  CXTypeTrait_BTT_IsBaseOf,
  CXTypeTrait_BTT_IsConvertibleTo,
  CXTypeTrait_BTT_IsTriviallyAssignable,
  CXTypeTrait_BTT_IsLayoutCompatible,
  CXTypeTrait_BTT_IsPointerInterconvertibleBaseOf,
  CXTypeTrait_BTT_ReferenceBindsToTemporary,
  CXTypeTrait_BTT_ReferenceConstructsFromTemporary,
  CXTypeTrait_BTT_ReferenceConvertsFromTemporary,
  CXTypeTrait_BTT_IsDeducible,
  CXTypeTrait_BTT_IsSame,
  CXTypeTrait_BTT_IsConvertible,
  CXTypeTrait_BTT_IsNothrowConvertible,
  CXTypeTrait_BTT_IsScalarizedLayoutCompatible,
